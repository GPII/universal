...
BUILD_DEMOUSER_DIR="$UNIVERSAL_DIR/build/dbData/demouser"
...
docker run --rm --link couchdb -v $STATIC_DATA_DIR:/static_data -e STATIC_DATA_DIR=/static_data -v $BUILD_DATA_DIR:/build_data -e BUILD_DATA_DIR=/build_data -v $BUILD_DEMOUSER_DIR:/build_data/demouser -e $BUILD_DEMOUSER_DIR=/build_data/demouser -e COUCHDB_URL=$DATALOADER_COUCHDB_URL -e CLEAR_INDEX=$CLEAR_INDEX $DATALOADER_IMAGE
