...
COUCHDB_PORT=5984
COUCHDB_HEALTHCHECK_DELAY=1
COUCHDB_HEALTHCHECK_TIMEOUT=15
...
# Wait for CouchDB
wget --retry-connrefused --waitretry=$COUCHDB_HEALTHCHECK_DELAY --read-timeout=20 --timeout=$COUCHDB_HEALTHCHECK_TIMEOUT -t 30 http://localhost:$COUCHDB_PORT
