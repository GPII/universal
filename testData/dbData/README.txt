...
* %universal/build/gpiiKeys.json5: Contains all GPII keys.
* %universal/build/prefsSafes.json5: Contains all preferences safes corresponding to GPII keys.
* clientCredentials.json5: Contains OAuth2 client credentials.
* gpiiAppInstallationClients.json5: Contains the information of all registered GPII app installations.
* views.json5: The PouchDB/CouchDB view functions.
