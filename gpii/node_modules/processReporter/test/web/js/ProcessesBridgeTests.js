...
fluid.defaults("gpii.tests.processes.mock", {
    ...
    members: {
        processList: gpii.tests.processes.mockProcessesList,
        mockNode: gpii.tests.processes.mockNode,
        mockFirefox: gpii.tests.processes.mockFirefox
    },
    invokers: {
        getProcessList: {
            funcName: "gpii.tests.processes.getProcessList",
            args: ["{that}"]
        }
    }
});
...
/**
 * Return a list of process information objects of the running processes.
 *
 * @param that {Component} - an instance of a processes component.
 * @return {Array} - Array of procInfo objects.
 */
gpii.tests.processes.getProcessList = function (that) {
    return that.processList;
};
...
gpii.tests.processes.runTests = function () {
    ...
    jqUnit.test(
        "Test getProceseList()/findProcessByPid() with specified node process",
        function () {
    ...
    jqUnit.test(
        ...
        function () {
            // Node is running. Add a running Firefox process.
            gpii.tests.processes.startFireFox(processesBridge);
            var pids = [processesBridge.mockNode.pid, processesBridge.mockFirefox.pid];
