...
fluid.defaults("gpii.processes", {
    ...
    invokers: {
        ...
        compareProcessNames: {
            funcName: "gpii.processes.compareProcessNames",
            args: ["{arguments}.0", "{arguments}.1"]
                    // process name A,  process name B
        }
    }
});
...
gpii.processes.findProcessesByCommand = function (that, commandName, procArray) {
    ...
    return fluid.accumulate(procArray, function (aProcInfo, matchingProcs) {
        if (that.compareProcessNames(aProcInfo.command, commandName)) {
...
/**
 * Compares the names of two processes, returning a boolean indicating whether or not they are equal.
 *
