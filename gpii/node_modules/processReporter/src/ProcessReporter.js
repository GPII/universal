...
fluid.defaults("gpii.processReporter.live", {
    ...
    components: {
        solutionsRegistryDataSource: {
            type: "kettle.dataSource.URL",
            options: {
                url: "{gpii.processReporter.live}.options.solutionsRegistryUrl",
                termMap: {
                    os: os.platform()
                }
            }
...
gpii.processReporter.live.get = function (requestProxy, processReporter) {
    var runningSolutions = [];
    processReporter.solutionsRegistryDataSource.get(null, function onSuccess(entries) {
