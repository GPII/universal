...
fluid.defaults("gpii.processReporter.base", {
    ...
    requestHandlers: {
        processGet: {
            route: "/processes",
            type: "gpii.processReporter.handlers.get",
            method: "get"
        },
        processGetSingle: {
...
fluid.defaults("gpii.processReporter.handlers.get", {
...
fluid.defaults("gpii.processReporter.solution.get", {
    ...
    invokers: {
        handleRequest: {
            ...
            args: ["{request}", "{processReporter}", "{flowManager}.solutionsRegistryDataSource"]
        }
    }
});
...
gpii.processReporter.fireResponse = function (request, installedSolutions, platformReporter) {
