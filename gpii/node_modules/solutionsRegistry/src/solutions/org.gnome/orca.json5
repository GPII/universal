{
  ...
  "settingsHandlers": {
    "configuration": {
      ...
      "settingsHandlerNamespace": "gpii.orca",
      "key": "configuration",
      "supportedSettings": {
        "enableTutorialMessages": {
          "schema": {
        ...
        "voices.default.average-pitch": {
          ...
          "key": "voices.default.average-pitch"
        },
        "voices.default.gain": {
          "schema": {
            "title": "Voice Gain",
