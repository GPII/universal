{
  ...
  "settingsHandlers": {
    "configure.common-tabletmode": {
      ...
      "key": "configure.common-tabletmode",
      "supportedSettings": {
        "OverrideTabletMode": {
          "schema": {
    ...
    "configure.ribbons": {
      ...
      "settingsHandlerNamespace": "gpii.settingsHandlers.remoteFileSettingsHandler.office",
      "key": "configure.ribbons",
      "supportedSettings": {
        "word-ribbon": {
          "schema": {
