{
  ...
  "settingsHandlers": {
    "configuration": {
      ...
      "settingsHandlerNamespace": "gpii.settingsHandlers.webSockets",
      "key": "configuration",
      "supportedSettings": {
        "captionsEnabled": {
          "schema": {
