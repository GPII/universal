{
  ...
  "key": "com.microsoft.windows.mouseSettings",
  "settingsHandlers": {
    "configureMousePrimaryButton": {
      ...
      "key": "configureMousePrimaryButton",
      "supportedSettings": {
        "SwapMouseButtonsConfig": {
          "schema": {
    ...
    "configureScrollInactiveWindow": {
      ...
      "settingsHandlerNamespace": "gpii.windows.spiSettingsHandler",
      "key": "configureScrollInactiveWindow",
      "supportedSettings": {
        "ScrollFocusRoutingConfig": {
          "schema": {
    ...
    "configureMouseCursorShadow": {
      ...
      "settingsHandlerNamespace": "gpii.windows.spiSettingsHandler",
      "key": "configureMouseCursorShadow",
      "supportedSettings": {
        "MouseCursorShadowEnable": {
          "schema": {
    ...
    "configureHorizontalScrollChars": {
      ...
      "settingsHandlerNamespace": "gpii.windows.spiSettingsHandler",
      "key": "configureHorizontalScrollChars",
      "supportedSettings": {
        "ScrollCharsConfig": {
          "schema": {
    ...
    "configureActiveWindowTracking": {
      ...
      "settingsHandlerNamespace": "gpii.windows.spiSettingsHandler",
      "key": "configureActiveWindowTracking",
      "supportedSettings": {
        "WindowsTrackingConfig": {
          "schema": {
    ...
    "configureActiveWindowZOrder": {
      ...
      "settingsHandlerNamespace": "gpii.windows.spiSettingsHandler",
      "key": "configureActiveWindowZOrder",
      "supportedSettings": {
        "ActiveZOrder": {
          "schema": {
    ...
    "configureWindowsArrangement": {
      ...
      "settingsHandlerNamespace": "gpii.windows.spiSettingsHandler",
      "key": "configureWindowsArrangement",
      "supportedSettings": {
        "WindowsArrangement": {
          "schema": {
    ...
    "configureMouseDoubleClickTime": {
      ...
      "settingsHandlerNamespace": "gpii.windows.nativeSettingsHandler",
      "key": "configureMouseDoubleClickTime",
      "supportedSettings": {
        "DoubleClickTimeConfig": {
          "schema": {
    ...
    "configureDoubleClickHeight": {
      ...
      "settingsHandlerNamespace": "gpii.windows.nativeSettingsHandler",
      "key": "configureDoubleClickHeight",
      "supportedSettings": {
        "DoubleClickHeightConfig": {
          "schema": {
