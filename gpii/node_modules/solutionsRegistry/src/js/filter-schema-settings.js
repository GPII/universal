 ...
 * @param {Object} schema - The schema to filter.
 ...
 *
 */
gpii.universal.solutionsRegistry.filterSchemaToSettings = function (settingsPayload, schema, pathToSchemaProperties) {
    pathToSchemaProperties = pathToSchemaProperties || ["properties", "flat", "properties",  "contexts", "additionalProperties", "properties", "preferences", "properties"];
