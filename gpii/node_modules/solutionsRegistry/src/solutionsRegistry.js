...
(function () {
    ...
    fluid.defaults("gpii.solutionsRegistry", {
        ...
        components: {
            ...
            solutionSource: {
                type: "gpii.requestContextDataSource"
            },
            solutionQuerySource: {
                type: "gpii.requestContextDataSource"
            }
    ...
    fluid.demands("gpii.urlExpander", ["solutionsRegistry.development", "gpii.solutionsRegistry"], {
        options: {
            vars: {
    ...
    fluid.demands("rawSolutionSource", "gpii.solutionsRegistry", {
        funcName: "gpii.dataSource.CouchDB"
    });
    fluid.demands("rawSolutionQuerySource", "gpii.solutionsRegistry", {
        funcName: "gpii.dataSource.CouchDB"
    });
    fluid.demands("solutionSource", "gpii.solutionsRegistry", {
        options: {
            components: {
                rawSource: "{rawSolutionSource}"
            }
        }
    });
    fluid.demands("solutionQuerySource", "gpii.solutionsRegistry", {
        options: {
            components: {
                rawSource: "{rawSolutionQuerySource}"
            }
        }
    });
