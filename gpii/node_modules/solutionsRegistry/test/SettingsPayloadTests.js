        ...
        fluid.promise.sequence(promises).then(
            function () {
                ...
                fluid.each(validationTimesByFile, function (validationTimes, filename) {
                    ...
                    jqUnit.assertTrue("The uncached validation time for file '" + filename + "' should not be horrendous.", uncachedTime < 500);

                    var cachedTime = validationTimes.endCached - validationTimes.endUncached;
                    jqUnit.assertTrue("The cached validation time for file '" + filename + "' should be reasonable.", cachedTime < 50);
