...
(function () {
    ...
    var configurationSpec = [{
        ...
        "settingsHandlers": [{
            "type": "gpii.tests.configurationManager.mockSettingsHandler",
            "settings": {
    ...
    gpii.tests.configurationManager.mockSettingsHandler = function (data) {
    ...
    gpii.tests.configurationManager.runTests = function () {
        ...
        testCase.test("gpii.configurationManager.createPayloadForSettingsHandler()", function () {
            jqUnit.expect(1);
            var response = gpii.configurationManager.createPayloadForSettingsHandler("org.gnome.desktop.a11y.magnifier", createPayloadForSettingsHandlerRequest);
        ...
        testCase.test("gpii.configurationManager.invokeSettingsHandlers()", function () {
            jqUnit.expect(2);
            ...
            gpii.configurationManager.invokeSettingsHandlers("org.gnome.desktop.a11y.magnifier", invokeSettingsHandlersRequest, invokeSettingsHandlersRequestSnapshot);
        ...
        testCase.asyncTest("gpii.configurationManager.set() and del()", function () {
            ...
            confMan.del(undefined, function (success) {
                jqUnit.assertDeepEq("DEL: The original settings restored, stop message to launch handler, empty settings store", [], confMan.settingsStore);
                start();
            });
