...
(function () {
    ...
    gpii.tests.configurationManager.runTests = function () {
        ...
        testCase.test("gpii.configurationManager.invokeSettingsHandlers()", function () {
            ...
            jqUnit.assertDeepEq("invokeSettingsHandlers properly updated the settingsHandler block", invokeSettingsHandlersRequestSnapshot, invokeSettingsHandlersExpectedSnapshot);
        });
        ...
        testCase.asyncTest("gpii.configurationManager.set() and delete()", function () {
            ...
            confMan.delete(undefined, function (success) {
