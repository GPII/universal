    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                args: ["{arguments}.0", gpii.tests.dbDataStore.testData.gpiiKeyToCreate_noGpiiKey],
                event: "{that}.events.onResponse"
            }]
        }, {
            ...
            sequence: [{
                ...
                listener: "gpii.tests.dbDataStore.verifyFetchedGpiiKey",
                args: ["{arguments}.0", gpii.tests.dbDataStore.testData.gpiiKeyToCreate_withGpiiKey],
                event: "{that}.events.onResponse"
            }]
        }, {
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                args: ["{arguments}.0", gpii.tests.dbDataStore.testData.gpiiKeyToUpdate],
                event: "{that}.events.onResponse"
            }]
        }, {
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The record of gpiiKey is not found",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The document type must be \"gpiiKey\"",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The record of prefsSafe is not found",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                listener: "gpii.tests.dbDataStore.verifyUpdatedRecord",
                args: ["{arguments}.0", gpii.tests.dbDataStore.testData.prefsSafeToUpdate],
                event: "{that}.events.onResponse"
            }]
        }, {
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The input field \"prefsSafeId\" is undefined",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The document type must be \"prefsSafe\"",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The record of gpiiAppInstallationAuthorization is not found",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
