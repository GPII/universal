...
// The test data is from %dbOperation/test/data/*.json
...
fluid.defaults("gpii.tests.dbDataStore.findPrefsSafeByGpiiKey", {
    ...
    rawModules: [{
        ...
        tests: [{
            name: "Find preferences by a proper GPII key",
            sequence: [{
                func: "gpii.tests.dbOperation.invokePromiseProducer",
                args: ["{dbDataStore}.findPrefsSafeByGpiiKey", ["chrome_high_contrast"], "{that}"]
            }, {
                listener: "jqUnit.assertDeepEq",
                args: ["The expected client data is received", gpii.tests.dbDataStore.testData.findPrefsSafeByGpiiKey, "{arguments}.0"],
                event: "{that}.events.onResponse"
            }]
        }, {
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The input field \"gpiiKey\" is undefined",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
...
fluid.defaults("gpii.tests.dbDataStore.addPrefsSafe", {
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                func: "gpii.tests.dbOperation.invokePromiseProducer",
                args: ["{dbDataStore}.addPrefsSafe", [gpii.dbOperation.docTypes.prefsSafe, gpii.tests.dbDataStore.testData.prefsSafeToCreate], "{that}"]
            }, {
                listener: "gpii.tests.dbDataStore.saveAndInvokeFetch",
                args: ["{dbDataStore}.findPrefsSafeById", "{arguments}.0.id", "{that}"],
                event: "{that}.events.onResponse"
            }, {
                listener: "gpii.tests.dbDataStore.verifyFetchedPrefsSafe",
                args: ["{arguments}.0", gpii.tests.dbDataStore.testData.prefsSafeToCreate],
                event: "{that}.events.onResponse"
            }]
        }, {
            name: "Unsupported prefs safe type returns unauthorized error",
            sequence: [{
                func: "gpii.tests.dbOperation.invokePromiseProducer",
                args: ["{dbDataStore}.addPrefsSafe", ["non-existing-prefsSafe-type", {}], "{that}"]
            }, {
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
...
fluid.defaults("gpii.tests.dbDataStore.addAuthorization", {
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                func: "gpii.tests.dbOperation.invokePromiseProducer",
                args: ["{dbDataStore}.addAuthorization", [gpii.dbOperation.docTypes.gpiiAppInstallationAuthorization, gpii.tests.dbDataStore.testData.gpiiAppInstallationAuthorizationToCreate], "{that}"]
            }, {
                listener: "gpii.tests.dbDataStore.saveAndInvokeFetch",
