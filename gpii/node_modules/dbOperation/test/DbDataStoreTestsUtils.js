...
gpii.tests.dbDataStore.verifyFetchedGpiiKey = function (response, expected) {
    ...
    jqUnit.assertEquals("The \"prefsSafeId\" value has been set to default", expected.prefsSafeId, response.prefsSafeId);
    jqUnit.assertEquals("The \"prefsSafeContext\" value has been set to default", expected.prefsSafeContext, response.prefsSafeContext);
...
gpii.tests.dbDataStore.verifyFetchedPrefsSafe = function (response, expected) {
    gpii.tests.dbDataStore.verifyFetched(response, expected);
