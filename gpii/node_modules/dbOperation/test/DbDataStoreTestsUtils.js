...
fluid.defaults("gpii.tests.dbDataStore.environment", {
    ...
    pouchConfig: {
        databases: {
            gpii: {
                data: [
                    "%dbOperation/test/data/clientCredentials.json",
                    "%dbOperation/test/data/gpiiAppInstallationAuthorizations.json",
                    "%dbOperation/test/data/gpiiAppInstallationClients.json",
                    "%dbOperation/test/data/gpiiKeys.json",
                    "%dbOperation/test/data/prefsSafes.json",
...
gpii.tests.dbDataStore.saveAndInvokeFetch = function (fetchDataSource, id, that) {
    ...
    gpii.tests.dbOperation.invokePromiseProducer(fetchDataSource, [id], that);
};
...
gpii.tests.dbDataStore.verifyFetchedGpiiKey = function (response, expected) {
    // verify the GPII key
    ...
    gpii.tests.dbDataStore.verifyFetched(response, nonIdFields);
    ...
    jqUnit.assertEquals("The \"prefsSafeId\" value has been set to default", nonIdFields.prefsSafeId, response.prefsSafeId);
    jqUnit.assertEquals("The \"prefsSetName\" value has been set to default", nonIdFields.prefsSetName, response.prefsSetName);
...
gpii.tests.dbDataStore.verifyCreatedPrefsSafe = function (response, expected) {
...
gpii.tests.dbDataStore.verifyUpdatedRecord = function (response, expected) {
    gpii.tests.dbDataStore.verifyFetched(response, expected);
