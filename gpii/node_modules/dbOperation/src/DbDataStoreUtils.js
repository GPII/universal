 ...
 * @param data {Object} Contains GPII key and preferences safe information associated with a GPII key
 * An input example:
 * {
 *     key: {String},   // GPII key
 *     id: {String},    // GPII key
...
/**
* Transform the data in CouchDB form to a more understandable structure
 * @param data {Object} Contains both client and client credential information associated with an oauth2 client id
 * An input example:
 * {
...
/**
* Transform the data in CouchDB form to a more understandable structure
 * @param data {Object} Contains both client and authorization information associated with an access token
 * An input example:
 * {
 *     key: {String},   // access token
 *     id: {String},    // authorization id
