...
gpii.dbOperation.dbDataStore.addAuthorization = function (saveDataSource, authorizationType, authorizationData) {
    ...
    if (authorizationType !== gpii.dbOperation.docTypes.gpiiAppInstallationAuthorization) {
        error = gpii.dbOperation.composeError(gpii.dbOperation.errors.unauthorized, {docName: authorizationType});
        promiseTogo.reject(error);
        return promiseTogo;
    }
    ...
    if (!authorizationData) {
        error = gpii.dbOperation.composeError(gpii.dbOperation.errors.missingDoc, {docName: authorizationType});
        promiseTogo.reject(error);
        return promiseTogo;
    }
