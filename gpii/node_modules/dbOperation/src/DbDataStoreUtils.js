 ...
 * @param prefsSafeData {Object} The GPII key data. An example of the data:
 *  {
 *      prefsSafeId: {String},
...
gpii.dbOperation.dbDataStore.addGpiiKey = function (saveDataSource, gpiiKeyData) {
    ...
    if (!gpiiKeyData) {
        var error = gpii.dbOperation.composeError(gpii.dbOperation.errors.missingDoc, {docName: gpii.dbOperation.docTypes.gpiiKey});
        promiseTogo.reject(error);
    } else {
        data = {
            schemaVersion: gpii.dbOperation.schemaVersion,
            prefsSafeId: gpiiKeyData.prefsSafeId,
            prefsSafeContext: gpiiKeyData.prefsSafeContext,
            revoked: false,
            revokedReason: null,
        ...
        promiseTogo = gpii.dbOperation.dbDataStore.addRecord(saveDataSource, gpii.dbOperation.docTypes.gpiiKey, "id", data);
    }
    return promiseTogo;
};
