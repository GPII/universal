 ...
 * @param {String or Array} valueNotEmpty - One or more required field(s).
 ...
 * @param {String or Array} valueNotEmpty - One or a set of path name(s) to look up in the give obj.
