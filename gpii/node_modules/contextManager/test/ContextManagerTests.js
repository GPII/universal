...
fluid.defaults("fluid.tests.contextManagerTester", {
    ...
    modules: [{
        name: "gpii.contextManager.addActiveContext tests",
        tests: [
            {
                expect: 1,
                name: "Basic test",
                sequence: [ {
                    func: "fluid.tests.addActiveContextTest",
...
fluid.tests.addActiveContextTest = function (contextManager, event) {
    contextManager.addActiveContext(gpii.contextManager.tests.contextPayload, event);
};
...
gpii.contextManager.tests.testMatchEvaluatedResponse = function (evaluatedContext) {
    var expected = fluid.extend(true, {}, gpii.contextManager.tests.contextPayload, {
        ...
        activeConfiguration: {
            inferredConfiguration: gpii.contextManager.tests.standardMMOutput.inferredConfiguration["gpii-default"]
        }
    });

    jqUnit.assertDeepEq("checking return from addActiveContextTest", expected, evaluatedContext);
};
