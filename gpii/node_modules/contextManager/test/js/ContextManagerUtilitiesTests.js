    ...
    var findActiveContextsTests = {
        matchData: {
            "inferredConfiguration": {
                ...
                "all-bright_join_multi-condition": {
                    "applications": {
                        "mac.test": {
                            "active": true,
                            "settings": {
        ...
        tests: {
            ...
            "Single context, highest priority wins over position of the preference set in the file when the highest priority is above": {
                currentContexts: {
                    "http://registry.gpii.net/common/environment/illuminance": 950
                },
                expected: [ "all-bright","really-bright", "gpii-default" ]
            },
            "Matching one and default, feasible set is still based on conditions rather than priority": {
                currentContexts: {
                    "http://registry.gpii.net/common/environment/illuminance": 1100
                },
                expected: [ "really-bright", "gpii-default" ]
            },
            ...
            "multi context matching everything, priorities win over position of the preference set in the file when the highest priority is below": {
                currentContexts: {
                    "http://registry.gpii.net/common/environment/auditory.noise": 15,
                    "http://registry.gpii.net/common/environment/illuminance": 950
                },
                expected: [ "all-bright_join_multi-condition", "all-bright", "really-bright", "multi-condition", "multi-condition2", "gpii-default" ]
            },
            "multi context, priorities win over position of the preference set in the file when the highest priority is above": {
                currentContexts: {
                    "http://registry.gpii.net/common/environment/auditory.noise": 15,
                    "http://registry.gpii.net/common/environment/illuminance": 600
                },
                expected: [ "multi-condition", "multi-condition2", "gpii-default" ]
            }
        }
    };
