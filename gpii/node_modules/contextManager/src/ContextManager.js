...
(function () {
    ...
    fluid.defaults("gpii.contextManager", {
        ...
        invokers: {
            ...
            environmentChanged: "gpii.contextManager.environmentChanged({that}, {arguments}.0)" // body
        },
        modelListeners: {
            currentContext: {
    ...
    fluid.defaults("gpii.contexManager.app", {
        contextManager: {
        ...
        requestHandlers: {
            environmentChanged: {
                ...
                method: "put",
                handler: "gpii.contextManager.environmentChanged.handler"
            }
        }
    });
    ...
    gpii.contextManager.evaluateConditions = function (that, lifecycleManager, context) {
        ...
        lifecycleManager.update(finalPayload, function (response) {
            if (response.success) {
                ...
                $.extend(true, activeSession, finalPayload);
            }
