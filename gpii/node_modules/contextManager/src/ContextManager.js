...
gpii.contextManager.evaluateConditions = function (that, lifecycleManager, context) {
    ...
    var finalPayload = {
        ...
        activeConfiguration: {
            inferredConfiguration: activeConfiguration,
            lifecycleInstructions: that.transformer.configurationToSettings(activeConfiguration, activeSession.model.solutionsRegistryEntries)
        }
    };
 ...
 * @param fullPayload {Object} - the full structure output from the matchmaking process
 * @return {Object} - a filled-in shallow clone of fullPayload including activeContextName, activeConfiguration
 */
gpii.contextManager.addActiveContext = function (that, fullPayload, event) {
    ...
    contextPayload.activeConfiguration = {
        inferredConfiguration: fluid.extend(true, {}, fullPayload.matchMakerOutput.inferredConfiguration[contextPayload.activeContextName])
    };
    event.fire(contextPayload);
};
