...
(function () {
    ...
    gpii.contextManager.evaluateMatch = function (that, matchData, fullMMData, event) {
        ...
        //TODO: fixme:
        var tmpContext = that.transformer.settingsHandlerToLifecycle(activeContext, fullMMData.solutionsRegistry);
        // console.log("tmpCont4ext: "+JSON.stringify(tmpContext, null, 4));
        event.fire(activeContext.applications, fullMMData);
