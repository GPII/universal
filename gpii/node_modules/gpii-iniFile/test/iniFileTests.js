...
gpii.tests.iniFile.parserTestData = fluid.freezeRecursive({
    ...
    expect: [
        ...
        ["sectionBegin", []],
        // key1=value1
        ["gotValue", [], "key1", "value1", false],
        // key2=value2
        ["gotValue", [], "key2", "value2", false],
        // [section1]
        ["sectionBegin", ["section1"]],
        // s1key1=value-s1key1
        ["gotValue", ["section1"], "s1key1", "value-s1key1", false],
        // s1key2=value-s1key2
        ["gotValue", ["section1"], "s1key2", "value-s1key2", false],
        // # comment
        // [section2]
        ["sectionEnd", ["section1"]],
        ["sectionBegin", ["section2"]],
        // s2key1=value-s2key1
        ["gotValue", ["section2"], "s2key1", "value-s2key1", false],
        // s2key2="value-s2key2"
        ["gotValue", ["section2"], "s2key2", "value-s2key2", true],
        // [[section2A]]
        ["sectionBegin", ["section2", "section2A"]],
        // s2Akey1="""value-s2Akey1
        // line2-s2Akey1"""
        ["gotValue", ["section2", "section2A"], "s2Akey1", "value-s2Akey1\nline2-s2Akey1", true],
        // s2Akey2=value-s2Akey2
        ["gotValue", ["section2", "section2A"], "s2Akey2", "value-s2Akey2", false],
        // [[section2B]]
        ["sectionEnd", ["section2", "section2A"]],
        ["sectionBegin", ["section2", "section2B"]],
        // s2Bkey1=value-s2Bkey1
        //   line2-s2Bkey1
        ["gotValue", ["section2", "section2B"], "s2Bkey1", "value-s2Bkey1\nline2-s2Bkey1", false],
        // s2Bkey2=value-s2Bkey
        ["gotValue", ["section2", "section2B"], "s2Bkey2", "value-s2Bkey2", false],
        // implied from eof
        ["sectionEnd", ["section2", "section2B"]],
        ["sectionEnd", ["section2"]],
        ["sectionEnd", []]
    ]
});
...
jqUnit.test("inifile writing (new file)", function () {
