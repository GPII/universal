...
fluid.defaults("gpii.tests.pouchManager", {
    ...
    pouchConfig: {
        databases: {
            auth: {
                data: [
                    "%gpii-universal/gpii/node_modules/pouchManager/test/data/oauth2TestData.json"
                ]
            }
        }
    }
...
fluid.defaults("gpii.tests.pouchManager.caseHolder", {
    ...
    components: {
        ...
        initialViewRequest: {
            type: "kettle.test.request.http",
            options: {
                path: "/auth/_design/views/_view/findClientByOauth2ClientId?key=%22testComputer%22",
                port: gpii.tests.pouchManager.authDBServerPort,
                method: "GET"
            }
        },
