...
gpii.tests.pouchManager.dbServerPort = 1234;
...
fluid.defaults("gpii.tests.pouchManager", {
    ...
    dbServerPort: gpii.tests.pouchManager.dbServerPort,
    resetServerPort: gpii.tests.pouchManager.resetServerPort,
    pouchConfig: {
        databases: {
            gpii: {
                data: [
                    "%gpii-universal/gpii/node_modules/pouchManager/test/data/testData.json"
                ]
            }
        }
    }
...
fluid.defaults("gpii.tests.pouchManager.caseHolder", {
    ...
    components: {
        totalRequest: {
            ...
            options: {
                path: "/gpii",
                port: gpii.tests.pouchManager.dbServerPort,
                method: "GET"
            }
        },
        initialViewRequest: {
