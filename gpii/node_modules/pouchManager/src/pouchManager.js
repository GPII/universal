...
/*
 * Pouch Manager manages the pouchDB that is used as the GPII server data storage when GPII runs in the development mode. It provides:
 ...
 * @dbServerPort {Integer} The port on which the pouchDB express server will run.
...
fluid.defaults("gpii.pouchManager", {
    ...
    components: {
        ...
        pouchHarness: {
            ...
            options: {
                port: "{pouchManager}.options.dbServerPort",
