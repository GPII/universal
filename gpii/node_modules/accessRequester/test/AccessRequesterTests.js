...
fluid.require("%universal/gpii/node_modules/testing/src/setupNock.js");
...
fluid.defaults("gpii.tests.accessRequesterTests.success", {
    gradeNames: ["gpii.tests.accessRequesterTests", "gpii.test.setupNock"],
    ...
    nockSetupFunc: "gpii.tests.accessRequester.setupNock",
    nockSetupFuncArgs: gpii.tests.accessRequester.success.nockConfig
});
...
fluid.defaults("gpii.tests.accessRequesterTests.error.wrongClientCredential", {
    ...
    nockSetupFunc: "gpii.tests.accessRequester.setupNock",
    nockSetupFuncArgs: gpii.tests.accessRequester.error_wrongClientCredential.nockConfig
});
