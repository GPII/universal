...
gpii.tests.accessRequester.cleanNock = function () {
    nock.cleanAll();
};
...
// The add-on grade for "gpii.tests.accessRequesterTests" when nock is needed for mocking http server responses
fluid.defaults("gpii.tests.accessRequester.configNock", {
    gradeNames: "fluid.component",
    nockConfig: null,   // to be supplied by individual tests
    listeners: {
        "onCreate.setupNock": {
            listener: "gpii.tests.accessRequester.setupNock",
            args: ["{that}.options.nockConfig"]
        },
        "onDestroy.cleanNock": "gpii.tests.accessRequester.cleanNock"
    }
});
...
fluid.defaults("gpii.tests.accessRequesterTests", {
    ...
    accessRequesterGrade: null,   // supplied by individual tests
    nockConfig: null,   // supplied by individual tests
    distributeOptions: {
        ...
        nockConfig: {
            source: "{that}.options.nockConfig",
            target: "{that > accessRequester}.options.nockConfig"
        },
        accessRequesterGrade: {
            source: "{that}.options.accessRequesterGrade",
            target: "{that > accessRequester}.options.gradeNames"
        },
        testCaseHolderGrade: {
...
gpii.tests.accessRequester.success = {
    clientCredentialFilePath: "%universal/gpii/node_modules/accessRequester/test/data/clientCredential-correct.json",
    nockConfig: {
        request: {
            "grant_type": "password",
            "password": "dummy",
    ...
    modules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                args: ["{accessRequester}.getAccessToken", [gpii.tests.accessRequester.gpiiToken], "{that}"]
            }, {
                listener: "jqUnit.assertDeepEq",
                args: ["The response is expected with an access token", gpii.tests.accessRequester.success.nockConfig.response, "{arguments}.0"],
...
fluid.defaults("gpii.tests.accessRequesterTests.success", {
    ...
    nockConfig: gpii.tests.accessRequester.success.nockConfig
});

// 2. Error occurs due to the wrong client credentials
gpii.tests.accessRequester.error_wrongClientCredential = {
    clientCredentialFilePath: "%universal/gpii/node_modules/accessRequester/test/data/clientCredential-wrong.json",
    nockConfig: {
    ...
    modules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                args: ["The error is received", gpii.tests.accessRequester.error_wrongClientCredential.expected, "{arguments}.0"],
...
fluid.defaults("gpii.tests.accessRequesterTests.error.wrongClientCredential", {
    ...
    accessRequesterGrade: "gpii.tests.accessRequester.configNock",
    nockConfig: gpii.tests.accessRequester.error_wrongClientCredential.nockConfig
});
    ...
    modules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertLeftHand",
                args: ["The response is expected with an access token", gpii.tests.accessRequester.error_missingClientCredentialFile.expected, "{arguments}.0"],
                event: "{that}.events.onError"
            }]
        }]
    }]
