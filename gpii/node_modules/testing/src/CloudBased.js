...
gpii.test.cloudBased.computeAppInfo = function (solutionId, OSid) {
    var device = {
        OS: {
            id: OSid || "web"
        },
        ...
        fmrequest: {
            ...
            options: {
                ...
                termMap: {
                    ...
                    appinfo: {
                        expander: {
                            func: "gpii.test.cloudBased.computeAppInfo",
...
gpii.test.cloudBased.buildTestFixture = function (testDef, baseDir) {
    ...
    testDef.config = testDef.config || gpii.test.cloudBased.gpiiConfig(baseDir);
