/*
    ...
    A collection of functions to expand "test defs" and run them as tests.
...
// TODO: Replace all usages of kettle.test.bootstrapServer

// TODO: Organize and add docs throughout.

/**
 *
 *  A function that wraps test definitions in a test environment, case holder, and runs them.  Uses
 *  sequence elements instead of manipulating arrays.  Intended as a long-term replacement for
 *  `gpii.test.bootStrapServer`.
 *
...
gpii.test.testDefToServerEnvironment = function (testDef) {
    return gpii.test.testDefToEnvironment(testDef, "gpii.test.serverEnvironment", testDef.sequenceGrade || "gpii.test.standardServerSequenceGrade");
};

gpii.test.testDefToCouchEnvironment = function (testDef) {
    return gpii.test.testDefToEnvironment(testDef, "gpii.test.couchEnvironment", testDef.sequenceGrade || "gpii.test.couchSequenceGrade");
};

gpii.test.testDefToSnapshotEnvironment = function (testDef) {
    return gpii.test.testDefToEnvironment(testDef, "gpii.test.couchEnvironment", testDef.sequenceGrade || "gpii.test.snapshotSequenceGrade");
};

gpii.test.testDefToSnapshotWithInitialStateEnvironment = function (testDef) {
    return gpii.test.testDefToEnvironment(testDef, "gpii.test.couchEnvironment", testDef.sequenceGrade || "gpii.test.initialStateSequenceGrade");
};
