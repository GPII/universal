...
gpii.test.settleStructurePush = function (settleRec, holder, promise, key) {
    ...
    promise.then(function (value) {
        ...
        var errObj = { message: err };
        settleRec.togo.reject(kettle.upgradeError(errObj, " while resolving promise with key " + key));
    });
};
...
// introduced to assure that, for example, cleanup is done as part of GPII-4039
