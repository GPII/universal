...
gpii.test.cloudBased.oauth2.sendLoginRequest = function (loginRequest, options) {
    ...
    loginRequest.send(querystring.stringify(formBody));
};
...
gpii.test.cloudBased.oauth2.mainSequence = [{ // 0
        ...
        func: "gpii.test.cloudBased.oauth2.sendLoginRequest",
    ...
    }, {  // 6 - 2 variants here for omitting each form field
...
gpii.test.cloudBased.oauth2.buildTestFixture = function (testDef, commonRec, baseDir) {
    ...
    testDef.expect = 19;
    testDef.sequence = gpii.test.cloudBased.oauth2.mainSequence;
    return testDef;
};
...
gpii.test.cloudBased.oauth2.buildDisruptedFixture = function (testDef, commonRec, disruption, baseDir) {
    ...
    fluid.set(testDef, [options.recordName, "changes"], disruption.changes);
    return testDef;
};
...
gpii.test.cloudBased.oauth2.filter = function (model, options, filterName) {
    ...
    return gpii.test.cloudBased.oauth2.filterModel(model, changes);
};
...
gpii.test.cloudBased.oauth2.filterModel = function (model, changes) {
    ...
    fluid.requestChanges(applier, fluid.makeArray(changes));
