...
gpii.test.cloudBased.oauth2.verifyDataStoreAuthorization = function (dataStore, expectedAuthDecision, verificationDoneEvent) {
    var findWebPrefsConsumerAuthorizationPromise = dataStore.findWebPrefsConsumerAuthorization(expectedAuthDecision.gpiiToken,
                                                             expectedAuthDecision.clientId,
                                                             expectedAuthDecision.redirectUri);
    findWebPrefsConsumerAuthorizationPromise.then(function (foundAuthDecision) {
