...
// The CouchDB grade used for running tests. It cleans up and reloads data in between each test run.
// A more persistent CouchDB data loader for manually testing GPII is at
// gpii/configs/shared/gpii.config.couch.development.base.
...
fluid.defaults("gpii.test.assessComponentLeaksSequence", {
    gradeNames: ["fluid.test.sequenceElement"],
    sequence: [
        { func: "gpii.test.assessComponentLeaks",
...
fluid.defaults("gpii.test.snapshotSequenceGrade", {
    ...
    sequenceElements: {
        assessComponentLeaks: {
            gradeNames: "gpii.test.assessComponentLeaksSequence",
            priority: "first"
        },
        snapshot: {
