...
gpii.test.integration.environmentResolver = function (env) {
    return path.resolve(process.env[env]);
};

fluid.defaults("gpii.test.integration.resolverConfig", {
...
fluid.defaults("gpii.test.integration.testCaseHolder", {
    ...
    distributeOptions: [{
        ...
        source: "{that}.options.components.resolverConfig.type",
        target: "{that lifecycleManager > variableResolver}.options.components.resolverConfig.type"
    }],
    components: {
        resolverConfig: {
            type: "gpii.test.integration.resolverConfig"
        },
        exec: {
