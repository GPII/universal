...
gpii.test.integration.prepopulateSettingsStore = function (testCaseHolder, settings) {
    fluid.extend(true, testCaseHolder.settingsStore, { orig: settings });
};

gpii.test.integration.prepopulateSettingsSequence = fluid.freezeRecursive([
    {
        func: "gpii.test.integration.prepopulateSettingsStore",
        args: [ "{testCaseHolder}", "{testCaseHolder}.options.integrationPrepopulation" ]
    }
]);
