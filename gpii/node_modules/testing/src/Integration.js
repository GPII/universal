...
fluid.defaults("gpii.test.integration.testCaseHolder", {
    ...
    distributeOptions: [{
        ...
        record: {
            funcName: null,
            func: "{gpii.test.integration.deviceReporterAware}.nameResolver.resolveName"
        },
...
//mocs for platform specific resolvers here
gpii.test.integration.mockRegistryResolver = function (value) {
    return value.split("\\").join(".");
};

fluid.defaults("gpii.lifecycleManager.integrationResolverConfig", {
    gradeNames: ["fluid.littleComponent", "autoInit"],
    resolvers: {
        registry: "gpii.test.integration.mockRegistryResolver"
    }
});

fluid.defaults("gpii.lifecycleManager.integrationResolvers", {
    gradeNames: ["autoInit", "fluid.gradeLinkageRecord"],
    contextGrades: ["gpii.lifecycleManager.standardResolverConfig"],
    resultGrades: ["gpii.lifecycleManager.integrationResolverConfig"]
});
