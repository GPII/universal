...
gpii.test.integration.mockDeviceReporters.genericBoolean = function () {
    // TODO: Only return true after checking against static content
    return true;
};
...
gpii.test.integration.mockDeviceReportersRegistry.populate = function (that) {
    fluid.each(that.options.deviceReporters, function (options, key) {
        ...
        fluid.setGlobalValue(key, gpii.test.integration.mockDeviceReporters[options.mockFunc]);
    });
};
