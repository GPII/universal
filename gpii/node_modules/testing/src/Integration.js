...
gpii.test.integration.prepopulateSettingsStore = function (testCaseHolder, nameResolver) {
    var settingsHandlers = testCaseHolder.options.integrationPrepopulation;
    gpii.test.setSettings(settingsHandlers, nameResolver);
};
...
fluid.defaults("gpii.test.integration.testCaseHolder", {
    ...
    invokers: {
        prepopulateSettingsStore: {
            funcName: "gpii.test.integration.prepopulateSettingsStore",
            args: [ "{that}", "{nameResolver}" ]
        }
    },
    components: {
        exec: {
    ...
    listeners: {
        "onCreate.prepopulateSettingsStore": "{that}.prepopulateSettingsStore"
    }
});
