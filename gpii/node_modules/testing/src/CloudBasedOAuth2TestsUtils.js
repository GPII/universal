...
gpii.test.cloudBased.oauth2.runDisruptedTests = function (testDefsToDisrupt, config, testCaseGrade) {
    fluid.each(testDefsToDisrupt, function (testDefToDisrupt) {
        fluid.each(testDefToDisrupt.disruptions, function (disruption) {
            ...
            gpii.test.runTestDefs([disruptedTestDef], function (testDef) {
                ...
                //var gradedTestDef = gpii.test.testDefToEnvironment(testDef, "gpii.test.serverEnvironment", "gpii.test.standardServerSequenceGrade");
