...
gpii.test.cloudBased.oauth2.gpiiConfig = function () {
    return {
...
gpii.test.cloudBased.oauth2.runDisruptedTests = function (testDefsToDisrupt, baseDir) {
    fluid.each(testDefsToDisrupt, function (testDefToDisrupt) {
        fluid.each(testDefToDisrupt.disruptions, function (disruption) {
            var disruptedTestDef = gpii.test.cloudBased.oauth2.buildDisruptedFixture(testDefToDisrupt.testDef, {}, disruption, baseDir);
