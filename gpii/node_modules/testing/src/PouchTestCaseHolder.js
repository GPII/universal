...
fluid.defaults("gpii.test.pouch.pouchTestCaseHolder", {
    ...
    pouchConfig: {
        databases: {
            gpii: {
                data: [
                    "%universal/tests/data/dbData/clientCredentials.json",
                    "%universal/tests/data/dbData/gpiiAppInstallationClients.json",
                    "%universal/tests/data/dbData/gpiiKeys.json",
                    "%universal/tests/data/dbData/prefsSafes.json",
