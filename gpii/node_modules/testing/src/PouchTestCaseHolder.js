...
fluid.defaults("gpii.test.pouch.pouchTestCaseHolder", {
    ...
    pouchConfig: {
        databases: {
            gpii: {
                data: [
                    "%universal/tests/platform/cloud/dbData/clientCredentials.json",
                    "%universal/tests/platform/cloud/dbData/gpiiAppInstallationClients.json",
                    "%universal/tests/platform/cloud/dbData/gpiiKeys.json",
                    "%universal/tests/platform/cloud/dbData/prefsSafes.json",
