...
fluid.defaults("gpii.test.pouch.pouchTestCaseHolder", {
    ...
    pouchConfig: {
        databases: {
            gpii: {
                data: [
                    "%gpii-universal/tests/data/dbData/clientCredentials.json5",
                    "%gpii-universal/tests/data/dbData/gpiiAppInstallationClients.json5",
                    "%gpii-universal/tests/data/dbData/gpiiKeys.json5",
                    "%gpii-universal/tests/data/dbData/prefsSafes.json5",
