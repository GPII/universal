...
gpii.test.integration.mockSettingsHandler.returnAsyncResponse = function (value, isAsync, timeInMs) {
...
gpii.test.integration.mockSettingsHandler.setImpl = function (that, payload, solutionId) {
    ...
    var togo = gpii.test.integration.mockSettingsHandler.returnAsyncResponse(setSettings(), that.options.async, payload.settings.timeInMs);
    return togo;
};
...
gpii.test.integration.mockSettingsHandler.getImpl = function (that, payload, solutionId) {
    ...
    var togo = gpii.test.integration.mockSettingsHandler.returnAsyncResponse(response, that.options.asyncGet, payload.settings.timeInMs);
    return togo;
};
