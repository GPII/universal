...
gpii.test.buildSingleTestFixture = function (testDef, rootGrades) {
    var isIntegrationTest = fluid.find(rootGrades, function (val) {
        return val.startsWith("gpii.test.integration") ? true : undefined;
    });
    ...
    // if integration test, prepopulate 'settings' for process reporter
    if (isIntegrationTest) {
        gpii.test.unshift(testDef.sequence, gpii.test.integration.prepopulateSettingsSequence);
    }
