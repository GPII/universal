...
gpii.test.buildSingleTestFixture = function (testDef, rootGrades) {
    ...
    // Wait for the pouchDB to run before starting the test sequence, and demolish the pouchDB at the end of the test sequence.
    // PouchDB contains the data used by the preferences server and the auth server.
...
gpii.test.buildSegmentedFixtures = function (fixtures, baseTestDef) {
    return fluid.transform(fixtures, function (fixture) {
        var overlay = {
            ...
            sequence: gpii.test.pouch.addConstructFixturesToSequence(fluid.flatten(fixture.sequenceSegments))
        };
