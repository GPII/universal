...
gpii.test.checkConfiguration = function (settingsHandlers, nameResolver) {
    ...
    console.log("!!!*!*!!* checkConfiguration - expected " + JSON.stringify(noOptions, null, 2) + " actual " + JSON.stringify(config, null, 2));
...
fluid.defaults("gpii.test.common.testCaseHolder", {
    ...
    components: {
        ...
        userKeyactionRequest: {
            type: "kettle.test.request.http",
            options: {
                path: "/userKeyaction/%userToken",
                port: 8081,
                termMap: {
                    userToken: "{tests}.options.userToken"
                }
