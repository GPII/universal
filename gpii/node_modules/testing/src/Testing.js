 ...
 * @param {Object} settingsHandlers - A map of settings handler names to `settingsHandler` blocks as seen in the `settingsHandlers`
 * option of a `gpii.test.common.testCaseHolder`.
 * @param {Object} settingStore - The `settingsStore` member of a `gpii.test.common.testCaseHolder`. This will have a snapshot of
...
// Add pouchDB infrastructure to each test definition before running it.
