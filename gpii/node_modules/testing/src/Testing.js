...
*/
gpii.test.getSettings = function (payload) {
    var ret = {};
...
gpii.test.snapshotSettings = function (settingsHandlers, settingsStore) {
    settingsStore.orig = gpii.test.getSettings(settingsHandlers);
};
...
gpii.test.checkConfiguration = function (settingsHandlers) {
    var config = gpii.test.getSettings(settingsHandlers);
...
gpii.test.checkRestoredConfiguration = function (settingsHandlers, settingsStore) {
    var currentSettings = gpii.test.getSettings(settingsHandlers);
...
// Convert a record as returned by a "portable test" into a full testDefs structure as 
