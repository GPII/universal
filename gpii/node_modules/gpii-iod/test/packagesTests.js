...
jqUnit.asyncTest("testing package data signature verification", function () {
    ...
    var tests = [
        function () {
            // Verify it.
            return gpii.iod.verifySignedJSON(json, signature).then(function () {
        ...
        function () {
            ...
            return gpii.iod.checkPackageSignature(packageResponse).then(function (value) {
        ...
        function () {
            ...
            gpii.iod.verifySignedJSON(modified, signature).then(function () {
