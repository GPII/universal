 ...
 *
 * @property {String} installerArgs Additional arguments for the installer.
 * @property {String} uninstallerArgs Additional arguments for the uninstaller.
 *
 * @property {String|String[]} installerArgs Additional arguments to pass to the installer.
 * @property {String|String[]} uninstallerArgs Additional arguments to pass to the installer, when uninstalling.
 *
 * @property {String} uninstallTime When to uninstall this package, after it's no longer required: "immediate", "idle",
 *   "never".
 *
 * @property {Boolean} elevate true to install as the administrator (installer specific).
