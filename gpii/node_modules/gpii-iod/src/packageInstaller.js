...
gpii.iod.downloadInstaller = function (that) {
    ...
    that.installation.localPackage = path.join(that.installation.tempDir, that.packageData.installer);
    ...
    if (that.packageData.installerSource) {
        if (/^https?:\/\//.test(that.packageData.installerSource)) {
            ...
            var downloadPromise = gpii.iod.fileDownload(that.packageData.installerSource, that.installation.localPackage);
