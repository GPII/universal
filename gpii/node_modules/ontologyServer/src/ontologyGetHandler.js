...
(function () {
    ...
    fluid.defaults("kettle.requests.request.handler.ontologyGet", {
        ...
        invokers: {
            ...
            getHandler: {
                ...
                args: [ "{arguments}.0", "{request}", "{requestProxy}", "{ontologyServer}.ontologySource", "{ontologyServer}" ]
            }
        },
        events: {
    ...
    gpii.ontology.get.getHandler = function (rawPrefs, request, requestProxy, ontologySource, ontologyServer) {
