...
(function () {
    ...
    gpii.ontologyServer.development.set = function (ontologySource, callbackWrapper, directModel, model, callback) {
        ...
        //THe source === undefined is a temporary fix to GPII-668, caused by a broke
        //implementation of the ontology service. This should be fixed along with the rest of
        //GPII-672
