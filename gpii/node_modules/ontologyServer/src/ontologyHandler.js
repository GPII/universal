    ...
    fluid.defaults("kettle.requests.request.handler.ontologyGet", {
        ...
        invokers: {
            handle: {
                ...
                args: ["{that}", "{requestProxy}", "{request}", "{ontologyServer}", "{that}.events.onRawPreferences"],
                dynamic: true
            },
            getHandler: {
            ...
            viewGenerated: {
                funcName: "gpii.ontology.get.viewGenerated",
                args: [ "{arguments.0", "{requestProxy}"]
            }
        },
        events: {
            onRawPreferences: null,
            onViewGenerated: null
        },
        listeners: {
            onRawPreferences: "{that}.getHandler",
            onViewGenerated: "{that}.viewGenerated"
        }
    });

    gpii.ontology.get.request = function (that, requestProxy, request, ontologyServer, event) {
