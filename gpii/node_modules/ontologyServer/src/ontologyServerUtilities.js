...
fluid.registerNamespace("gpii.ontologyServer.transform");

gpii.ontologyServer.parsePreferences = function (preferences, to) {
...
gpii.ontologyServer.expandTransformations = function (transformations) {
    var expanded = {};
...
gpii.ontologyServer.transform.application = function (preferences, expandSpec, expander) {
