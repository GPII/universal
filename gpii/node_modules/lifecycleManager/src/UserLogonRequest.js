...
gpii.lifecycleManager.userLogonRequest.handleRequest = function (that, lifecycleManager, logonState) {
    ...
    // keep track of the last non-noUser for /proximityTriggered endpoint to verify its debounce rule
...
gpii.lifecycleManager.endProcessOneUserLogonRequest = function (lifecycleManager) {
    ...
    // "noUser" keyin into a separate process. The request failure needs to be furthur
    // investigated.
