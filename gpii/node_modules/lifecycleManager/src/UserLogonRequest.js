...
gpii.lifecycleManager.endProcessOneUserLogonRequest = function (lifecycleManager) {
    ...
    // "noUser" keyin before the current callback completes triggers this error. fluid.invokeLater()
    // helps to pull "noUser" keyin into a separate process. The request failure needs to be furthur
    // investigated.
