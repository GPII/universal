...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager", {
        ...
        listeners: {
            ...
            "onClearActionQueue.clearActionQueue": "gpii.lifecycleManager.clearActionQueue({that}.actionQueue)"
        },
    ...
    */
    ...
    gpii.lifecycleManager.clearActionQueue = function (queue) {
        while (queue.length > 0) {
            var item = queue.shift();
            item.promise.reject("clearActionQueue: clearing lifecycleManager promise from the action queue - remaining items: " + queue.length);
        }
    };
