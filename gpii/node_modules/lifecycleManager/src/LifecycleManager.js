...
(function () {
    ...
    gpii.lifecycleManager.readPreferences = function (that, preferences) {
        ...
        matchMakingPromise.then(function (payload) {
            ...
            var matchedSolutions = fluid.get(payload, ["activeConfiguration", "lifecycleInstructions"]);
            fluid.log("=== matchedSolutions: ", matchedSolutions);
            var settingsPromise = that.read(matchedSolutions);
