...
(function () {
     ...
     * This function is used by gpii-app to easily trigger a re-logon of the last environmental login, if for some
     * reason (e.g. the "reset to standard" function has been activated) the user has become logged out.
     *
     * @param {Component} that - An instance of gpii.lifecycleManager.
    ...
    gpii.lifecycleManager.replayEnvironmentalLogin = function (that, lastEnvironmentalLoginGpiiKey) {
        ...
        if (activeGpiiKey && activeGpiiKey !== "noUser") {
            ...
            promiseTogo = that.performLogin(lastEnvironmentalLoginGpiiKey);
        }
        return promiseTogo;
    };
