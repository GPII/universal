...
(function () {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    gpii.lifecycleManager.start = function (that, requestProxy, finalPayload, callback) {
        ...
        //   userToken, solutionsRegistryEntries: Assigned in initialPayload, consumer in UserUpdate
        var sessionState = $.extend(true, {
            actionResults: {}
        }, fluid.filterKeys(finalPayload, ["userToken", "activeConfiguration", "solutionsRegistryEntries"]));
