...
(function () {
    ...
    gpii.lifecycleManager.applyExistingPrefs = function (that, session, contextualPrefs, prefsAppliedLocalEvent) {
        ...
        session.applier.change("", {
            ...
            currentPreferences: gpii.lifecycleManager.getContextedPreferences(fullPayload.preferences, fullPayload.activeContextName)
        });
     ...
     */
    gpii.lifecycleManager.readPreference = function (that, preference, preferenceReadSuccessEvent, preferenceReadFailEvent) {
        ...
        matchMakingPromise.then(function (payload) {
            ...
            settingsPromise.then(function (allSettingValues) {
                ...
                if (fluid.jQueryStandalone.isEmptyObject(matchedPrefs)) {
                    ...
                    fluid.log("=== before, currentPreferences: ", session.model.currentPreferences);
                    session.applier.change(["currentPreferences"], fluid.extend(true, session.model.currentPreferences, matchedPrefs));
                    // session.applier.change("", {
                    //     currentPreferences: fluid.extend(true, session.model.currentPreferences, matchedPrefs),
                    //     gpiiKey: "noUser1"
                    // });
                    fluid.log("=== after, currentPreferences: ", session.model.currentPreferences);
