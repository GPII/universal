...
fluid.logObjectRenderChars = 16000;
    ...
    */
    ...
    gpii.lifecycleManager.executeActions = function (that, solutionId, solutionRecord, session, actionBlock, rootAction) {
        ...
        var sequence = fluid.transform(steps, function (action) {
            if (typeof(action) === "string") {
                ...
                if (action.startsWith("settings.")) {
                    ...
                    if (actionBlock === "isRunning") {
                        ...
                        fluid.set(solutionRecord, [ "launchHandlers", settingsHandlerBlockName, "settings"], { running: null })
            ...
            } else { // We allow free lifecycle actions, but strongly discourage them, since we dont have control of logging state like with settings/launch handlers
                return function () {
