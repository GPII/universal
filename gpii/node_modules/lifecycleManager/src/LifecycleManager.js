...
(function () {
    ...
    gpii.lifecycleManager.applyPreferences = function (that, preferences, prefsAppliedLocalEvent) {
        ...
        matchMakingPromise.then(function (newPayload) {
            ...
            session.applier.change(["solutionsRegistryEntries"], newPayload.solutionsRegistryEntries, "ADD", "PSP");
            session.applier.change(["activeConfiguration"], fullPayload.activeConfiguration, "ADD", "PSP");
