...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager", {
        ...
        invokers: {
            ...
            stop: {
                ...
                args: [ { func: "{that}.processStop", arg: "{arguments}.0" } ]
            },
            start: {
                noexpand: true,
                func: "{that}.addToQueue",
                args: [ { func: "{that}.processStart", arg: "{arguments}.0" } ]
            },
            update: {
                noexpand: true,
                func: "{that}.addToQueue",
                args: [ { func: "{that}.processUpdate", arg: "{arguments}.0" } ]
            },
            applySolution: {
    ...
    */
    ...
    gpii.lifecycleManager.processQueue = function (that, queue) {
        ...
        var item = queue.shift();
        var func = fluid.makeInvoker(that, item.func, "");
        var promise = func(item.arg);
