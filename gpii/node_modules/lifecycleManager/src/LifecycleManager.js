...
(function () {
    ...
    */
    ...
    gpii.lifecycleManager.removeSettingsBlocks = function (solutionEntry) {
        solutionEntry.handlers = fluid.transform(solutionEntry.handlers, function (handler) {
    ...
    gpii.lifecycleManager.recordSnapshotInSession = function (that, snapshot, solutionId, solutionRecord, session, settingsHandlerBlockName, rootAction) {
        if (rootAction === "start" || rootAction === "update") {
            ...
            toSnapshot.handlers[settingsHandlerBlockName] = snapshot;
    ...
    */
    gpii.lifecycleManager.executeSettingsAction = function (that, solutionId, solutionRecord, session, settingsHandlerBlockName, rootAction) {
        var settingsHandlerBlock = solutionRecord.handlers[settingsHandlerBlockName];
    ...
    gpii.lifecycleManager.transformSolutionSettings = function (solutionSettings, transformer) {
        ...
        togo.handlers = fluid.transform(solutionSettings.handlers, function (handlerBlock) {
            ...
            if (typeof(action) === "string") {
                ...
                if (action.indexOf("settings.") === 0) {
                    ...
                    if (actionBlock === "isRunning") {
                        ...
                        fluid.set(tmpSolutionRecord, [ "handlers", settingsHandlerBlockName, "settings"], { running: null });
                        ...
                        if (actionBlock === "start" || actionBlock === "stop") {
                            ...
                            fluid.set(solutionRecord, [ "handlers", settingsHandlerBlockName, "settings"], launchSettings);
                        }
    ...
    gpii.lifecycleManager.getSolutionRunningStateFromSnapshot = function (solutionSnapshot) {
        ...
        if (isRunningBlock && isRunningBlock.indexOf("settings.") === 0) {
            ...
            var recordedState = fluid.get(solutionSnapshot, ["ha", settingsHandlerBlockName, "settings", "running"]);
