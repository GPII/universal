...
(function () {
    ...
    gpii.lifecycleManager.applyWithNewPrefs = function (that, session, parsedPrefs, prefsAppliedLocalEvent) {
        var newPrefsSet = {};
        fluid.set(newPrefsSet, ["contexts", session.model.activeContextName, "preferences"], parsedPrefs);
        ...
        matchMakingPromise.then(function (newPayload) {
            ...
            fluid.set(fullPayload, ["currentPreferences"], gpii.lifecycleManager.getPreferencesForSet(fullPayload.preferences, fullPayload.activeContextName));
    ...
    gpii.lifecycleManager.applyExistingPrefs = function (that, session, parsedPrefs, prefsAppliedLocalEvent) {
        ...
        session.applier.change(["preferences", "contexts", session.model.activeContextName, "preferences"], parsedPrefs, "ADD", "userUpdate");
        ...
        session.applier.change("", {
            ...
            currentPreferences: gpii.lifecycleManager.getPreferencesForSet(fullPayload.preferences, fullPayload.activeContextName)
        });
    ...
    gpii.lifecycleManager.readPreferences = function (that, preferences, preferenceReadSuccessEvent, preferenceReadFailEvent) {
        ...
        var onePrefsSet = {};
        fluid.set(onePrefsSet, ["contexts", activeContextName, "preferences"], parsedPreferences);
    ...
    */
    ...
    gpii.lifecycleManager.processStart = function (that, userSession, finalPayload) {
        ...
        fluid.set(finalPayload, ["currentPreferences"], gpii.lifecycleManager.getPreferencesForSet(finalPayload.preferences, finalPayload.activeContextName));
