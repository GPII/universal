...
(function () {
    ...
    */
    ...
    gpii.lifecycleManager.processSnapshot = function (that, snapshot, solutionId, solutionRecord, session, settingsHandlerBlockName, rootAction) {
     ...
     * @param settingsReturn {Object} this object will contain the snapshotted settings (i.e. recorded before new
    ...
    gpii.lifecycleManager.executeSettingsAction = function (that, solutionId, solutionRecord, session, settingsHandlerBlockName, rootAction) {
        ...
        return function () {
            ...
            settingsPromise.then(function (snapshot) {
                ...
                gpii.lifecycleManager.processSnapshot(that, snapshot, solutionId, solutionRecord, session, settingsHandlerBlockName, rootAction);
            });
