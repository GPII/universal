...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager", {
        ...
        invokers: {
            ...
            restoreDefaultSettings: {
                funcName: "gpii.lifecycleManager.restoreDefaultSettings",
                args: ["{that}", "{arguments}.0"]
                                 // defaultSettings
            },
    ...
    */
    ...
    /** Reset the system to the default preferences set.
     * @param {Component} that - The gpii.lifecycleManager.
     * @param {Object} defaultSettings - The system default preferences set to be reset to.
     * @return {Promise} A promise for the action of resetting the system.
     */
    gpii.lifecycleManager.restoreDefaultSettings = function (that, defaultSettings) {
        var promiseTogo = fluid.promise();
        // Perform a local matchmaking to get matched solutions for existing and new preferences.
        ...
        matchMakingPromise.then(function (payload) {
            ...
            var lifecycleInstructions = gpii.transformer.configurationToSettings(payload.matchMakerOutput.inferredConfiguration[activeContextName], payload.solutionsRegistryEntries);
            var restorePromise = that.restoreSnapshot(lifecycleInstructions);
            fluid.promise.follow(restorePromise, promiseTogo);
        });
        return promiseTogo;
    };
