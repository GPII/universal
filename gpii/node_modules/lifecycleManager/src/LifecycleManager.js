    ...
    */
    gpii.lifecycleManager.invokeSettingsHandler = function (that, solutionId, handlerSpec, isMultiSH) {
        ...
        setSettingsPromise.then(function (handlerResponse) {
            console.log("Got handlerResponse of ", JSON.stringify(handlerResponse, null, 2), " for settings handler ", handlerSpec.type, " with payload ", JSON.stringify(settingsHandlerPayload, null, 2));
