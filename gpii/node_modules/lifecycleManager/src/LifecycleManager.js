...
(function () {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    // as a side-effect
    gpii.lifecycleManager.applySolution = function (that, solution, solutionId, solutionRecord, actions, sessionState) {
    ...
    gpii.lifecycleManager.update = function (that, requestProxy, options, solutions, callback) {
        ...
        fluid.each(solutions, function (solution, solutionId) {
            ...
            promises.push(that.applySolution(sol, solutionId, solution, actions, sessionState));
        });
