...
(function () {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    gpii.lifecycleManager.update = function (that, options, solutions, callback) {
        ...
        var togo = {};
        var promises = fluid.transform(solutions, function (solution, solutionId) {
            ...
            return gpii.lifecycleManager.applySolution(sol, solutionId, solution, actions, sessionState, that.nameResolver);
        });
