...
// require("../../settingsHandlers/src/WebSocketsComponent.js");
// TODO: Emergency fix for issue GPII-1232 which temporarily makes this file includable in the browser
    ...
    fluid.defaults("gpii.lifecycleManager", {
        ...
        listeners: {
            onCreate: {
                funcName: "gpii.lifecycleManager.mountWebSocketsSettingsHandler",
                args: ["{lifecycleManager}"]
            }
        }
    });

    gpii.lifecycleManager.mountWebSocketsSettingsHandler = function (lifecycleManager) {
        gpii.settingsHandlers.WebSockets = lifecycleManager.webSocketsSettingsHandler;
    };
