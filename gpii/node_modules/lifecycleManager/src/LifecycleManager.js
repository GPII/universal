...
(function () {
        ...
        invokers: {
            ...
            removeSolution: {
                ...
                args: ["{that}", "{arguments}.0", "{arguments}.1", "{arguments}.2", "{arguments}.3"]
                                  // toSnapshot, solutionId,  solutionRecord, sessionState, lifecycleBlockKeys
            },
            executeActions: {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
     ...
     * the list ofapplied solutions to the sessionState
     *
     * @param solutionId {String} the ID of the solution
     * @param solutionRecord {Object} is not modified and consists of the solution and setings to be applied
     * @param sessionState {Object} the object holding the state of the system
     * @param sessionState {Array} an ordered array of the lifecycle blocks to be executed
