    ...
    gpii.lifecycleManager.getSolutionRunningState = function (that, solutionId, solutionRecord, session) {
        if (!fluid.isDestroyed(that)) {
            ...
            promise.then(function (val) {
                ...
                // Create and return a new "response" variable instead of  using sessoin.model.runningOnLogin is because
                // sessoin.model.runningOnLogin won't get updated when isRunning === undefined.
                var response = {};
