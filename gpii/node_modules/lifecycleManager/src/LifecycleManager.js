...
(function () {
    ...
    // per handler
    // @param isMultiSH {boolean} is a flag denoting whether it's a multi-settings handlers solution
    ...
    gpii.lifecycleManager.specToSettingsHandler = function (solutionId, handlerSpec, isMultiSH) {
        ...
        if (handlerSpec.supportedSettings === undefined) {
            if (isMultiSH) {
                fluid.fail("Solution " + solutionId + " has multiple settingshandler but is missing " +
   ...
   //@param isMultiSH {boolean} if present and true, the solution has multiple settingshandlers
   // Payload example:
   //   http://wiki.gpii.net/index.php/Settings_Handler_Payload_Examples
   // Transformer output:
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    gpii.lifecycleManager.invokeSettingsHandlers = function (that, solutionId, handlerSpec, isMultiSH) {
    ...
    */
    gpii.lifecycleManager.executeSettingsAction = function (that, solutionId, solutionRecord, sessionState, settingsReturn, settingsHandlerBlockName) {
        ...
        return function () {
            ...
            var settingsPromise = that.invokeSettingsHandlers(solutionId, expanded, isMultiSH);
