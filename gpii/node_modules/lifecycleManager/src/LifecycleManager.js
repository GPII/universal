...
(function () {
    ...
    /**
     * Read corresponding setting values of the requested preferences.
     * @param {Component} that - An instance of gpii.lifecycleManager.
     * @param {Object} preference - The preference to read settings for. An example is:
     * "http://registry\\.gpii\\.net/common/magnification": {
     *     value: 3
     * }
     * @return {Promise} An promise whose resolved value is the an object with setting values read from the system.
     */
    gpii.lifecycleManager.readPreference = function (that, preference) {
        ...
        matchMakingPromise.then(function (payload) {
            ...
            settingsPromise.then(function (allSettingValues) {
                fluid.log("=== allSettingValues: ", allSettingValues);
                ...
                var matchMakerSettings = gpii.lifecycleManager.getMatchMakerSettings(allSettingValues[0], matchMakerSolutionRegistryEntries);
    ...
    /*
     * Remove settings that are not in the matchMaker result.
     * @param {Object} settingValues - An object with each element keyed by a solution id with its value being
    ...
    /*
     * If a settingsHandler's "capabilitiesTransformations" block has "noMatch" block defined, this setting will be
     * returned even when there isn't a matched preferences. This function is to remove this kind of settings.
     * @param {Object} settingValues - An object with each element keyed by a solution id with its value being
     * an object of setting values that this solution supports.
    ...
    gpii.lifecycleManager.removeNoMatchSettings = function (settingValues, preference, solutionRegistryEntries) {
        fluid.log("=== settingValues: ", settingValues);
        fluid.log("=== preference: ", preference);
        fluid.log("=== solutionRegistryEntries: ", solutionRegistryEntries);
        var settingsTogo = {};
        ...
        fluid.each(settingValues, function (settings, solutionId) {
            fluid.each(settings, function (settingValue, settingName) {
                ...
                fluid.each(settingsHandlers, function (oneSettingsHandler) {
                    ...
                    fluid.log("=== oneSettingCapabilitiesTransformation: ", oneSettingCapabilitiesTransformation);
        ...
        fluid.log("=== settingsTogo: ", settingsTogo);
        return settingsTogo;
    };
