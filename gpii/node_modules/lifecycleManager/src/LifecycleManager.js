...
(function () {
    ...
    */
    ...
    /**
     * Based on the current state of an application (ie. if it is running or not), and the recorded state
     ...
     * @param recordedRunState {boolean}: True if application was running on login
     * @return {Array} An array of actions (strings) that needs to be run to restore the application
     *       to its original state
     */
    gpii.lifecycleManager.selectRestoreActions = function (currentRunState, recordedRunState) {
        var actions;
        ...
        fluid.each(session.model.originalSettings, function (changesSolutionRecord, solutionId) {
            ...
            tasks.push(function () {
                if (!fluid.isDestroyed(that)) { // See above comment for GPII-580
                    ...
                    var actions = gpii.lifecycleManager.selectRestoreActions(currentRunState, recordedRunState);
