    ...
    */
    ...
    gpii.lifecycleManager.prefsSetNameChanged = function (that, forcePrefsSetName) {
        ...
        if (oldPrefsSetName === fullPayload.activePrefsSetName) {
            fluid.log(fluid.logLevel.TRACE, "contextManager: Same context as before (" + oldPrefsSetName + ") so doing nothing");
            return;
        }
        fluid.log("contextManager: Context changed from old context \"", oldPrefsSetName, "\" to new active context \"" + fullPayload.activePrefsSetName, "\" for the GPII key: ", activeGpiiKey);
