        ...
        dynamicComponents: {
            ...
            userLogonRequests: {
                ...
                options: {
                    ...
                    gpiiKey: "{arguments}.2",
                    requestPromise: "{arguments}.3"
                }
            }
        },
        members: {
            sessionIndex: {}, // map of gpiiKey to session component member name, managed by gpii.lifecycleManager.sessionIndexer
            userLogonRequestIndex: {}, // map of request item if to user logon request component member name,
                                       // managed by gpii.lifecycleManager.userLogonRequestIndexer
