...
(function () {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    gpii.lifecycleManager.buildSettingsResolver = function (lifecycleInstructions) {
        // build settings resolvers:
        var settingsResolver = {};
        fluid.each(lifecycleInstructions, function (content, id) {
    ...
    gpii.lifecycleManager.start = function (that, requestProxy, finalPayload, callback) {
        ...
        var settingsResolver = gpii.lifecycleManager.buildSettingsResolver(lifecycleInstructions);
