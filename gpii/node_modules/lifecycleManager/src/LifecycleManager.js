   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    gpii.lifecycleManager.update = function (that, options, solutions, callback) {
        ...
        fluid.each(solutions, function (solution) {
            ...
            if (solIndex === undefined) { // TODO: This branch consists of dead code which has never been tested or probably run
    ...
    gpii.lifecycleManager.start = function (that, options, solutions, callback) {
        ...
        fluid.each(solutions, function (solution) {
            ...
            gpii.lifecycleManager.applySolution(togo, solution, solution.lifecycleManager.start, sessionState, that.nameResolver);
        });
