...
(function () {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    gpii.lifecycleManager.applySolution = function (solution, sessionState) {
        var solutionCpy = fluid.copy(solution);
        solutionCpy.settingsHandlers = gpii.lifecycleManager.executeActions(
            solution.id, solution.settingsHandlers, solution.lifecycleManager.start, sessionState);
    ...
    gpii.lifecycleManager.start = function (activeSessions, resolver, stop, options, solutions, callback) {
        ...
        fluid.each(solutions, function (solution) {
            ...
            gpii.lifecycleManager.applySolution(solution, sessionState);
        });
