...
(function () {
   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    ...
    gpii.lifecycleManager.applySolution = function (solution, solutionId, solutionRecord, actions, sessionState) {
        solution.settingsHandlers = gpii.lifecycleManager.executeActions(
            solutionId, solutionRecord.settingsHandlers, actions,
            sessionState);
    ...
    gpii.lifecycleManager.start = function (activeSessions, resolver, stop, options, solutions, callback) {
        ...
        fluid.each(solutions, function (solution, solutionId) {
            ...
            gpii.lifecycleManager.applySolution(togo, solution, solutionId,
