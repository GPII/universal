...
(function () {
    ...
    */
    ...
    gpii.lifecycleManager.getSession = function (activeSession) {
    ...
    gpii.lifecycleManager.stop = function (that, requestProxy, options, callback) {
        var sessionState = that.activeSession;
        if (!sessionState) {
            callback(false);
            return;
        }
        ...
        sequence.then(function () {
            delete that.activeSession;
            that.activeUserTokens = [];
            callback(true);
        }, function (error) {
    ...
    gpii.lifecycleManager.start = function (that, requestProxy, finalPayload, callback) {
        ...
        if (that.activeUserTokens.length > 0) {
            var userTokens = [];
        ...
        that.activeUserTokens.push(sessionState.userToken);
        var tasks = [];
        fluid.each(lifecycleInstructions, function (solution, solutionId) {
            tasks.push(function () {
        ...
        that.activeSession = sessionState;
