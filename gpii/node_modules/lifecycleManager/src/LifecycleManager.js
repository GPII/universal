...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager", {
        ...
        events: {
            ...
            onPrefsUpdated: null,           // fired with [gpiiKey, {session}.model.preferences]
            onClearQueue: null
        },
        listeners: {
        ...
        invokers: {
            ...
            getSession: {
                ...
                args: ["{that}", "{arguments}.0"] // GPII key
            },
            processQueue: {
    ...
    gpii.lifecycleManager.applyPreferences = function (that, preferences, prefsAppliedEvent) {
        fluid.log("Lifecycle Manager: Received preferences update ", preferences);
        ...
        // in order to distinguish from model.preferences change requests triggered by initial user key-in and the context manager
        session.applier.change(["preferences", "contexts", session.model.activeContextName, "preferences"], contextualPrefs, "ADD", "PrefsUpdated");
        ...
        that.update(fullPayload).then(prefsAppliedEvent.fire);
    };
    ...
    // Will return one of the user's GPII key keys for an active session
