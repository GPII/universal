...
// new preferences that don't exist in lifecycleManager.session.model.preferences.
 ...
 gpii.lifecycleManager.privateMatchMaker.doMatch = function (that, deviceReporterDataSource, gpiiKey, preferences) {
     ...
     devicePromise.then(function (deviceData) {
         ...
         fluid.log("Private Match Maker, doMatch - error at receiving device data: " + err.message);
