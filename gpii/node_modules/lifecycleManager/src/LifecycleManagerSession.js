...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager.session", {
        ...
        modelListeners: {
            preferences: {
                ...
                args: ["{that}.options.gpiiKey", "{change}.value", "{change}.transaction.sources", "{gpii.lifecycleManager}.events.onPrefsUpdated"]
            }
        },
        members: {
    ...
    gpii.lifecycleManager.session.savePrefsUpdates = function (gpiiKey, preferences, transactionSources, onPrefsUpdated) {
        if (transactionSources.PrefsUpdated) {
            onPrefsUpdated.fire(gpiiKey, preferences);
        }
    };
