...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager.session", {
        ...
        model: {
            // Keep track of the GPII key that is currently keyed-in. Set to "undefined" when no key is keyed in.
            gpiiKey: undefined,
            actionResults: {},
            originalSettings: {},
            appliedSolutions: {}
    ...
    gpii.lifecycleManager.session.savePrefsUpdates = function (that, preferences, transactionSources, onAutoSaveRequired) {
        ...
        if (transactionSources.userUpdate) {
            ...
            var prefsInActiveContext = fluid.get(preferences, ["contexts", that.model.activePrefsSetName, "preferences"]);
