...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager.session", {
        ...
        modelListeners: {
            preferences: {
                listener: "{gpii.lifecycleManager}.events.onPrefsUpdated.fire",
                args: ["{that}.options.gpiiKey", "{change}.value"]
            }
        },
        members: {
    ...
    */
    ...
    gpii.lifecycleManager.computeLocalFetcher = function (session, actionResultsFetcher) {
        // let the user's GPII key as well as any named action results accumulated
        ...
        return gpii.combineFetchers(
            gpii.resolversToFetcher({gpiiKey: session.options.gpiiKey}),
