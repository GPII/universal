...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager.session", {
        ...
        modelListeners: {
            preferences: {
                ...
                args: ["{that}.options.gpiiKey", "{change}.value", "{change}.transaction.sources", "{gpii.lifecycleManager}.events.preferencesUpdated"]
            }
        },
        members: {
    ...
    gpii.lifecycleManager.session.savePrefsUpdates = function (gpiiKey, preferences, transactionSources, preferencesUpdated) {
        if (transactionSources.PrefsUpdated) {
            preferencesUpdated.fire(gpiiKey, preferences);
        }
    };
