...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager.session", {
        ...
        model: {
            ...
            // for PSPChannle clients.
            currentPreferences: {},

            // Incremented by 1 at reading a preference. It forces a model change even if a preferenceread
            // receives an unchanged setting value.
