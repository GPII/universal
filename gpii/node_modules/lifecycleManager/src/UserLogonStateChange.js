...
gpii.lifecycleManager.userLogonHandling.handleResetGpiiKey = function (that, lifecycleManager) {
    ...
    var defaultSettings = that.options.defaultSettings;
    ...
    if (defaultSettings) {
        fluid.log("Reset: restoring the system to the default settings: ", defaultSettings);
        resetActions.push(lifecycleManager.restoreSnapshot(defaultSettings));
    }
