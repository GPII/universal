...
gpii.lifecycleManager.userLogonHandling.errorResponse = function (that, message, statusCode, userErrors) {
...
fluid.defaults("gpii.lifecycleManager.userLogonHandling.stateChangeHandler", {
    invokers: {
        ...
        errorResponse: {
            ...
            args: ["{that}", "{arguments}.0", "{arguments}.1", "{lifecycleManager}.userErrors"]
                                // message, statusCode
        }
    },
    events: {
...
fluid.defaults("gpii.lifecycleManager.untrusted.stateChangeHandler", {
    ...
    listeners: {
        "onGpiiKey.setGpiiKey": {
            listener: "gpii.lifecycleManager.setGpiiKey",
            args: ["{that}", "{arguments}.0"]
        },
