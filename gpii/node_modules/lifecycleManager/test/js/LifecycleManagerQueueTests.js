...
(function () {
     ...
     * is called with
     *
     * @param {int} timeout - The number of ms the function should wait before resolving (or rejecting) the promise.
     * @param {String (or function)} func - The function to call after `timeout` ms, immediately before resolving or rejecting the promise.
