...
(function () {
    ...
    fluid.defaults("gpii.tests.qssSettingsLoader", {
        gradeNames: ["fluid.component"],
        invokers: {
            get: "gpii.tests.qssSettingsLoader.get"
        }
    });
    gpii.tests.qssSettingsLoader.get = function () {
        return {
    ...
    gpii.tests.lifecycleManager.queue.mockQssSettingsLoaderOptions = {
        components: {
            qssSettingsLoader: {
                type: "gpii.tests.qssSettingsLoader"
            },
            privateMatchMaker: {
    ...
    jqUnit.asyncTest("Tasks are being processed on addition", function () {
        var lifecycleManager = gpii.lifecycleManager(gpii.tests.lifecycleManager.queue.mockQssSettingsLoaderOptions);
        jqUnit.expect(1);
