...
(function () {
    ...
    fluid.defaults("gpii.tests.lifecycleManager.resolver.resolverConfig", {
        ...
        resolvers: {
            session: "", // TODO: Fill this in with the live session resolver
            solution: "" // TODO: Fill this in with the solution resolver details.
        }
    });
    ...
    gpii.tests.lifecycleManager.resolver.runSingleTest = function (testDef) {
        jqUnit.test(testDef.message, function () {
            //gpii.tests.lifecycleManager.resolver.setup();
    ...
    fluid.defaults("gpii.tests.lifecycleManager.resolver.testRunner", {
        ...
        testDefs: {
            ...
            solutionResolver: {
                message: "Solution resolver tests",
                startPayload: {
                    gpiiKey: "resolver-tests",
                    activeConfiguration: {
                        lifecycleInstructions: {}
                    ...
                    solutionsRegistryEntries: {
                        "dotted.namespace.entry": {
                            "deep": {
                                "value": "data from the solution."
                            }
                        }
                    }
                },
                toExpand: {
                    solutionData: "${{solution}.dotted.namespace.entry.deep.value}"
                },
                expectedResults: {
                    solutionData: "data from the solution."
                }
            }
        },
        invokers: {
