...
(function () {
    ...
    gpii.tests.lifecycleManager.buildSettingsHandlersEntry = function (settings, setRunning) {
        var togo = {
            "settingsHandlers": {
                "myconf": {
        ...
        if (setRunning !== undefined) {
            fluid.set(togo, [ "settingsHandlers", "launcher", "settings" ], { running: setRunning })
        }
        return togo;
    };
    ...
    gpii.tests.lifecycleManager.initBackingMock = function (origSettings, setRunning) {
        ...
        var setRunning = (setRunning === undefined) ? false : setRunning; // default to false
    ...
    // TODO KASPER: Remove this and all references (probably)
    ...
    gpii.tests.lifecycleManager.startTestDefs = [{
        name: "Solution with only start and stop blocks",
        ...
        name: "solution with only configure and restore blocks",
        basePayload: gpii.tests.lifecycleManager.buildLifecycleInstructions(
            "org.gnome.desktop.a11y.magnifier",
            {
                "active": true,
    ...
    gpii.tests.lifecycleManager.updateTestDefs = [{
        ...
        loginSettings: { "cross-hairs-clip": true, "cross-hairs-color": "red" },
        runningAfterLogin: true,
        updateSettings: { "cross-hairs-clip": false, "cross-hairs-color": "green" }, // dont expect these to apply
        runningAfterUpdate: true,
        expectedSettings: { "cross-hairs-clip": true, "cross-hairs-color": "red" },
        expectedLaunchHandlerCalls: 2
    }, {
     ...
     * expectedAfterLogin: the expected "appliedSolutions" of the session after login
     ...
     * expectedAfterUpdate: the expected "appliedSOlutions" of the session after update call
     ...
     */
    gpii.tests.lifecycleManager.runLifecycleTest = function (testDef) {
        ...
        jqUnit.asyncTest(testDef.name, function () {
            ...
            lifecycleManager.start(gpii.tests.lifecycleManager.buildStartPayload(testDef.loginPayload), function (success) {
                jqUnit.assertTrue("gpii.lifecycleManager.start() succeeds", success);
                var session = lifecycleManager.getSession(123); // always just use the default user token
                jqUnit.assertDeepEq("Checking appliedSolutions after start", testDef.expectedAfterLogin, session.model.appliedSolutions);
                ...
                if (testDef.updatePayload) {
                    lifecycleManager.update(gpii.tests.lifecycleManager.buildStartPayload(testDef.updatePayload), function () {
                        jqUnit.assertDeepEq("Checking appliedSolutions after update", testDef.expectedAfterUpdate, session.model.appliedSolutions);
                        ...
                        lifecycleManager.stop(gpii.tests.lifecycleManager.userOptions, stopCycle);
                    });
                } else {
                    lifecycleManager.stop(gpii.tests.lifecycleManager.userOptions, stopCycle);
                }
    ...
    gpii.tests.lifecycleManager.buildUpdateTests = function () {
        fluid.each(gpii.tests.lifecycleManager.updateTestDefs, function (test) {
            var expectedOriginal = gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.originalSettings, test.runningOnLogin));
            var loginPayload = gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.loginSettings));
            var expectedAfterLogin = gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.loginSettings, test.runningAfterLogin));
            var updatePayload = gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.updateSettings));
            var expectedAfterUpdate = gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.expectedSettings, test.runningAfterUpdate));
            var originalRunSetting = test.expectedLaunchHandlerCalls === 0 ? undefined : test.runningOnLogin;
            ...
            var expectedOriginalSettingsAfterUpdate = gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                gpii.tests.lifecycleManager.buildSettingsHandlersEntry(originalSettingsAfterUpdate, test.runningOnLogin));
            ...
            gpii.tests.lifecycleManager.runLifecycleTest(testDef);
        });
    };
        ...
        fluid.each(gpii.tests.lifecycleManager.startTestDefs, function (test) {
            var testDef = {
                ...
                loginPayload: gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                    gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.appliedSettings)),
                expectedAfterLogin: gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                    gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.appliedSettings, test.runningAfterLogin)),
                runningAfterLogin: test.runningAfterLogin,
                ...
                expectedOriginal: gpii.tests.lifecycleManager.extendLifecycleInstructions(test.basePayload,
                    gpii.tests.lifecycleManager.buildSettingsHandlersEntry(test.originalSettings, test.expectedLaunchHandlerCalls === 0 ? undefined : test.runningOnLogin))
            };
