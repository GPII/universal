...
// >>>>>>> amb26/GPII-434
    ...
    gpii.tests.lifecycleManager.mockSettingsHandler = {
        set: function (data) {
            ...
            gpii.invokeLater(function () {
                ...
                togo.resolve(response);//gpii.tests.lifecycleManager.responseToSnapshotRequest);
            }, 100);
            return togo;
        },
        get: function (data) {
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        jqUnit.asyncTest("gpii.lifecycleManager.update() with active user session", function () {
            ...
            lifecycleManager.start(gpii.tests.lifecycleManager.userOptions, gpii.tests.lifecycleManager.configurationSpec, function (success) {
                jqUnit.assertTrue("gpii.lifecycleManager.start() succeeds", success);

                lifecycleManager.update(gpii.tests.lifecycleManager.userOptions, gpii.tests.lifecycleManager.configurationSpec, function () {
