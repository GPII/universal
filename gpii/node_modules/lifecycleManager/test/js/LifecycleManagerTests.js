...
(function () {
    ...
    gpii.tests.lifecycleManager.privateMatchMakerOptions = {
        components: {
            privateMatchMaker: {
    ...
    gpii.tests.lifecycleManager.resolverConfigOptions = {
        distributeOptions: {
            "resolverConfig": {
    ...
    gpii.tests.lifecycleManager.testOptions = fluid.extend(true, {}, gpii.tests.lifecycleManager.privateMatchMakerOptions, gpii.tests.lifecycleManager.resolverConfigOptions);
    ...
    gpii.tests.lifecycleManager.assertNoActiveSessions = function (lifecycleManager, message) {
        jqUnit.assertDeepEq(message + "- session state should be empty", [], lifecycleManager.getActiveSessionGpiiKeys());
    };
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        jqUnit.asyncTest("gpii.lifecycleManager.invokeSettingsHandlerSet()", function () {
            jqUnit.expect(2);
            var lifecycleManager = gpii.lifecycleManager(gpii.tests.lifecycleManager.privateMatchMakerOptions);
            ...
            var testCases = {
                caseRegular: {
                    ...
                    preferences: {
                        ...
                        "http://registry.gpii.net/common/pitch": 0.75,
