...
(function () {
    ...
    var lifecycleManagerTestOptions = {
        distributeOptions: {
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        jqUnit.asyncTest("gpii.lifecycleManager.start() and stop()", function () {
            ...
            jqUnit.expect(5);
            var lifecycleManager = gpii.lifecycleManager(lifecycleManagerTestOptions);
        ...
        jqUnit.test("gpii.lifecycleManager.update() without active session", function () {
            try {
                ...
                lifecycleManager.update(options, configurationSpec);
            } catch (e) {
        ...
        jqUnit.test("gpii.lifecycleManager.update() with active user session", function () {
            ...
            fluid.set(lifecycleManager, "activeSessions", sampleActiveSession);
            lifecycleManager.start(options, configurationSpec, function (success) {
                console.log("Start success: " + success);
            });
            lifecycleManager.update(options, configurationSpec, function () {
                var sessionSolutions = lifecycleManager.activeSessions[options["userToken"]]["solutions"];
