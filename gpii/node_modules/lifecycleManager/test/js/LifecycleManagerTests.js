...
(function () {
    ...
    gpii.tests.lifecycleManager.assertExpectedSettingsHandler = function (message, expected) {
        jqUnit.assertDeepEq("expected input sent to settingsHandler" + message, expected,
            gpii.tests.staticRepository.settingsHandler);
    };
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        jqUnit.asyncTest("gpii.lifecycleManager.start() and stop()", function () {
            ...
            lifecycleManager.start(options, configurationSpec, function () {
                gpii.tests.lifecycleManager.assertExpectedExec();
                gpii.tests.lifecycleManager.assertExpectedSettingsHandler(" - on start",
                    settingsHandlerExpectedInputNewSettings);
                lifecycleManager.stop(options, function () {
                    gpii.tests.lifecycleManager.assertExpectedSettingsHandler(" - on stop",
                        settingsHandlerExpectedInputRestoreSettings);
