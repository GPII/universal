...
(function () {
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        jqUnit.test("gpii.lifecycleManager.update() catch fail", function () {
            try {
        ...
        jqUnit.test("gpii.lifecycleManager.update() success", function () {
            jqUnit.expect(1);
            ...
            lifecycleManager.update(options, configurationSpec, function (result) {
                jqUnit.assertTrue("Update method succeeds with ongoing session", result.success);
            });
        });
    };
}());
