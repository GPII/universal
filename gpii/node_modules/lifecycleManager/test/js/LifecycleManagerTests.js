...
(function () {
     ...
     *
     * @param currentInstructions {Object} a set of lifecycle instructions keyed by a solution id. For example,
     *    this could be the output of the buildLifecycleInstructions function.
     * @param arguments {..Object..} The remaining arguments should be valid lifecycleInstructions that will
     *    be extended onto the original
     * @param return {Object} The original lifecycle instructions, but with the remaining arguments fluid.extend'ed
