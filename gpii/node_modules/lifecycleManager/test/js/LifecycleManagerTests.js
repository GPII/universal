...
(function ($) {
    ...
    gpii.tests.lifecycleManager.buildSolutionEntry = function (solId, handlers, otherLFs) {
        var togo = {};
        togo[solId] = $.extend(true, {}, handlers, otherLFs);
        return togo;
    };
    ...
    gpii.tests.lifecycleManager.configurationSpec = gpii.tests.lifecycleManager.buildSolutionEntry("org.gnome.desktop.a11y.magnifier",
        {
            "settingsHandlers": {
                "myconf": {
    ...
    gpii.tests.lifecycleManager.buildSolutionEntry("org.gnome.desktop.a11y.magnifier",
        {
            "settingsHandlers": {
                "myconf": {
                    "type": "gpii.tests.lifecycleManager.mockSettingsHandler",
    ...
    gpii.tests.lifecycleManager.updateTestDefs = [{
        ...
        updateSpec: gpii.tests.lifecycleManager.buildSolutionEntry("org.gnome.desktop.a11y.magnifier", {
            "settingsHandlers": {
                "myconf": {
                    "type": "gpii.tests.lifecycleManager.mockSettingsHandler",
                    "settings": {
        ...
        expectedAppliedSolutions: gpii.tests.lifecycleManager.buildSolutionEntry("org.gnome.desktop.a11y.magnifier", {
            "settingsHandlers": {
                "myconf": {
                    "type": "gpii.tests.lifecycleManager.mockSettingsHandler",
                    "settings": {
        ...
        expectedOriginalSettings: gpii.tests.lifecycleManager.buildSolutionEntry("org.gnome.desktop.a11y.magnifier", {
            "settingsHandlers": {
                "myconf": {
                    "type": "gpii.tests.lifecycleManager.mockSettingsHandler",
                    "settings": {
