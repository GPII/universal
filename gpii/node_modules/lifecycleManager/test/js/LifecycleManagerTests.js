...
(function () {
    ...
    gpii.tests.lifecycleManager.isRunningTests = function () {
        jqUnit.asyncTest("Tests for correct behavior when application is not already running", function () {
            // call start block for solution
            gpii.tests.lifecycleManager.setup();
            ...
            // expect the isRunning block to be called (will return false)
            // do NOT expect the 'update' block to be called
            // DO expect the 'start' block to be called
            // the correct state should be stored
            // the correct state should be applied
            // on logout DO expect the 'stop' block to be called
            // the correct state should be restored

            // TEST: Running on startup - no reference to start/stop block in update
            // call start block for solution
            // get for isRunning block should be called (will return true)
            // Expect the update block to be called
            // do NOT expect the start block to be called
            // The correct state should be stored
            // The correct state should be applied
            // on logout, update should be called
            // do NOT expect the stop block to be called
            //


            // TEST: Running on startup
        });
    };
    ...
    gpii.tests.lifecycleManager.runTests = function () {
        ...
        gpii.tests.lifecycleManager.isRunningTests();
