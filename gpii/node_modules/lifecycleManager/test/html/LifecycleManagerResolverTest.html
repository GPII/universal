...
<html>
    <head>
        ...
        <title>GPII Lifecycle Manager Resolver Tests</title>
        ...
        <script src="../js/LifecycleManagerResolverTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Lifecycle Manager Resolver Tests</h1>
        ...
        <script>
            gpii.tests.lifecycleManager.resolver.testRunner();
        </script>
    </body>
</html>
