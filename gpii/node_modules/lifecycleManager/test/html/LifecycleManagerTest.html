...
<html>
    <head>
        ...
        <script src="../../../settingsHandlers/src/settingsHandlerUtilities.js"></script>
        <script src="../../../matchMakerFramework/src/MatchMakerUtilities.js"></script>
        <script src="../../../gpii-user-errors/src/UserErrors.js"></script>
        <script src="../../../testing/src/Mocks.js"></script>
        <script src="../../../testing/src/TestUtils.js"></script>
        <script src="../../../testing/src/Integration.js"></script>
        <script src="../../src/Resolvers.js"></script>
        <script src="../../../../../build/tests/browserify/util.js"></script>
        <script src="../../../flowManager/src/SystemUtils.js"></script>
        <script src="../../../transformer/src/js/Transformer.js"></script>
        <script src="../../src/LifecycleManagerSession.js"></script>
        <script src="../../src/UserLogonRequest.js"></script>
        <script src="../../src/LifecycleManagerUtils.js"></script>
        ...
        <script src="../js/LifecycleManagerQueueTests.js"></script>
