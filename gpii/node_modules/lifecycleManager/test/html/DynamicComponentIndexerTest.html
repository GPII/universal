...
<html>
    <head>
        ...
        <title>GPII Dynamic Component Indexer Tests</title>
        ...
        <script src="../js/DynamicComponentIndexerTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Dynamic Component Indexer Tests</h1>
