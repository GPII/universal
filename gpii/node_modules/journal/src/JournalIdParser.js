 ...
 * @param {String} journalId - A journalId string beginning with HEAD, < or >.
 ...
 * @param {Array of JournalFile} journalFiles - An array of JournalFile objects, sorted into increasing order of age.
 * @param {Object} parsed - A {ParsedJournalId} as returned from `gpii.journal.parseId` which will be used to index into `journalFiles.
...
/** Formats a millisecond timestamp into an ISO-8601 date string which is safe to
  ...
  * @param {Number} time - A millisecond timestamp, as dispensed from `Date.now()`.
