...
fluid.defaults("gpii.journalApp", {
    ...
    templates: {
        ...
        journalLink: "<p><a href=\"%journalUrl\">System snapshot taken at %journalTime</a>%crashedString</p>"
    },
    requestHandlers: {
        restore: {
...
gpii.journal.journals.handleRequest = function (journal, request) {
    var links = fluid.transform(journal.journalFiles, function (journalFile) {
        var terms = {
            ...
            crashedString: journal.closed ? "" : ": crashed session"
        };
