...
<html>
    <head>
        ...
        <title>GPII Journal ID Parser Tests</title>
        ...
        <script src="../../src/JournalIdParser.js"></script>
        <script src="../js/JournalIdParserTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Journal ID Parser Tests</h1>
