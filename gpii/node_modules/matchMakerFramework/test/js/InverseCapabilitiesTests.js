...
gpii.tests.matchMakerFramework.inverse.fullSolutionsRegistry = {
    win32: gpii.tests.matchMakerFramework.inverse.loadJSON("../../../../../testData/solutions/win32.json"),
    linux: gpii.tests.matchMakerFramework.inverse.loadJSON("../../../../../testData/solutions/linux.json"),
    android: gpii.tests.matchMakerFramework.inverse.loadJSON("../../../../../testData/solutions/android.json")
};
...
gpii.tests.matchMakerFramework.inverse.runTests = function () {
    ...
    jqUnit.test("Compute Leaves", gpii.tests.matchMakerFramework.inverse.testCommonTermsInference);
};