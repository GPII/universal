...
(function () {
    ...
    var testData = [{
        ...
        expectedDispositions: [undefined, undefined, "deactivate", "deactivate", "deactivate"]
    }, {
        description: "Single highest priority wins, rest rejected",
        priorities: [2, 1, 1, 1, 1],
        expectedDispositions: ["accept", "deactivate", "deactivate", "deactivate", "deactivate"]
    }, {
    ...
    // }, {
        ...
        expectedDispositions: ["deactivate", "deactivate", "accept", "deactivate", "accept"]
    }, {
        description: "Tie between multiple solutions of different types",
        priorities: [2, 1, 2, 2, 2],
        expectedDispositions: [undefined, "deactivate", undefined, undefined, undefined]
    }, {
        description: "Tie between multiple solutions of different types #2",
        priorities: [2, 1, 2, 1, 2],
        expectedDispositions: [undefined, "deactivate", undefined, "deactivate", undefined]
    // }, {
    //     description: "",
