...
(function () {
    ...
    gpii.tests.matchMakerUtilities.computeCapabilitiesFromSolution = function () {
        ...
        fluid.each(computeCapabilitiesFromSolutionFixtures, function (fixture) {
            var result = gpii.matchMakerFramework.utils.computeCapabilitiesFromSolution("FIXME - pleeeease", fixture.model, flatToISOSpec);
    ...
    gpii.tests.matchMakerUtilities.addInferredCommon = function () {
    ...
    gpii.tests.matchMakerUtilities.runTests = function () {
        ...
        jqUnit.test("Merging inferred common terms with preferences", gpii.tests.matchMakerUtilities.addInferredCommon);
    };
}());
