...
(function () {
    ...
    var computeOntologizedCapabilitiesFromSolutionFixture = {
    ...
    gpii.tests.matchMakerUtilities.computeOntologizedCapabilitiesFromSolution = function () {
        var fixture = computeOntologizedCapabilitiesFromSolutionFixture;
        var flatToISOSpec = fluid.model.transform.invertConfiguration(transformSpec);

        var resultISO = gpii.matchMakerFramework.utils.computeOntologizedCapabilitiesFromSolution(fixture.model, flatToISOSpec);
        jqUnit.assertDeepEq(fixture.description, fixture.expectedISO, resultISO);

        var resultApptology = gpii.matchMakerFramework.utils.computeOntologizedCapabilitiesFromSolution(fixture.model, apptologyTransformSpec);
    ...
    gpii.tests.matchMakerUtilities.testAddInferredCommon = function () {
        jqUnit.module("Inferred common terms merging");
        fluid.each(inferredCommonfixtures, function (fixture) {
            var result = gpii.matchMakerFramework.utils.addInferredCommon(fixture.preferences, fixture.inferred);
    ...
    gpii.tests.matchMakerUtilities.testAddSolutionTypeInformation = function () {
        ...
        fluid.each(addSolutionTypeInformationFixtures, function (fixture) {
            ...
            var result = gpii.matchMakerFramework.utils.addSolutionTypeInformation(payload, apptologyTransformSpec);
    ...
    gpii.tests.matchMakerUtilities.runTests = function () {
        ...
        jqUnit.test("Compute Capabilities From Solution", gpii.tests.matchMakerUtilities.computeOntologizedCapabilitiesFromSolution);
        jqUnit.test("Build Return Payload", gpii.tests.matchMakerUtilities.buildReturnPayload);
        jqUnit.test("Merging inferred common terms with preferences", gpii.tests.matchMakerUtilities.testAddInferredCommon);
