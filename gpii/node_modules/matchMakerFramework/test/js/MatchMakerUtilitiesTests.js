...
(function () {
    ...
    var selectMMFixtures = [{
        description: "Prefrence-based matchmaker dispatch: Find matchmaker.",
        expected: "my_mm",
        input: {
            activeContexts: [
                "gpii-default"
            ...
            preferences: {
                contexts: {
                    "gpii-default": {
                        preferences: {
                            "http://registry.gpii.net/common/matchMakerType": "my_mm"
                        }
                    }
                }
            }
        ...
        description: "Prefrence-based matchmaker dispatch: Fallback (flat)",
        expected: "flat",
        input: {
            activeContexts: [
                "gpii-default"
        ...
        description: "Prefrence-based matchmaker dispatch: Priorities",
        expected: "my_prio_mm",
        input: {
            activeContexts: [
                "gpii-default",
            ...
            preferences: {
                contexts: {
                    ...
                    "some-context1": {
                        priority: 2000,
                        preferences: {
                            "http://registry.gpii.net/common/matchMakerType": "my_obsolete_mm"
                        }
                    },
                    "some-context2": {
                        priority: 2500,
                        preferences: {
                            "http://registry.gpii.net/common/matchMakerType": "my_prio_mm"
                        }
                    }
                }
            }
    ...
    gpii.tests.matchMakerUtilities.selectMatchMaker = function () {
        fluid.each(selectMMFixtures, function (fixture) {
            var result = gpii.matchMakerFramework.utils.selectMatchMaker(fixture.input);
            jqUnit.assertEquals(fixture.description, fixture.expected, result);
        });
    };
    ...
    gpii.tests.matchMakerUtilities.runTests = function () {
        ...
        // Currently broke - should be uncommented once https://issues.gpii.net/browse/GPII-1532 is fixed
        // jqUnit.test("Select MatchMaker functionality", gpii.tests.matchMakerUtilities.selectMatchMaker);
