    ...
    var computeLeavesFixtures = [
        ...
        },
        {
            ...
            expected: [
                ...
                "com\\.microsoft\\.windows\\.narrator.http://registry\\.gpii\\.net/common/trackingTTS.0",
                "com\\.microsoft\\.windows\\.narrator.http://registry\\.gpii\\.net/common/trackingTTS.1",
                "http://registry\\.gpii\\.net/applications/com\\.microsoft\\.windows\\.magnifier.invertColours"
            ],
            ignoreArrayParsing: false
        },
        {
            ...
            expected: [
                "com\\.microsoft\\.windows\\.narrator.http://registry\\.gpii\\.net/common/speechRate",
                "com\\.microsoft\\.windows\\.narrator.http://registry\\.gpii\\.net/common/pitch",
                "com\\.microsoft\\.windows\\.narrator.http://registry\\.gpii\\.net/common/trackingTTS",
                "http://registry\\.gpii\\.net/applications/com\\.microsoft\\.windows\\.magnifier.invertColours"
            ],
            ignoreArrayParsing: true
        }
    ];

    gpii.tests.matchMakerUtilities.computeLeaves = function () {
        fluid.each(computeLeavesFixtures, function (fixture) {
            var result = gpii.matchMakerFramework.utils.computeLeaves(fixture.model, fixture.ignoreArrayParsing);
