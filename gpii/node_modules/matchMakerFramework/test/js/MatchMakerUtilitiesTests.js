...
(function () {
    ...
    gpii.tests.matchMakerUtilities.updateInferredConfigurationTestDefs = [{
        name: "Basic: single top-level common term, single application",
        preferences: {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences",
        ...
        name: "Basic: multiple top-level common terms in preferences, single application",
        preferences: {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences",
        ...
        name: "Basic: common terms in preferences not matching applications in inferred",
        preferences: {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences",
        ...
        name: "Basic: multiple top-level common terms in preferences, multiple application",
        preferences: {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences",
        ...
        name: "Basic: Common terms in preferences scoped to an application",
        preferences: {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences",
        ...
        name: "Basic: Common terms in preferences, both scoped and not scoped to an application",
        preferences: {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences",
    ...
    gpii.tests.matchMakerUtilities.getLeastLiveness.testData = [
        {
            ...
            term: "http://registry.gpii.net/common/magnifierEnabled",
    ...
    gpii.tests.matchMakerUtilities.getLeastLiveness.tests = function () {
        ...
        fluid.each(gpii.tests.matchMakerUtilities.getLeastLiveness.testData, function (testDef) {
            var liveness = gpii.matchMakerFramework.utils.getLeastLiveness(testDef.term, testDef.solutions);
