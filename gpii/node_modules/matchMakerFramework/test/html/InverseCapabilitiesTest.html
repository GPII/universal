...
<html>
    <head>
        ...
        <title>GPII Inverse Capabilities Tests</title>
        ...
        <script src="../../test/js/InverseCapabilitiesTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Inverse Capabilities Tests</h1>
        ...
        <script>
            gpii.tests.matchMakerFramework.inverse.runTests();
        </script>
    </body>
</html>
