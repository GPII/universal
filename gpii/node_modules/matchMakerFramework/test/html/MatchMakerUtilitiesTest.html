...
<html>
    <head>
        ...
        <script src="../js/MatchMakerUtilitiesDisposeFromPriorityTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Match Maker Utilities tests</h1>
        ...
        <script>
            ...
            gpii.tests.matchMakerUtilities.disposeFromPriority.runTests();
        </script>
    </body>
</html>
