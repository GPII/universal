...
gpii.tests.matchMakerFramework.inverse.fullSolutionsRegistry = require("universal/testData/solutions");
...
gpii.tests.matchMakerFramework.inverse.testCommonTermsInference = function (prefName) {
    ...
    var result = gpii.matchMakerFramework.inferCommonTerms(prefs, gpii.tests.matchMakerFramework.inverse.fullSolutionsRegistry);
