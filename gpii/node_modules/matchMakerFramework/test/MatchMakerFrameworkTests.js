...
(function () {
    ...
    fluid.tests.inferCommonTermsTests = function (npset) {
    ...
    if (kettle.tests.allTests) {
        module.exports = "gpii.matchmakerFramework.tests.testTree";
    } else {
        fluid.test.runTests(["gpii.matchmakerFramework.tests.testTree"]);
    }
