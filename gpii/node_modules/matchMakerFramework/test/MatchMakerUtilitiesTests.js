...
(function () {
    ...
    fluid.defaults("gpii.tests.matchMakerUtilities", {
        gradeNames: ["fluid.test.testEnvironment", "autoInit"],
        components: {
            tester: {
                type: "gpii.tests.matchMakerUtilities.testCaseHolder"
            }
        }
    });
                        ...
                        "settingsHandlers": [
                            {
                                ...
                                "options": {
                                    "path": "/Users/kasper/dev/gpii/mac/tests/acceptanceTests/acceptanceTest.tmp1.json"
                                },
                                "capabilities": [
    ...
    fluid.defaults("gpii.tests.matchMakerUtilities.testCaseHolder", {
        gradeNames: ["fluid.test.testCaseHolder", "autoInit"],
        modules: [{
            name: "matchMakerUtilitiesTests",
            tests: [{
                expect: computeLeavesFixtures.length,
                name: "gpii.matchMakerFramework.utils.computeLeaves tests",
                func: "gpii.tests.matchMakerUtilities.computeLeaves"
            }, {
                expect: pathsToSkeletonFixtures.length,
                name: "gpii.matchMakerFramework.utils.pathsToSkeleton tests",
                func: "gpii.tests.matchMakerUtilities.pathsToSkeleton"
            }, {
                expect: computeCapabilitiesFromSolutionFixtures.length,
                name: "gpii.matchMakerFramework.utils.computeCapabilitiesFromSolution tests",
                func: "gpii.tests.matchMakerUtilities.computeCapabilitiesFromSolution"
            }, {
                expect: buildReturnPayloadFixtures.length,
                name: "gpii.matchMakerFramework.utils.buildReturnPayload tests",
                func: "gpii.tests.matchMakerUtilities.buildReturnPayload"
            }]
        }]
    });
    ...
    if (kettle.tests.allTests) {
        module.exports = "gpii.tests.matchMakerUtilities";
    } else {
        fluid.test.runTests(["gpii.tests.matchMakerUtilities"]);
    }
