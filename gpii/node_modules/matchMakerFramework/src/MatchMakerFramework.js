...
(function () {
	...
	gpii.matchMakerFramework.GetCapableMatchMaker = function (matchMakerPayload) {
		// Constants
		var EXCLUDED_MATCHMAKER_PREF0 = "http://registry.gpii.org/common/excludedMatchMaker";
		var EXCLUDED_MATCHMAKER_PREF1 = "http://registry.gpii.net/common/excludedMatchMaker";
		// Contexts
		var contexts = matchMakerPayload.preferences.contexts;
