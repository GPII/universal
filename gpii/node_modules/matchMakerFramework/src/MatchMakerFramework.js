...
(function () {
    ...
    gpii.matchMakerFramework.tryDifferentComplete = function (request) {
        request.events.onSuccess.fire("New configuration applied to the system");
    };

    gpii.matchMakerFramework.handleTryDifferent = function (that, lifecycleManager, matchMakerFramework, flowManager, body, events) {
