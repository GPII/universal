...
(function () {
        ...
        invokers: {
            preProcess: {
                ...
                args: [ "{that}", "{arguments}.0", "{arguments}.1", "{arguments}.2", "{arguments}.3"]
                                     // token, prefs, device, solutionsRegistry
            },
            matchMakerDispatcher: {
                funcName: "gpii.matchMakerFramework.matchMakerDispatcher",
                args: [ "{that}", "{arguments}.0", "{that}.events.onMatch" ]
            }
        },
        events: {
            onReadyForLifecycleManager: null, //TODO KASPER: Delete this?
            onSolutions: null,
            onPreProcessed: null,
            onMatch: null
        },
     ...
     */
    gpii.matchMakerFramework.preProcess = function (that, token, preferences, deviceContext, solutionsRegistry) {
        var togo = {
            token: token,
        ...
        that.events.onPreProcessed.fire(togo);
    };
})();
