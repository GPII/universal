			...
			if (excludedMatchMakers.indexOf(capability.id) < 0) {
				...
				if (supportsConditions || !payloadHasConditions) {
					...
					if (capability.metrics) {
						if (capability.metrics.baseValue) baseValue = capability.metrics.baseValue;
						if (capability.metrics.forEachPreference) forEachPreference = capability.metrics.forEachPreference;
						if (capability.metrics.forEachUnsupportedPreference) forEachUnsupportedPreference = capability.metrics.forEachUnsupportedPreference;
					}
