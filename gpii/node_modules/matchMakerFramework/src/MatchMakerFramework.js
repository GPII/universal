...
(function () {
    ...
    gpii.matchMakerFramework.preProcess = function (that, lifecycleManager, initialPayload) {
        ...
        if (activeTokens.length === 1) {
            ...
            var currentSession = lifecycleManager.activeSession;
            var preferences = [{
                userToken: currentSession.userToken,
                contexts: currentSession.preferences.contexts
            }, {
                userToken: initialPayload.userToken,
                contexts: initialPayload.preferences.contexts
            }];
            initialPayload.preferences = preferences;
