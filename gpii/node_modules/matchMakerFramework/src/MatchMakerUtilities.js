...
(function () {
    ...
    */
     ...
     *
     * @param data {Object} a match maker output input payload that includes a translation of the
     ...
     * NOTE: this function will modify the solrecs object
     *
     * @param context {Object} the contextual portion of an NP set - ie. the part of the NP set that is
     ...
     * @fullSolutionsRegistry (Object) - The solutionsRegistries, keyed by OS
     *
                    ...
                    if (id in flattenedSolutionsRegistry) {
                        ...
                        fluid.each(entry.settingsHandlers, function (handler) {
                            ...
                            if (handler.inverseCapabilitiesTransformations !== undefined) {
                                ...
                                // else fall back to using the frameworks' automatic inversion features
