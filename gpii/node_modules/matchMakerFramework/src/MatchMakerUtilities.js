...
(function () {
    ...
    */
     ...
     *
     * Not that we're fetching the solution registry for all platforms.  The reason is that if the
     * user has eg. application specific preferences for a linux solution, we need that solution
