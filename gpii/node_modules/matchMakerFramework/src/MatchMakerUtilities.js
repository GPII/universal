...
(function () {
     ...
     *    specific settings in their preferences set for that application, but has no explicit priority for
    ...
    */
    ...
    /**
     * Based on the /enabled terms from a users' preferences set and the /enabled capabilities from the solution,
     ...
     *
     * Given the context section of an preferences set, the function will search the metadata section for
     ...
     * NOTE: this function will modify the solrecs object
     *
     * @param context {Object} the contextual portion of an preferences set - i.e. the part of the preferences set that is
     ...
     *
     * This function will walk an preferences set and look for any /enabled terms. Anything that is not an /enabled
     ...
     * @return {Object} The preferences set with only context names and /enabled terms
    */
     ...
     *
     * @param preferences {Object} - An preferences set (including contexts, etc)
     ...
     * ensure that no preferences are passed in the preferences set that are not already given via the inferred configuration,
