...
(function () {
    ...
    */
    ...
    /**
     * Based on the /enabled terms from a users' preference set and the /enabled capabilities from the solution,
     ...
     * NOTE: this function will modify the solrecs object
     *
     * @param context {Object} the contextual portion of an preference set - i.e. the part of the preference set that is
     ...
     *
     * @param preferences {Object} A needs and preference set (including the context blocks)
    ...
    */
     ...
     *
     * @param preferences {Object} - An preference set (including contexts, etc)
