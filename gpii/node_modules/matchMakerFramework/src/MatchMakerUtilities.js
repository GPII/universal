...
(function () {
     ...
     *    specific settings in their NP set for that application, but have no explicit priority for
     *    that application.
    ...
    */
    ...
    gpii.matchMakerFramework.utils.disposeSolutions = function (data, strategy, transformSpec) {
        ...
        fluid.each(data.hierarchicalPrefs.contexts, function (context, contextId) {
            ...
            var disposed = strategy(leaves, tmpSolrecs, data, contextId);
            togo[contextId] = [];
     ...
     *
     * @solrecs (Object): a map of solution information, keyed by solution ids. This object should
     ...
     * @typeInfo (Object): contains information about the type each solution is. More precisely,
     ...
     *
     * @tied {Array} An array of solutionIds of tied solutions for which the disposition and
     ...
     * NOTE: this function will modify the solrecs object
     *
     * @types {Array} An array of solution types
     * @solutionTypeMapping {object} A hash of solutionTypes with values being arrays of solutionIds
     ...
     * @disposeReason (String): The reason to recor for rejecting this solution. If this parameter
     ...
     * NOTE: this function will modify the solrecs object
     *
     * @context {Object} the contextual portion of an NP set - ie. the part of the NP set that is
     ...
     *
     * NOTE: this function will modify the payloadObject
     *
     * @types {payload} An object with the format of a standard matchmaker input payload. At a very
     ...
     * @transformSpec {object} ontology transform spec translating from common terms into
