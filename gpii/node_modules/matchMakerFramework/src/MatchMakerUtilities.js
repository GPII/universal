...
(function () {
    ...
    */
    ...
    /*
     * Merges all the settings handler blocks from within the keyed arrays of the
     * solutions "settingsHandlers" block
     *
     * @solution {Object} a single solution registry entry
     * @return an array of settingsHandler
     */
    gpii.matchMakerFramework.utils.mergeSettingsHandlerBlocks = function (solution) {
        var settingsHandlerBlocks = [];
        fluid.each(solution.settingsHandlers, function (handlerGroup) {
            settingsHandlerBlocks = settingsHandlerBlocks.concat(handlerGroup);
        });
