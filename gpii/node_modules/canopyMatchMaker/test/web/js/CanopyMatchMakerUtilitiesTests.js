...
(function () {
    ...
    gpii.tests.canopyMatchMaker.runBasicTests = function () {
        ...
        jqUnit.test("Fitness computation", function () {
            var fitness = gpii.canopyMatchMaker.utils.computeFitness(sammyLeaves, magnifierSkeleton);
        ...
        jqUnit.test("Rank and dispose solutions", function () {
            ...
            var ranked = gpii.canopyMatchMaker.utils.rankSolutions(sammyLeaves, solrecs);
            var minimalData = {
                solutionTypes: {
            ...
            var disposed = gpii.canopyMatchMaker.utils.disposeFromCanopy(sammyLeaves, ranked, solrecs, minimalData);
