...
gpii.tests.canopyMatchMaker.runBasicTests = function () {
    ...
    jqUnit.test("Rank and dispose solutions", function () {
        ...
        var ranked = gpii.canopyMatchMaker.utils.rankSolutions(sammyLeaves, solrecs, gpii.canopyMatchMaker.utils.ISO24751.prefixLength);
        var minimalData = {
            solutionTypes: {
        ...
        var disposed = gpii.canopyMatchMaker.utils.disposeFromCanopy(sammyLeaves, ranked, solrecs, minimalData, gpii.canopyMatchMaker.utils.ISO24751.prefixLength);
