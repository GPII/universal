...
(function () {
    ...
    gpii.tests.canopyMatchMaker.runTests = function () {
        ...
        jqUnit.test("Path Utilities", function () {
            jqUnit.assertEquals("Exact depth", 0, gpii.matchMaker.canopy.prefixLength("display.screenEnhancement.fontSize", sammyProfile));
            jqUnit.assertEquals("Near depth", 0, gpii.matchMaker.canopy.prefixLength("display.screenEnhancement", sammyProfile));
            jqUnit.assertEquals("Mid depth", -1, gpii.matchMaker.canopy.prefixLength("display.unrecognizable", sammyProfile));
            jqUnit.assertEquals("Far depth", -2, gpii.matchMaker.canopy.prefixLength("display.unrecognizable.thing", sammyProfile));
        });
        ...
        jqUnit.test("Rank and dispose solutions", function () {
            ...
            var itions = gpii.matchMaker.canopy.extractDispositions(disposed);
