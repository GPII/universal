...
<html>
    <head>
        ...
        <script src="../../../src/CanopyMatchMakerUtilities.js"></script>
        <script src="../js/CanopyMatchMakerUtilitiesTests.js"></script>
    ...
    <body id="body">
        ...
        <script>
            gpii.tests.canopyMatchMaker.runBasicTests();
            gpii.tests.canopyMatchMaker.disposeStrategyTests();
        </script>
    </body>
</html>
