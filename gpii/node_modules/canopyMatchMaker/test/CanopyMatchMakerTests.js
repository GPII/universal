...
(function () {
    ...
    var matchFixtures = [
        {
            ...
            input: require("./data/full_mm_payload2.json"),
            preferences: {
                "gpii-default": {
            ...
            description: "Two magnifier preferences->best fit is launched",
            input: require("./data/full_mm_payload2.json"),
            preferences: {
                "gpii-default": {
                    "name": "Default preferences",
            ...
            description: "Application settings for multile magnifiers - canopy best fit used",
            input: require("./data/full_mm_payload2.json"),
            preferences: {
                "gpii-default": {
                    "name": "Default preferences",
    ...
    gpii.canopyMatchMaker.tests.match = function (ontologyHandler) {
        fluid.each(matchFixtures, function (fixture) {
            fluid.set(fixture.input, ["preferences", "contexts"], fixture.preferences);
            var result = gpii.canopyMatchMaker.match(ontologyHandler, fixture.input, gpii.canopyMatchMaker.utils.disposeStrategy);
