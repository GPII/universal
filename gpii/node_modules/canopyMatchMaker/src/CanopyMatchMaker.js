...
(function () {
    ...
    fluid.defaults("gpii.canopyMatchMaker", {
        ...
        invokers: {
            match: {
                ...
                args: [ "{ontologyHandler}", "{arguments}.0", "{canopyMatchMaker}.disposeStrategy"]
            },
            disposeStrategy: {
                funcName: "gpii.canopyMatchMaker.disposeStrategy",
     ...
     */
    gpii.canopyMatchMaker.matchPost = function (flatMatchMaker, requestProxy, body) {
