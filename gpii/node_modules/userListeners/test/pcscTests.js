...
/**
 * Get a test instance of the gpii.pcscUserListener component.
 */
gpii.tests.userListener.getListenerComponent = function () {
 ...
 */
gpii.tests.userListener.mockReader = function () {
...
jqUnit.asyncTest("PC/SC listener - mock card", function () {
    ...
    jqUnit.expect(gpii.tests.userListener.cardTests.length * 3);
    var index = 0;

    var listener = gpii.tests.userListener.getListenerComponent();
    var reader = gpii.tests.userListener.mockReader();
