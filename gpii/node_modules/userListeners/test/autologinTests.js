...
fluid.defaults("gpii.tests.userListener.autoLoginListener", {
    ...
    listeners: {
        ...
        "onCreate.loginListener": "fluid.identity"
    },
    invokers: {
...
jqUnit.asyncTest("autoLogin writeTokenFile", function () {
...
jqUnit.test("test addLoginListener", function () {
    ...
    autoLogin.storeToken = function (token) {
        tokenWrote = true;
    ...
    autoLogin.options.saveLastLogin = false;
    gpii.userListeners.autoLogin.addLoginListener(autoLogin, firer);
    firer.fire("dummy", tokenValue);

    jqUnit.assertFalse("Token should not have been written", tokenWrote);

    // Test when saving is enabled
    autoLogin.options.saveLastLogin = true;
    gpii.userListeners.autoLogin.addLoginListener(autoLogin, firer);
    firer.fire("dummy", tokenValue);
