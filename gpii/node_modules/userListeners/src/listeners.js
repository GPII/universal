...
fluid.defaults("gpii.userListeners", {
    ...
    components: {
        // Note: The subcomponent "lifecycleManager" is distributed from flowManager so it doesn't disturb
        // user listeners unit tests.
        // lifecycleManager: {
...
gpii.userListeners.tokenArrived = function (that, token) {
    ...
    that.lifecycleManager[that.proximity ? "performProximityTriggered" : "performLogin"](token);
};
