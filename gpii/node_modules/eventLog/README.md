...
```json5
{
    ...
    "keyIn": true, // true if the user is currently keying-in, "after" if shortly after key-in (10 seconds). This can
                   // used to determine if a preference was set due to a user's preferences, or the quick-strip.
