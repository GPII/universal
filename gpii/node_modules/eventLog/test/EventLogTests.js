...
gpii.tests.eventLog.testDefs = fluid.freezeRecursive(fluid.transform([
    ...
    },
    {
        ...
        testData: [{
            func: "defer",
            args: ["module11", "event11", {}, null, "timer-id3"]
        }, {
            func: "logDeferred",
            args: ["timer-id3"]
        }],
    ...
    },
    {
        ...
        testData: [{
            func: "defer",
            args: ["module12", "event12", null, null, "timer-id4"]
        }, {
            func: "logDeferred",
            args: ["timer-id4"]
        }],
    ...
    },
    {
        ...
        testData: {
            func: "log",
            args: ["module13", "event13", {"data0": "value0"}, "WARN"]
        },
        expected: {
            "timestamp": "2000-00-00T00:00:00.000Z",
            "level": "WARN",
    ...
    },
    {
        ...
        testData: {
            func: "logDuration",
            args: ["module14", "event14", {}, "FATAL", "timer-unknown1"]
        },
        expected: {
            "timestamp": "2000-00-00T00:00:00.000Z",
            "level": "FATAL",
    ...
    item.expected.installID = gpii.tests.eventLog.installID;
    return item;
}));
...
jqUnit.asyncTest("eventLog tests #1", function () {
    ...
    gpii.eventLog.getTimestamp = function () {
        return "2000-00-00T00:00:00.000Z";
    };
