 ...
 */
gpii.eventLog.createLogObject = function (module, event, data) {
    var eventObject = {
        module: module,
        event: event
    };
...
gpii.eventLog.log = function (module, event, data, level, timerId) {
    ...
    gpii.eventLog.writeLog(gpii.eventLog.checkLevel(level), eventObject);
};
 ...
 */
gpii.eventLog.defer = function (module, event, data, timerId) {
    gpii.eventLog.startTimer(timerId);
    gpii.eventLog.pendingLogs[timerId] = gpii.eventLog.createLogObject(module, event, data);
};
...
gpii.eventLog.logDeferred = function (timerId) {
    ...
    gpii.eventLog.logDuration(eventObject, null, null, timerId);
};
 ...
 *
 * @param loglevel to check, can be a string that represents the value or a property of gluid.logLevel
