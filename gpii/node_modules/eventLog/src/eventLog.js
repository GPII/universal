 ...
 */
gpii.eventLog.createLogObject = function (module, event, data, level) {
    var eventObject = {
        module: module || "GPII",
        event: event,
        level: level
 ...
 */
gpii.eventLog.log = function (module, event, data, level, timerId) {
    var eventObject = gpii.eventLog.createLogObject(module, event, data);
    if (timerId) {
 ...
 *
 * @param module {String|Object} The part of GPII causing this event, or an object containing the module, event, and
 ...
 */
gpii.eventLog.logDuration = function (module, event, data, level, timerId) {
    var eventObject;

    if (module && module.module) {
        eventObject = module;
    } else {
        eventObject = gpii.eventLog.createLogObject(module, event, data);
    }
 ...
 */
gpii.eventLog.defer = function (module, event, data, level, timerId) {
    if (!timerId) {
        timerId = level;
        level = null;
    }
    gpii.eventLog.startTimer(timerId);
    gpii.eventLog.pendingLogs[timerId] = gpii.eventLog.createLogObject(module, event, data, level);
};
 ...
 * Logs an error.
 *
 * @param module {String} The part of GPII causing this error.
 * @param errType {String} Type of error.
 * @param err {Object} The error.
 */
gpii.eventLog.logError = function (module, errType, err) {
    var data = {};
    ...
    gpii.eventLog.log(module, "Error." + errType, data, fluid.logLevel.FAIL);
};
...
gpii.eventLog.wrapData = function (data) {
    ...
    if (data === null || data === undefined) {
        ...
        dataTogo = gpii.eventLog.isEmpty(data) ? null : data;
    } else {
        dataTogo = {value: data};
    }
 ...
 *
 * @param level to check, can be a string that represents the value or a property of gluid.logLevel
