...
fluid.defaults("gpii.tests.dbDataStore.findKeysForPrefsSafe", {
    gradeNames: ["gpii.tests.dbDataStore.environment"],
    rawModules: [{
        name: "Test findKeysForPrefsSafe()",
        tests: [{
            name: "List prefs safes",
            sequence: [{
                func: "gpii.tests.invokePromiseProducer",
                args: ["{dbDataStore}.findKeysForPrefsSafe", ["prefsSafe-1"], "{that}"]
            }, {
                listener: "jqUnit.assertLeftHand",
                args: ["Expecing a list of keys for prefsSafe-1.", gpii.tests.dbDataStore.testData.findKeysForPrefsSafe_prefsSafe1, "{arguments}.0"],
                event: "{that}.events.onResponse"
            }]
        }]
    }]
...
fluid.test.runTests([
    ...
    "gpii.tests.dbDataStore.findKeysForPrefsSafe",
