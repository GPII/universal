    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                resolveArgs: ["Expecing a list of keys for prefsSafe-1.", gpii.tests.dbDataStore.testData.findRelatedDocsForPrefsSafe_prefsSafe1, "{arguments}.0"]
            }]
        }]
    }]
});
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                resolve: "jqUnit.assertDeepEq",
                resolveArgs: ["Expecing a safe from the express lookup.", gpii.tests.dbDataStore.testData.findSafeByExpressUserLookup_credential, "{arguments}.0"]
            }]
        }]
    }]
});
