    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The record of type \"gpiiKey\" was not found",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The record of type \"prefsSafe\" was not found",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
    ...
    rawModules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                listener: "jqUnit.assertDeepEq",
                args: ["The expected error is received", {
                    message: "The record of type \"gpiiAppInstallationAuthorization\" was not found",
                    statusCode: 400,
                    isError: true
                }, "{arguments}.0"],
                event: "{that}.events.onError"
