...
<html>
    <head>
        ...
        <title>In-browser PouchDB Data Source Tests</title>
        ...
        <!-- Components to test -->
        <script src="../../src/DataSource-pouchDB.js"></script>
        <script src="../js/DataSource-PouchDBTestsUtils.js"></script>
        <script src="../js/DataSource-PouchDBTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">In-browser PouchDB Data Source Tests</h1>
