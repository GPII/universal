/*!
GPII CouchDB/PouchDB Data Store
...
fluid.defaults("gpii.dbOperation.dbDataStore", {
    ...
    components: {
        ...
        expressUserSafeLoginLookup: {
            type: "gpii.dbOperation.dbDataSource",
            options: {
                requestUrl: "/_design/views/_view/expressUserSafeLoginLookup?include_docs=true&key=%22%userRecordId%22",
                termMap: {
        ...
        findKeysForPrefsSafeDataSource: {
            type: "gpii.dbOperation.dbDataSource",
            options: {
                requestUrl: "/_design/views/_view/findKeysForPrefsSafe?include_docs=true&key=%22%prefsSafeId%22",
                termMap: {
    ...
    invokers: {
        ...
        findKeysForPrefsSafe: {
            funcName: "gpii.dbOperation.dbDataStore.findRecordList",
            args: [
                "{that}.findKeysForPrefsSafeDataSource",
                {
        ...
        findAuthorizationByAccessToken: {
            ...
            args: [
                ...
                "accessToken",
                gpii.dbOperation.dbDataStore.findAuthorizationByAccessTokenPostProcess
            ]
            // accessToken
        },
        findAllViews: {
