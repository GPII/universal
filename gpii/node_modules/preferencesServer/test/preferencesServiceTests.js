    ...
    databases: {
        gpii: {
            data: [
                ...
                "%gpii-universal/gpii/node_modules/preferencesServer/test/data/userLookup.json",
...
fluid.defaults("gpii.tests.preferencesServer.preferencesService.addGpiiKey", {
    gradeNames: ["gpii.tests.preferencesServer.preferencesService.baseEnvironment"],
    components: {
        caseHolder: {
            options: {
                modules: [{
                    ...
                    tests: [
                        {
                            name: "addGpiiKey: Successful create",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.addGpiiKey",
                                args: [{
                                    "type": "gpiiKey",
                                    "schemaVersion": "0.1",
                                ...
                                resolveArgs: ["Newly created gpiiKey", {
                                    "schemaVersion": "0.1",
                                    "prefsSafeId": "prefsSafe-1",
                                    "prefsSetId": "gpii-default",
                                    "revoked": false,
                        ...
                        {
                            name: "addGpiiKey: Error: Prefs Safe does not exist",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.addGpiiKey",
                                args: [{
                                    "type": "gpiiKey",
                                    "schemaVersion": "0.1",
                                    "prefsSafeId": "prefsSafe-2020",
                                    "prefsSetId": "gpii-default",
                                    "revoked": false,
                                    "revokedReason": null
                                }],
                                reject: "jqUnit.assertLeftHand",
                                rejectArgs: ["Preference safe doesn't exist, can't create key", {
                                    "isError": true,
                                    "message": "The prefs safe does not exist"
                                }, "{arguments}.0"]
                            }]
                        }
                    ]
...
// Tests for cloudSafeCredCreate
fluid.defaults("gpii.tests.preferencesServer.preferencesService.cloudSafeCredCreate", {
    gradeNames: ["gpii.tests.preferencesServer.preferencesService.baseEnvironment"],
    components: {
        caseHolder: {
            options: {
                modules: [{
                    name: "Test cloudSafeCredCreate()",
                    tests: [
                        {
                            name: "cloudSafeCredCreate: Successful create",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.cloudSafeCredCreate",
                                args: [{prefsSafeId: "prefsSafe-1", username: "myUserName", password: "supersecret"}],
                                resolve: "jqUnit.assertLeftHand",
                                resolveArgs: ["Newly created credentials document", {
                                    prefsSafeId: "prefsSafe-1",
                                    gpiiExpressUserId: "org.couch.db.user:myUserName",
                                    type: "gpiiCloudSafeCredential"
                                }, "{arguments}.0"]
                            }, {
                                task: "{preferencesService}.cloudSafeUnlock",
                                args: [{username: "myUserName", password: "supersecret"}],
                                resolve: "jqUnit.assertDeepEq",
                                resolveArgs: ["Should have returned prefsSafe-1: ", "prefsSafe-1", "{arguments}.0.id"]
                            }]
                        },
                        {
                            name: "cloudSafeCredCreate: Error: Prefs Safe doesn't exist",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.cloudSafeCredCreate",
                                args: [{prefsSafeId: "prefsSafe-1999", username: "myUserName", password: "supersecret"}],
                                reject: "jqUnit.assertLeftHand",
                                rejectArgs: ["Error message saying the prefs safe does not exist.", {
                                    "isError": true,
                                    "message": "The prefs safe does not exist"
                                }, "{arguments}.0"]
                            }]
                        ...
                        {
                            name: "cloudSafeUnlock: Error: Name already used",
                            sequence: [{
                                task: "{preferencesService}.cloudSafeCredCreate",
                                args: [{prefsSafeId: "prefsSafe-1", username: "prefs7user", password: "supersecret"}],
                                reject: "jqUnit.assertLeftHand",
                                rejectArgs: ["Error indicating bad username and password for new credentials.", {
                                    "isError": true,
                                    "message": "Unable to create credentials with that username and password combination"
                                }, "{arguments}.0"]
                            }]
                        }
                    ]
...
//Tests for cloudSafeUnlock
fluid.defaults("gpii.tests.preferencesServer.preferencesService.cloudSafeUnlock", {
    gradeNames: ["gpii.tests.preferencesServer.preferencesService.baseEnvironment"],
    components: {
        caseHolder: {
            options: {
                modules: [{
                    name: "Test cloudSafeUnlock()",
                    tests: [
                        {
                            name: "cloudSafeUnlock: Unlock a safe successfully",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.cloudSafeUnlock",
                                args: [{username: "prefs7user", password: "testPassword"}],
                                resolve: "jqUnit.assertDeepEq",
                                resolveArgs: ["Should have returned prefsSafe-7: ", "prefsSafe-7", "{arguments}.0.id"]
                            }]
                        },
                        {
                            name: "cloudSafeUnlock: Fail to unlock with a bad username/password",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.cloudSafeUnlock",
                                args: [{username: "prefs7user", password: "wrongPassword"}],
                                reject: "jqUnit.assertDeepEq",
                                rejectArgs: ["Should fail with message", "Unable to unlock a Preferences Safe with the supplied credentials.", "{arguments}.0.message"]
                            }]
                        }
                    ]
                }]
...
//Tests for creating and updating prefs safes
gpii.tests.preferencesServer.preferencesService.createUpdatePrefsSafeData = {
    newPrefsSafe: {
        "type": "prefsSafe",
        "schemaVersion": "0.1",
        "prefsSafeType": "user",
    ...
    updatedPrefsSafe7: {
        ...
        // This value will be different "timestampUpdated": null
    }
};

fluid.defaults("gpii.tests.preferencesServer.preferencesService.createUpdatesPrefs", {
    gradeNames: ["gpii.tests.preferencesServer.preferencesService.baseEnvironment"],
    components: {
        caseHolder: {
            options: {
                modules: [{
                    ...
                    tests: [
                        {
                            name: "createSavePrefsSafe: Add a new safe.",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.addPrefsSafe",
                                args: [gpii.tests.preferencesServer.preferencesService.createUpdatePrefsSafeData.newPrefsSafe],
                                resolve: "jqUnit.assertLeftHand",
                                resolveArgs: ["Should have same structure as created: ",
                                    gpii.tests.preferencesServer.preferencesService.createUpdatePrefsSafeData.newPrefsSafe,
                                    "{arguments}.0"]
                            }]
                        },
                        {
                            name: "updateExistingSafe: Change the name of prefsSafe 7",
                            sequenceGrade: "gpii.tests.preferencesServer.preferencesService.sequenceGrade",
                            sequence: [{
                                task: "{preferencesService}.updatePrefsSafe",
                                args: [gpii.tests.preferencesServer.preferencesService.createUpdatePrefsSafeData.updatedPrefsSafe7],
                                resolve: "jqUnit.assertLeftHand",
                                resolveArgs: ["Should have same structure as created: ",
                                    gpii.tests.preferencesServer.preferencesService.createUpdatePrefsSafeData.updatedPrefsSafe7,
                                    "{arguments}.0"]
                            }]
                        }
                    ]
...
fluid.test.runTests([
    ...
    "gpii.tests.preferencesServer.preferencesService.addGpiiKey",
    "gpii.tests.preferencesServer.preferencesService.cloudSafeCredCreate",
    "gpii.tests.preferencesServer.preferencesService.cloudSafeUnlock",
    "gpii.tests.preferencesServer.preferencesService.createUpdatesPrefs"
]);
