...
// A pouch testcase holder for tests that depend on zero preference safes and keys
fluid.defaults("gpii.tests.preferencesServer.preferencesService.emptySet.pouchTestCaseHolder", {
    gradeNames: ["gpii.test.pouch.pouchTestCaseHolder"],
    mergePolicy: {
        "pouchConfig.databases.gpii.data": "replace"
    },
    ...
    // Successful create
    {
        ...
        sequence: [{
            ...
            resolveArgs: ["Newly created gpiiKey", {
                ...
                "type": "gpiiKey"
                // "id": "0c2e153a-fb5a-4356-b8f4-131810c71cc1"
            }, "{arguments}.0"]
        }]
    },
    // Error creating new key if prefsSafe does not exist
    {
        config: {
            configName: "gpii.tests.preferencesServer.config",
            configPath: "%preferencesServer/test/configs"
...
gpii.test.bootstrapServer(gpii.tests.preferencesServer.preferencesService.addGpiiKey);
...
gpii.tests.preferencesServer.preferencesService.cloudSafeCredCreate = [
    // Successful create
    {
        ...
        sequence: [{
            task: "gpii.tests.preferencesServer.preferencesService.promise",
            args: ["cloudSafeCredCreate", [{prefsSafeId: "prefsSafe-1", username: "myUserName", password: "supersecret"}]],
            resolve: "jqUnit.assertLeftHand",
            ...
            task: "gpii.tests.preferencesServer.preferencesService.promise",
            args: ["cloudSafeUnlock", [{username: "myUserName", password: "supersecret"}]],
            resolve: "jqUnit.assertDeepEq",
            resolveArgs: ["Should have returned prefsSafe-1: ", "prefsSafe-1", "{arguments}.0.id"]
        }]
    },
    // Error: Prefs Safe doesn't exist
    {
        config: {
            configName: "gpii.tests.preferencesServer.config",
            configPath: "%preferencesServer/test/configs"
        ...
        pouchTestCaseHolder: "gpii.tests.preferencesServer.preferencesService.pouchTestCaseHolder",
        name: "cloudSafeUnlock: Error: Prefs Safe doesn't exist",
        sequence: [{
            task: "gpii.tests.preferencesServer.preferencesService.promise",
            args: ["cloudSafeCredCreate", [{prefsSafeId: "prefsSafe-1999", username: "myUserName", password: "supersecret"}]],
            reject: "jqUnit.assertLeftHand",
    ...
    // Error: Name already used
    {
        ...
        sequence: [{
            task: "gpii.tests.preferencesServer.preferencesService.promise",
            args: ["cloudSafeCredCreate", [{prefsSafeId: "prefsSafe-1", username: "prefs7user", password: "supersecret"}]],
            reject: "jqUnit.assertLeftHand",
...
gpii.test.bootstrapServer(gpii.tests.preferencesServer.preferencesService.cloudSafeCredCreate);
...
gpii.tests.preferencesServer.preferencesService.cloudSafeUnlock = [
    {
        ...
        sequence: [{
            task: "gpii.tests.preferencesServer.preferencesService.promise",
            args: ["cloudSafeUnlock", [{username: "prefs7user", password: "testPassword"}]],
            resolve: "jqUnit.assertDeepEq",
    ...
    },
    {
        ...
        sequence: [{
            task: "gpii.tests.preferencesServer.preferencesService.promise",
            args: ["cloudSafeUnlock", [{username: "prefs7user", password: "wrongPassword"}]],
            reject: "jqUnit.assertDeepEq",
...
gpii.tests.preferencesServer.preferencesService.createSavePrefsSafe = [
    {
        config: {
            configName: "gpii.tests.preferencesServer.config",
            configPath: "%preferencesServer/test/configs"
...
gpii.test.bootstrapServer(gpii.tests.preferencesServer.preferencesService.createSavePrefsSafe);
