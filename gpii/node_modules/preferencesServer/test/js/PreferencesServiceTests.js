...
(function () {
    ...
    fluid.defaults("gpii.tests.preferencesServer.preferencesService.createPreferences", {
        ...
        rawModules: [{
            ...
            tests: [{
                name: "createPreferences() creates a prefs safe and an auto generated GPII key - a success workflow",
                sequence: [{
                    func: "gpii.tests.dbOperation.invokePromiseProducer",
                    args: ["{preferencesService}.createPreferences", [gpii.tests.preferencesServer.preferencesService.testData.preferencesToCreate_full], "{that}"]
                }, {
                ...
                name: "createPreferences() creates a prefs safe and an GPII key with the provided key value - a success workflow",
                sequence: [{
                    func: "gpii.tests.dbOperation.invokePromiseProducer",
                    args: ["{preferencesService}.createPreferences", [gpii.tests.preferencesServer.preferencesService.testData.preferencesToCreate_full, "a-new-gpii-key-by-preferences-service"], "{that}"]
                }, {
                    listener: "gpii.tests.dbOperation.invokePromiseProducer",
                    args: ["{preferencesService}.getPrefsSafeByGpiiKey", ["{arguments}.0.gpiiKey"], "{that}"],
                    event: "{that}.events.onResponse"
                    ...
                    listener: "gpii.tests.preferencesServer.preferencesService.verifyFetchedPrefsSafe",
                    args: [gpii.tests.preferencesServer.preferencesService.testData.preferencesToCreate_full, "{arguments}.0", "a-new-gpii-key-by-preferences-service"],
                    event: "{that}.events.onResponse"
                }]
            }, {
                name: "createPreferences() sets default values when input values are not provided for some fields",
                sequence: [{
                    func: "gpii.tests.dbOperation.invokePromiseProducer",
                    args: ["{preferencesService}.createPreferences", [gpii.tests.preferencesServer.preferencesService.testData.preferencesToCreate_prefsOnly], "{that}"]
                }, {
                    listener: "gpii.tests.dbOperation.invokePromiseProducer",
                    args: ["{preferencesService}.getPrefsSafeByGpiiKey", ["{arguments}.0.gpiiKey"], "{that}"],
                    event: "{that}.events.onResponse"
                ...
                sequence: [{
                    func: "gpii.tests.dbOperation.invokePromiseProducer",
                    args: ["{preferencesService}.createPreferences", [gpii.tests.preferencesServer.preferencesService.testData.preferencesToCreate_full, "alice_gpii_key"], "{that}"]
                }, {
                    listener: "jqUnit.assertDeepEq",
    ...
    fluid.defaults("gpii.tests.preferencesServer.preferencesService.updatePreferences", {
        ...
        rawModules: [{
            ...
            tests: [{
                name: "updatePreferences() updates the associated prefs safe - a success workflow",
                sequence: [{
                    func: "gpii.tests.dbOperation.invokePromiseProducer",
                ...
                name: "updatePreferences() creates a new prefs safe when the GPII key is not associates with a prefs safe - a success workflow",
                sequence: [{
                    func: "gpii.tests.dbOperation.invokePromiseProducer",
    ...
    gpii.tests.preferencesServer.preferencesService.verifyNewPrefsSafeForUpdate = function (that, updatedPreferences, gpiiKey, response) {
        ...
        var unchangedOrigGpiiKeyFields = fluid.censorKeys(that.originalData.gpiiKeyDetails, ["prefsSafeId", "prefsSetName", "timestampUpdated"]);
        var unchangedGpiiKeyFields = fluid.censorKeys(response.gpiiKeyDetails, ["prefsSafeId", "prefsSetName", "timestampUpdated"]);
