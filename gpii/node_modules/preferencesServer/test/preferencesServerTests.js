...
gpii.test.runServerTestDefs(gpii.tests.preferencesServer.health.testDefs);

// Run tests for /ready endpoint:
// 1. With a proper database connection: liveness === true
gpii.test.runServerTestDefs(gpii.tests.preferencesServer.ready.testDefsWithDbConnection);
