...
gpii.tests.preferencesServer.testResponseLeftHand = function (response, expected, receivedStatusCode, expectedStatusCode) {
    var retrievedData = JSON.parse(response);
    jqUnit.assertEquals("Response status code is expected", expectedStatusCode, receivedStatusCode);
...
gpii.tests.preferencesServer.put.testRequestResponse = function (response, prefs, gpiiKey) {
    var retrievedData = JSON.parse(response);
    // expect preferences without ontology info - any generated GPII key is fine
    var expected = {
        preferences: prefs,
        gpiiKey: gpiiKey
    };
