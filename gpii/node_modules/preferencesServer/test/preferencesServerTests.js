...
fluid.registerNamespace("gpii.tests.preferencesServer.old.get");

gpii.tests.preferencesServer.old.get.testRequestResponse = function (expected) {
    return function (data) {
        var retrievedData = JSON.parse(data);
        fluid.log("preferencesServer.old.get.testRequestResponse received " + JSON.stringify(retrievedData, null, 4));
        jqUnit.assertDeepEq("Response is correct", expected, retrievedData);
    };
};

gpii.tests.preferencesServer.old.get.buildTestDef = function (fixture) {
    return {
        name: fixture.name,
        expect: 1,
        config: gpii.tests.preferencesServer.standardConfig,
        ...
        sequence: [{
            ...
            event: "{getRequest}.events.onComplete",
            listenerMaker: "gpii.tests.preferencesServer.old.get.testRequestResponse",
            makerArgs: [ fixture.expected ]
        }]
    };
};

gpii.tests.preferencesServer.old.get.fixtures = [
    {
...
fluid.registerNamespace("gpii.tests.preferencesServer.old.post");

gpii.tests.preferencesServer.old.post.testRequestResponse = function (userToken, expectedRaw) {
    return function (data) {
        var retrievedData = JSON.parse(data);
        ...
        gpii.tests.preferencesServer.put.checkRawPreferences(userToken, expectedRaw);

    };
};

gpii.tests.preferencesServer.old.post.buildTestDef = function (fixture) {
    return {
        name: fixture.name,
        expect: 3,
        config: gpii.tests.preferencesServer.standardConfig,
        ...
        sequence: [{
            ...
            event: "{putRequest}.events.onComplete",
            listenerMaker: "gpii.tests.preferencesServer.old.post.testRequestResponse",
            makerArgs: [ fixture.userToken, fixture.expectedRaw ]
        }]
    };
};

gpii.tests.preferencesServer.old.post.fixtures = [
    {
...
gpii.tests.preferencesServer.testMap = [ {
    ...
    build: gpii.tests.preferencesServer.old.get.buildTestDef,
    fixtures: gpii.tests.preferencesServer.old.get.fixtures
}, {
    build: gpii.tests.preferencesServer.old.post.buildTestDef,
    fixtures: gpii.tests.preferencesServer.old.post.fixtures
}, {
