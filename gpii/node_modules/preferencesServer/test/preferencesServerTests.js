...
gpii.preferencesServer.tests.prefsDir = kettle.resolveModulePath("%universal/gpii/testData/preferences/");
...
gpii.preferencesServer.tests.testServerMock.get = function (model, body, callback, rawPreferencesDataSource) {
    ...
    rawPreferencesDataSource.get(model, body, callback).then(function (data) {
        if (data === undefined) {
            promise.reject({ "isError": true, "statusCode": 404 });
        } else {
...
fluid.defaults("gpii.preferencesServer.tests.rejectedPromise", {
    ...
    invokers: {
        ...
        get: {
            funcName: "gpii.preferencesServer.tests.rejectedPromise.get"
        }
    }
});
...
gpii.preferencesServer.tests.rejectedPromise.get = function () {
    var promise = fluid.promise();
    promise.reject({
        isError: true,
        message: "this is a failure"
...
fluid.each(gpii.preferencesServer.tests.rejectedPromiseFixture, function (fixture) {
    testDefs.push((fixture));
});
