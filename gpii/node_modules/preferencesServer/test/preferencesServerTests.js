...
gpii.tests.preferencesServer.get.successFixtures = [
    {
        name: "GET: Basic retrieval of simple preferences set in same ontology (no parameter)",
        ...
        name: "GET: Basic retrieval of simple preferences set in same ontology (with parameter)",
        gpiiKey: "np_flatOnly_singleContext",
        ...
        name: "GET: Basic retrieval of simple preferences set in different ontology (with parameter)",
        ...
        name: "GET: Retrieval of simple preferences set in different ontology plus non-translateable preference",
        gpiiKey: "np_flatOnly_singleContext",
        ...
        name: "GET: Retrieval of single ontology, multi-context preferences set in same ontology",
        ...
        name: "GET: Retrieval of single ontology, multi-context preferences set in a different ontology",
        gpiiKey: "np_flatOnly_multiContext",
        url: "%gpiiKey?view=ISO24751",
        expected: {
            "name": "Multiple Contexts",
        ...
        name: "GET: Retrieval of mixed preferences set in flat (from multiple ontologies, single context)",
        ...
        name: "GET: Retrieval of mixed preferences set in flat (from multiple ontologies, multi context)",
        ...
        name: "GET: Retrieval of mixed preferences set in ISO24751 (from multiple ontologies, multi context)",
        gpiiKey: "np_mixed_multiContext",
        url: "%gpiiKey?view=ISO24751",
        expected: {
            "name": "lotta stuff",
        ...
        name: "GET: Complex retrieval of simple preferences set in different ontology (with parameter)",
...
gpii.tests.preferencesServer.put.successFixtures = [
    {
        name: "PUT: No view specified, ontology matching preferences set",
        gpiiKey: "np_flatOnly_singleContext",
        putBody: {
            "contexts": {
                "gpii-default": {
        ...
        name: "PUT: No view specified, ontology matching preferences set, with the merge flag turned on to merge the new preferences with the existing preferences",
        gpiiKey: "np_flatOnly_singleContext",
        merge: true,
        putBody: {
            "contexts": {
        ...
        name: "PUT: To preferences set containing same preference in different ontology",
        gpiiKey: "np_tiny",
        view: "ISO24751",
        putBody: {
            "contexts": {
        ...
        name: "PUT: To preferences set containing same preference in different ontology, with the merge flag turned on to merge the new preferences with the existing preferences",
        gpiiKey: "np_tiny",
        view: "ISO24751",
        merge: true,
        putBody: {
