...
gpii.tests.preferencesServer.prefsDir = fluid.module.resolvePath("%gpii-universal/gpii/testData/preferences/");
...
gpii.tests.preferencesServer.put.copyNPSet = function (toToken, fromToken) {
    ...
    if (fromToken === undefined) { // if fromToken is undefined, it means we don't want to copy anything
        return;
    }
