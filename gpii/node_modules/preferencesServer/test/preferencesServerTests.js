...
gpii.preferencesServer.tests.testServerMock.set = function (model, body, callback, rawPreferencesDataSource) {
    ...
    gpii.preferencesServer.tests.filesToDelete.push(__dirname+"/data/"+token+".json");

    var promise = fluid.promise();
    rawPreferencesDataSource.set({token: token}, body, callback).then(function () {
        promise.resolve({ token: token, preferences: body});
    });
    return promise;
};
...
var getFixtures = [
    {
        ...
        token: "np_flatOnly_singleContext",
        url: "%token",
        expected: {
            "contexts": {
                "gpii-default": {
        ...
        token: "np_ISO24751Only_singleContext",
        url: "%token?view=flat",
        expected: {
            "contexts": {
                "gpii-default": {
        ...
        token: "np_flatOnly_multiContext",
        url: "%token?view=flat",
        expected: {
            "contexts": {
                "gpii-default": {
        ...
        name: "GET: Basic retrieval of simple NP set in different ontology (with parameter)",
        token: "np_ISO24751Only_singleContext_wildcardMetadata",
        url: "%token?view=flat",
        expected: {
            "contexts": {
                "gpii-default": {
                    ...
                    "metadata": [{
                        ...
                        "scope": [
                            ...
                            "http://registry\\.gpii\\.net/common/onscreenKeyboard",
                            ...
                            "http://registry\\.gpii\\.net/common/-provisional-initDelay",
                            "http://registry\\.gpii\\.net/common/-provisional-slowKeysEnable",
                            "http://registry\\.gpii\\.net/common/-provisional-debounceEnable",
                            "http://registry\\.gpii\\.net/common/-provisional-mouseEmulationEnabled"
                        ],
                        "source": "snapshotter"
                    }]
                }
...
var postFixtures = [
    {
        ...
        name: "POST: With no token specified and ontology specified",
        url: "?view=flat",
        postBody: {
            "contexts": {
                "gpii-default": {
    ...
    return {
        ...
        components: {
            putRequest: {
                ...
                options: {
                    requestOptions: {
                        path: "/preferences/%token" + (fixture.view ?
                            "?view="+fixture.view : ""),
                        method: "PUT",
                        port: 8081
                    },
        ...
        putBody: {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences",
                    "preferences": {
                        "http://registry.gpii.net/common/onscreenKeyboard": false
                    },
                    "metadata": [
                        {
                            "type": "required",
...
gpii.preferencesServer.tests.old.testPostRequestResponse = function (token, expectedRaw) {
    return function (data) {
        var retrievedData = JSON.parse(data);
        // if auto-generated token, copy from return payload - this still ensures correct structure
        if (token === "") {
            token = retrievedData.token;
        }

        jqUnit.assertDeepEq("Response from old preferences server is as expected",
                { token: token }, retrievedData);
        gpii.preferencesServer.tests.put.checkRawPreferences(token, expectedRaw);
...
gpii.preferencesServer.tests.old.buildPostTestDef = function (fixture) {
    return {
        ...
        sequence: [{
            ...
            makerArgs: [ fixture.token, fixture.expectedRaw ]
        }]
    };
};
...
var oldPostSupportFixtures = [
    {
        name: "POST: no token given",
        token: "",
        copyFromToken: undefined,
        putBody: {
            "http://registry.gpii.net/common/onscreenKeyboard": [{ value: false }]
        },
        expectedRaw: {
            flat: {
                "contexts": {
        ...
        name: "POST: token given - prefs set doesn't exist",
        token: "old_post_test1",
        copyFromToken: undefined,
        putBody: {
            "http://registry.gpii.net/common/onscreenKeyboard": [{ value: false }]
        },
        ...
        name: "POST: token given - Overwriting existing NP set",
        token: "old_post_test2",
...
gpii.preferencesServer.tests.testRejectedPromise = function (data) {
...
gpii.preferencesServer.tests.rejectedPromiseFixture = {
    ...
    sequence: [{
        ...
        listener: "gpii.preferencesServer.tests.testRejectedPromise"
    }]
};
