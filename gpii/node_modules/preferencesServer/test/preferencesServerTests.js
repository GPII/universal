...
gpii.tests.preferencesServer.updatePreferencesSuccessFixtures = [
    {
        ...
        name: "updatePreferences(): No view specified, ontology matching NP set, with mergePrefs turned on to merge the new preferences with the existing preferences",
        gpiiKey: "np_flatOnly_singleContext",
        view: undefined,
        mergePrefs: true,
        preferences: {
        ...
        name: "updatePreferences(): To NP set containing same preference in different ontology, with mergePrefs turned on to merge the new preferences with the existing preferences",
        gpiiKey: "np_tiny",
        view: "ISO24751",
        mergePrefs: true,
        preferences: {
