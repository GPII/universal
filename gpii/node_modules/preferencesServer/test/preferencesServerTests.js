...
// POST success cases
gpii.tests.preferencesServer.post.testPostResponse = function (response, prefs, receivedStatusCode, expectedStatusCode) {
    var retrievedData = JSON.parse(response);
    var expected = {
        preferences: prefs,
...
gpii.tests.preferencesServer.post.buildTestDef = function (fixture) {
    ...
    return {
        ...
        sequence: [{
            ...
            args: ["{arguments}.0", fixture.postBody, "{postRequest}.nativeResponse.statusCode", expectedStatusCode]
        }]
    };
};
...
gpii.tests.preferencesServer.post.successFixtures = [
    {
        name: "POST: With no gpiiKey specified and no ontology specified",
        url: "",
        postBody: {
            "contexts": {
                "gpii-default": {
        ...
        name: "POST: With no gpiiKey specified and ontology specified",
        url: "?view=flat",
        postBody: {
            "contexts": {
                "gpii-default": {
