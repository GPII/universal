...
(function () {
    ...
    gpii.preferencesServer.get.getRawPreferences = function (preferencesServer, request, event) {
        preferencesServer.getRawPreferences(event, request.req.params.token);
    };
