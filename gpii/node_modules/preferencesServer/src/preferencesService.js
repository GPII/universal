        ...
        if (gpiiKey) {
            ...
            gpiiKeyPromise.then(function (data) {
                if (data) {
                    ...
                    var gpiiKeyExistedMsg = fluid.stringTemplate(gpii.preferencesServer.errors.gpiiKeyExisted.message, {
                        gpiiKey: gpiiKey
                    });
                    fluid.log("Preferences Service, verifyGpiiKey() rejected: ", gpiiKeyExistedMsg);
                    promiseTogo.reject({
                        errorCode: gpii.preferencesServer.errors.gpiiKeyExisted.errorCode,
                        message: gpiiKeyExistedMsg
                    });
                } else {
        ...
        gpiiKeyPromise.then(function (data) {
            ...
            if (prefsSafeId) {
                if (data.prefsSafe.prefsSafeType !== gpii.preferencesServer.prefsSafeType.user) {
                    ...
                    var noUpdateOnSnapsetMsg = fluid.stringTemplate(gpii.preferencesServer.errors.noUpdateOnSnapset.message, {
                        gpiiKey: gpiiKey
                    });
                    updatePromise.reject({
                        errorCode: gpii.preferencesServer.errors.noUpdateOnSnapset.errorCode,
                        message: noUpdateOnSnapsetMsg
                    });
                } else {
