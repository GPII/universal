...
(function () {
    ...
    fluid.defaults("gpii.preferencesServer.preferencesService", {
        ...
        invokers: {
            ...
            updatePreferences: {
                ...
                // preferences, gpiiKey, mergePrefs
            }
        },
        events: {
     ...
     * @param gpiiKey {String} Optional. The new GPII key, an UUID will be generated if it's not provided
     * @param mergePrefs {Boolean} A flag that indicates whether to merge the incoming preferences with the existing preferences
     * @return {Promise} A promise object whose resolved value is:
     *  {
     *      gpiiKey: {String},
     *      preferences: {Object}
     *  }
     */
    gpii.preferencesServer.preferencesService.updatePreferences = function (that, preferences, gpiiKey, mergePrefs) {
        mergePrefs = mergePrefs || false;  // By default, do not merge with the incoming preferences with the existing preferences
        var promiseTogo = fluid.promise();
        ...
        gpiiKeyPromise.then(function (data) {
            ...
            if (prefsSafeId) {
                if (data.prefsSafe.prefsSafeType === gpii.preferencesServer.prefsSafeType.snapset) {
                    ...
                    // The mergePrefs flag determines whether to merge the new preferences with the existing preferences
                    var prefsSafeData = fluid.extend(mergePrefs, {}, data.prefsSafe, {preferences: preferences});
