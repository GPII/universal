...
(function () {
     ...
     * @param gpiiKey {String} Optional. The new GPII key, an UUID will be generated if it's not provided
     * @param merge {Boolean} A flag that indicates whether to merge the incoming preferences with the existing preferences
     * @return {Promise} A promise object whose resolved value is:
     *  {
     *      gpiiKey: {String},
     *      preferences: {Object}
    ...
    gpii.preferencesServer.preferencesService.updatePreferences = function (that, preferences, gpiiKey, merge) {
        merge = merge || false;  // By default, do not merge with the incoming preferences with the existing preferences
        var promiseTogo = fluid.promise();
