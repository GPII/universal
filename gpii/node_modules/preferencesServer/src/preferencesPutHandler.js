...
gpii.preferencesServer.put.handleRequest = function (request, preferencesServer, event) {
    var promise = preferencesServer.getRawPreferences(request.req.params.gpiiKey);
...
gpii.preferencesServer.put.onGetRawPreferences = function (preferencesServer, ontologyHandler, request, rawPrefs, event) {
    // get the view of the given preferences (in body), update raw preferences set and PUT it
    ...
    preferencesServer.setRawPreferences(event, rawPrefs, request.req.params.gpiiKey);
};
