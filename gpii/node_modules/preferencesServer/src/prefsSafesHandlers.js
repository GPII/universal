...
gpii.preferencesServer.prefsSafeWithKeysGet.handler.get = function (prefsService, preferencesServer, request, prefsSafeId) {
    prefsService.getKeysForPrefsSafe(prefsSafeId).then(function (data) {
        prefsService.dataStore.findById(prefsSafeId).then(function (prefsSafeData) {
...
gpii.preferencesServer.prefsSafePut.handler.savePrefsSafe = function (preferencesServer, request, prefsSafeId, prefsSafe) {
    preferencesServer.dataStore.updatePrefsSafe(prefsSafeId, prefsSafe).then(request.events.onSuccess.fire, request.events.onError.fire);
};
