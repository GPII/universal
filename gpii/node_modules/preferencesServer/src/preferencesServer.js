...
fluid.defaults("gpii.preferencesServer", {
    ...
    invokers: {
        ...
        createPrefsSet: {
            funcName: "gpii.preferencesServer.createPrefsSet",
            args: ["{preferencesService}", "{ontologyHandler}", "{arguments}.0", "@expand:gpii.preferencesServer.getRequestView({arguments}.1)"]
            // preferences, toView
        // },
        // setRawPreferences: {
...
gpii.preferencesServer.createPrefsSet = function (preferencesService, ontologyHandler, preferences, toView) {
    toView = gpii.preferencesServer.getRequestView(toView);
    var payload = {};
    payload[toView] = preferences;

    return preferencesService.createPrefsSet({
        preferences: payload
    });
};
