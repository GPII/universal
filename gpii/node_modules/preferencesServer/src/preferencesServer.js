...
(function () {
    ...
    fluid.defaults("gpii.preferencesServer", {
        ...
        requestHandlers: {
            ...
            oldPreferencesGet: {
                ...
                method: "get",
                type: "gpii.preferencesServer.old.get.handler"
            },
            oldPreferencesPost: {
                route: "/oldPreferences/:userToken?",
                method: "post",
                type: "gpii.preferencesServer.old.post.handler"
            }
        },
        invokers: {
            getRawPreferences: {
    ...
    gpii.preferencesServer.getRawPreferences = function (rawPreferencesDataSource, userToken) {
        ...
        if (userToken === undefined) {
            ...
            console.log("rawPreferences datasource GET with options ", rawPreferencesDataSource.options);
            var promise = rawPreferencesDataSource.get({userToken: userToken});
            promise.then(function (data) {
                console.log("GET RAW PREFENCES RETURNED ", data);
                promiseTogo.resolve(data.preferences || data);
            }, function (err) {
                console.log("RAW PREFERENCES REJECTING ", err);
