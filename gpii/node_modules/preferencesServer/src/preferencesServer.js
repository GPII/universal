...
fluid.defaults("gpii.preferencesServer", {
    ...
    invokers: {
        ...
        updatePreferences: {
            ...
            // gpiiKey, preferences, view, mergePrefs
        }
    },
    components: {
        preferencesService: {
 ...
 * @param view {String} An view that the preferences should be transformed upon
 ...
 * @param view {String} An view that the provided preferences is based upon
 ...
 * }
 */
gpii.preferencesServer.updatePreferences = function (preferencesService, ontologyHandler, gpiiKey, preferences, view, mergePrefs) {
    ...
    if (!gpiiKey) {
        ...
        gpiiKeyPromise.then(function (gpiiKeyRelatedData) {
            ...
            if (gpiiKeyRelatedData) {
                ...
                var updatePromise = preferencesService.updatePreferences(payload, gpiiKey, mergePrefs);
