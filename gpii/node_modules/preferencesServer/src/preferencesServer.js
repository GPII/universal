...
(function () {
    ...
    fluid.defaults("gpii.preferencesServer", {
        ...
        invokers: {
            ...
            setRawPreferences: {
                ...
                args: ["{gpii.preferencesServer}.rawPreferencesDataSource", "{arguments}.0", "{arguments}.1", "{arguments}.2" ]
            }
        },
    ...
    gpii.preferencesServer.setRawPreferences = function (rawPreferencesDataSource, event, body, token) {
        ...
        rawPreferencesDataSource.set({token: token || ""}, body, gpii.preferencesServer.logAndNotify("Saved raw user preferences: ", event,
            function getPreferences(data) {
                return data;
            })
        );
