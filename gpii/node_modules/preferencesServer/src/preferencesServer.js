...
fluid.defaults("gpii.preferencesServer", {
    ...
    requestHandlers: {
        ...
        preferencesPostPrefs: {
            route: "/preferences/",
            method: "post",
            type: "gpii.preferencesServer.postPrefs.handler"
        },
        preferencesPut: {
            route: "/preferences/:gpiiKey",
            method: "put",
...
gpii.preferencesServer.createPreferences = function (preferencesService, ontologyHandler, preferences, view, gpiiKey) {
    ...
    if (!preferences) {
        ...
        fluid.log("Preferences Server, createPreferences(), adding GPII key (", gpiiKey, ") and its preferences: ", payload);
