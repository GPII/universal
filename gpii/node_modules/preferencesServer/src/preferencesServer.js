...
(function () {
    ...
    fluid.defaults("gpii.preferencesServer", {
        ...
        invokers: {
            getRawPreferences: {
                ...
                args: ["{gpii.preferencesServer}.rawPreferencesDataSource", "{requestProxy}.events.onError", "{arguments}.0", "{arguments}.1"]
            },
            getRawPreferencesAllowError: {
                funcName: "gpii.preferencesServer.getRawPreferences",
                args: ["{gpii.preferencesServer}.rawPreferencesDataSource", "{arguments}.0", "{arguments}.0", "{arguments}.1"]
            },
            setRawPreferences: {
    ...
    gpii.preferencesServer.getRawPreferences = function (rawPreferencesDataSource, errorEvent, event, userToken) {
        ...
        promise.then(function (data) {
            event.fire((data === undefined) ? {} : data.preferences || data); //TODO KASPER!!!!!!!!!
        }, errorEvent.fire);
    };
    ...
    gpii.preferencesServer.setRawPreferences = function (rawPreferencesDataSource, requestProxy, successEvent, body, userToken) {
        ...
        promise.then(successEvent.fire, function (e) {
            // console.log("E: "+JSON.stringify(e));
            // console.log("R E: "+ (typeof request) + " ... has events " + JSON.stringify(request.events));
             requestProxy.events.onError.fire(e);
        });
    };
