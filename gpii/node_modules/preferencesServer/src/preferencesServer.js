    ...
    fluid.defaults("gpii.preferencesServer", {
        ...
        requestHandlers: {
            preferencesGet: {
                ...
                method: "get",
                handler: "gpii.preferencesServer.get.handler"
            },
            preferencesPost: {
                route: "/preferences",
                method: "post",
                handler: "gpii.preferencesServer.post.handler"
            },
            preferencesPut: {
                route: "/preferences/:userToken",
                method: "put",
                handler: "gpii.preferencesServer.put.handler"
            },
            oldPreferencesGet: {
                route: "/oldPreferences/:userToken",
                method: "get",
                handler: "gpii.preferencesServer.old.get.handler"
            },
            oldPreferencesPost: {
                route: "/oldPreferences/:userToken?",
                method: "post",
                handler: "gpii.preferencesServer.old.post.handler"
            }
        },
        invokers: {
            getRawPreferences: {
            ...
            setRawPreferences: {
                ...
                args: ["{gpii.preferencesServer}.rawPreferencesDataSource", "{request}", "{arguments}.0", "{arguments}.1", "{arguments}.2" ]
            }
        },
        components: {
