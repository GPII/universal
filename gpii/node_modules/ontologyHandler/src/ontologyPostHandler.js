...
(function () {
    ...
    gpii.ontology.post.request = function (request, ontologyHandler, event) {
        ...
        ontologyHandler.setRawPreferences(event, payload, undefined, "POST");
    };
