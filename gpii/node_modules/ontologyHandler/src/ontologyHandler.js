...
(function () {
     ...
     * @param prefs {Object} The preferences set to be translated into a different ontology. The preferences set
     *     passed should be in the ontology specified by the 'fromView' parameter and NOT keyed by
     *     an ontology ID.
     * @param fromView {String} The ontology in which the preferences set given in the 'prefs' parameter is formatted
     * @param toView {String} The ontology to which the preferences set should be transformed.
     *
     * @return The NP transformed into the ontology requested via the 'toView' parameter. If no
     *     valid transformation to that ontology was found, an empty preferences set is returned
     */
    ...
    /**
     * Function to merge two preferences sets.
     *
