...
(function () {
    ...
    fluid.defaults("gpii.ontologyHandler", {
        ...
        invokers: {
            ...
            finalInit: {
                funcName: "gpii.ontologyHandler.finalInit",
                args: [ "{that}" ]
            }
        },
        listeners: {
            onCreate: "{that}.finalInit"
        },
    ...
    /*
     * Small utility function for adding a key-value pair to an object only if the value is not 'undefined'
     *
