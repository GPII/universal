...
(function () {
     ...
     * @param prefs {Object} The preference set to be translated into a different ontology. The preference set
     *     passed should be in the ontology specified by the 'fromView' parameter and NOT keyed by
     *     an ontology ID.
     * @param fromView {String} The ontology in which the preference set given in the 'prefs' parameter is formatted
     * @param toView {String} The ontology to which the preference set should be transformed.
     *
     ...
     * @param rawPrefs {Object} The raw preferences as can be found on the preferences server - NOT
     *     expected keyed by 'preferences'
     * @param toView {String} The ontology to translate the preference set into
     *
     ...
     *
     * @param that {Object} A gpii.ontologyHandler object
     * @param prefs {Object} A preference set in some ontology
     * @param prefsView {String} The format of the preference set given in the 'prefs' parameter
     * @param rawPrefs {Object} The raw preference set to be modified
     *
