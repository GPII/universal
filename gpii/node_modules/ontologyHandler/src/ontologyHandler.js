...
(function () {
    ...
    gpii.ontologyHandler.loadOntologies = function (that) {
        console.log("loadOntologies for " + that.id + " path " + fluid.pathForComponent(that));
        var ontologyDir = kettle.module.resolvePath(that.options.ontologySourceListDir);
    ...
    gpii.ontologyHandler.loadOntologyTransformSpecs = function (that, ontologyDir, ontologyTransformsList) {
        var transformSpecs = {};
        fluid.each(ontologyTransformsList, function (filename) { // TODO: we have a multiple startup bug
