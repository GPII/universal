...
(function () {
    ...
    gpii.ontologyHandler.loadOntologyTransformSpecs = function (that, ontologyDir, ontologyTransformsList) {
        ...
        fluid.each(transformSpecs, function(spec, key) {
            ...
            edges.push(key.split('-'), key.split('-').reverse());
        });
    ...
    gpii.ontologyHandler.floydWarshallAlgorithmWithReconstruction = function ( edges ) {
        ...
        fluid.each(edges, function(edge) {
            initialVertices.push(edge[0], edge[1]);
        });
        var vertices = fluid.arrayToHash(initialVertices);
        // Assign each vertice an integer key for the lookup arrays
     ...
     * generate the shortest path as an array of vertice names.
     *
