...
(function () {
    ...
    fluid.registerNamespace("gpii.tests.ontologyHandler");

    var ontologyHandler = fluid.registerNamespace("gpii.ontologyHandler");
    ...
    gpii.tests.ontologyHandler.runTests = function () {
        jqUnit.module("Utilities");

        jqUnit.test("ontologyHandler.filter", function () {
    ...
    //         "": {
    //             "transform": {
    //                 "type": "gpii.ontologyHandler.transform.application",
    //                 "inputPath": "",
    ...
    //     jqUnit.test("ontologyHandler.parsePreferences", function () {
    //         var expected = {
    //             "flat": {
    //                 to: "ISO24751-2",
    //                 from: "flat",
    ...
    //             var actualName = ontologyHandler.parsePreferences(prefSet);
    //             jqUnit.assertDeepEq("Ontology related information is parsed correctly",
    //                 expected[type], actualName);
    //         });
    //     });

    //     jqUnit.test("ontologyHandler.expandTransformations", function () {
    //         var expected = {
    //             "ISO24751-2/flat": {
    //                 "display.screenEnhancement.fontSize": "http://registry\\.gpii\\.org/common/fontSize.0.value",
    //                 "display.screenEnhancement.tracking": "http://registry\\.gpii\\.org/common/tracking.0.value",
    ...
    //             jqUnit.assertDeepEq("Ontology transformation rules are expanded correctly.", thisExpected, ontologyHandler.expandTransformations(transformations[key]));
    //         });
    //     });
