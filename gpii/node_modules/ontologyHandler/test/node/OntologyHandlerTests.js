...
(function () {
    ...
    gpii.ontologyHandler.tests.floydWarshallAlgorithmWithReconstruction = function () {
        var edges = [["A","B"], ["B","A"], ["C","B"], ["B", "C"], ["B","D"], ["D", "B"]];
        var mapped_edges = [];
        ...
        var data = gpii.ontologyHandler.floydWarshallAlgorithmWithReconstruction(mapped_edges);
        jqUnit.assertDeepEq("Testing path from A to D through B.", ["A", "B", "D"],
            gpii.ontologyHandler.floydWarshallPath(data, "A", "D"));
        jqUnit.assertDeepEq("Testing path from D to A through B.", ["D", "B", "A"],
            gpii.ontologyHandler.floydWarshallPath(data, "D", "A"));
        jqUnit.assertDeepEq("Testing direct path from A to B", ["A", "B"],
            gpii.ontologyHandler.floydWarshallPath(data, "A", "B"));
        jqUnit.assertDeepEq("Testing direct path from B to A", ["B", "A"],
            gpii.ontologyHandler.floydWarshallPath(data, "B", "A"));
    };
