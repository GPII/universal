...
(function () {
    ...
    gpii.tests.canopyMatchMaker.runTests = function () {
        ...
        jqUnit.test("Rank and dispose solutions", function() {
            ...
            var expanded = gpii.matchMaker.expandSolutions(solutions);
            ...
            var disposed = gpii.matchMaker.disposeSolutions(sammyProfile, solutions, canopy.disposeStrategy);
            var itions = gpii.matchMaker.extractDispositions(disposed);
            var expected2 = ["reject", "accept"];
            jqUnit.assertDeepEq("Disposed solutions", expected2, itions);
        });
