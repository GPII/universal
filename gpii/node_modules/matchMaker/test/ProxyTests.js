...
var fluid = require("infusion"),
    ...
    flowManager = fluid.require("matchMaker", require),
...
var proxy = fluid.registerNamespace("kettle.tests.matchMakerProxyTests");

proxy.preferences = require(path.resolve(__dirname,
    "../../../../testData/preferences/os_common.json"));
...
proxy.payload = {
    ...
    device: {
        solutions: require(path.resolve(__dirname,
...
proxy.testFailedResponse = function (data) {
    ...
    jqUnit.assertEquals("Errpr message is correct", "connect ECONNREFUSED",
        data.message);
};
...
var testDefs = [{
    ...
    sequence: [{
        ...
        listener: "kettle.tests.matchMakerProxyTests.testProxyResponse"
    }, {
        func: "{request}.send",
        args: proxy.payloadRuleBased
    }, {
        event: "{request}.events.onComplete",
        listener: "kettle.tests.matchMakerProxyTests.testFailedResponse"
    }]
}];
