...
(function () {
    ...
    // This is a stub development raw ontology data source.
    fluid.demands("rawOntologyServer", ["matchMaker.development", "gpii.matchMaker"], {
        funcName: "gpii.matchMaker.developmentOntologyDataSource"
    });
    fluid.defaults("gpii.matchMaker.developmentOntologyDataSource", {
        ...
        preInitFunction: "gpii.matchMaker.developmentOntologyDataSource.preInit"
    });
    gpii.matchMaker.developmentOntologyDataSource.preInit = function (that) {
        that.get = function (termMap, callback) {
            var preferences = termMap.preferences;
            that.ontologySource.get(null, function (data) {
    ...
    fluid.demands("rawOntologyServer", "gpii.matchMaker", {
        funcName: "gpii.dataSource.URL",
        options: {
            url: "{gpii.matchMaker}.options.ontologyServerUrl",
            termMap: {
    ...
    fluid.demands("ontologyServer", "gpii.matchMaker", {
        options: {
            components: {
