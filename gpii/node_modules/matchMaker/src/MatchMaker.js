(function () {
    ...
    fluid.demands("gpii.matchMaker.set", "gpii.matchMaker", {
        ...
        args: ["{transformer}.transformSettings", "{solutionsReporter}", "{gpii.matchMaker}.match", "{arguments}.0", "{arguments}.1", "{arguments}.2"]
    });
    ...
    gpii.matchMaker.setFS = function (transform, solutionsReporter, match, directModel, model, callback) {
        solutionsReporter.get(undefined, function (solutions) {
            var solutions = filterFSSolutions(solutions, model.device);
            callback(transform({
                solutions: match(model.preferences, solutions),
