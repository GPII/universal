...
(function () {
    ...
    gpii.matchMaker.match = function (preferences, solutions, strategy, inverseCapabilities) {
        console.log("gpii.matchMaker.match: preferences ", preferences, " solutions ", solutions, " strategy " , strategy, " invCap ", inverseCapabilities);
        ...
        return fluid.promise.map(gpii.matchMaker.disposeSolutions(preferences, solutions, strategy), function (disposed) {
            var togo = [];
