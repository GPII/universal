...
var JavaRpcClient = function() {
	...
	_self.sendUserProfile = function(message) 
	{
		...
		if(message.display != null && message.display.screenEnhancement != null && message.display.screenEnhancement.magnificationPosition != null)
		{
		...
		sendMessage({ messageName : "UserProfile", fontSize  : tmpFontSize, magnification : tmpMagnification, foregroundColor : tmpForegroundColor, backgroundColor : tmpBackgroundColor, highContrast: highContrast, magnifierFullScreen: magnifierFullScreen });
    };
	
	_self.sendDeviceReporterPayload = function(message) {
        sendMessage({ messageName : "EnvironmentProfile", os_id  : message.OS.id, os_version : message.OS.version });
    };
