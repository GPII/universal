...
var JavaRpcClient = function() {
	...
	_self.sendUserProfile = function(message) 
	{
		...
		if(message.display != null
			&& message.display.screenEnhancement != null
			&& message.display.screenEnhancement.highContrast != null)
		{
		...
		if(message.display != null
			&& message.display.screenEnhancement != null
			&& message.display.screenEnhancement.magnificationPosition != null)
		{
			if(message.display.screenEnhancement.magnificationPosition == "FullScreen")
				magnifierFullScreen = true;
		}
		if(message.display != null
			&& message.display.screenEnhancement != null
			&& message.display.screenEnhancement["-provisional-magnifierPosition"] != null)
		{
