...
var JavaRpcClient = function() {
    ...
    _self.jarPath   = '../node_modules/universal/gpii/node_modules/matchMaker/src/RB_MM/Cloud4All_MatchMaker.jar';
    _self.verbose   = true;
    ...
    _self.on('Hello', function(){
        _self.sendHello();
		//sendUserProfile("sending us prof...");
    });
	...
	_self.sendUserProfile = function(message) 
	{
		...
		if(message.applications != null
			&& message.applications["com.microsoft.windows.highContrast"] != null
			&& message.applications["com.microsoft.windows.highContrast"].parameters !=null
			&& message.applications["com.microsoft.windows.highContrast"].parameters.highContrastOn != null
			&& message.applications["com.microsoft.windows.highContrast"].parameters.highContrastOn.value != null)
		{
			if(message.applications["com.microsoft.windows.highContrast"].parameters.highContrastOn.value == 1)
				highContrast = true;
		}
		else if(message.applications != null
			&& message.applications["org.gnome.desktop.interface"] != null
			&& message.applications["org.gnome.desktop.interface"].parameters != null
			&& message.applications["org.gnome.desktop.interface"].parameters["gtk-theme"] != null)
		{
			if(message.applications["org.gnome.desktop.interface"].parameters["gtk-theme"] == "HighContrast")
				highContrast = true;
		}
		
		var magnifierFullScreen = false;
		if(message.applications != null
			&& message.applications["com.microsoft.windows.magnifier"] != null
			&& message.applications["com.microsoft.windows.magnifier"].parameters != null
			&& message.applications["com.microsoft.windows.magnifier"].parameters.MagnificationMode != null
			&& message.applications["com.microsoft.windows.magnifier"].parameters.MagnificationMode.value != null)
		{
			if(message.applications["com.microsoft.windows.magnifier"].parameters.MagnificationMode.value == 2)
				magnifierFullScreen = true;
		}
		else if(message.applications != null
			&& message.applications["org.gnome.desktop.a11y.magnifier"] != null
			&& message.applications["org.gnome.desktop.a11y.magnifier"].parameters != null
			&& message.applications["org.gnome.desktop.a11y.magnifier"].parameters["screen-position"] != null)
		{
			if(message.applications["org.gnome.desktop.a11y.magnifier"].parameters["screen-position"] == "full-screen")
				magnifierFullScreen = true;
		}		
		
		//else
		//	console.log("\n\n\nDEEEEEN EXEI CONTRAST path\n\n\n");
			
		//console.dir("\n\n\n\nTO XXX EINAI: " + message.applications["org.gnome.desktop.interface"].parameters["gtk-theme"] + "\n\n\n");	
		...
		sendMessage({
            ...
            fontSize  : message.display.screenEnhancement.fontSize,
			magnification : message.display.screenEnhancement.magnification,
			foregroundColor : message.display.screenEnhancement.foregroundColor,
			backgroundColor : message.display.screenEnhancement.backgroundColor,
	...
	_self.sendDeviceReporterPayload = function(message) {
        sendMessage({
            messageName : "EnvironmentProfile",
            os_id  : message.OS.id,
			os_version : message.OS.version
        });
    }
