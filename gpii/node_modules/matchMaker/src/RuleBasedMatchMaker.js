...
ruleBasedMatchMaker.match = function (callbackWrapper, preferences, solutions, originalModel, strategy) {
    ...
    console.log("PREFERNCES PRIN TON TRANSFORMER:\n");
    console.dir(preferences);
    console.log("\n\n");
    
    fs.writeFile("prinTonTransformer.json", JSON.stringify(preferences, null, 4), function(err) {
	    if(err) {
	      console.log(err);
	    } else {
    ...
    console.log("PREFERNCES META TON TRANSFORMER:\n");
    console.dir(preferences);
    console.log("\n\n");
    
    fs.writeFile("metaTonTransformer.json", JSON.stringify(preferences, null, 4), function(err) {
	    if(err) {
	      console.log(err);
	    } else {
	      //console.log("JSON saved to ");
					...
					for(i=0; i<newPrefsWords.length;i++)
					{
						if(newPrefsWords[i] == "ENABLE_DEFAULT_THEME")
						{
							if(preferences != null
								...
								&& preferences.display.screenEnhancement != null)
							{
								preferences.display.screenEnhancement.highContrast = false;
							}
							//remove application-unique highContrast - Windows
							if(preferences != null
							...
							//remove application-unique highContrast - Linux
							if(preferences != null
								&& preferences.applications["org.gnome.desktop.interface"] != null
								&& preferences.applications["org.gnome.desktop.interface"].parameters != null
								&& preferences.applications["org.gnome.desktop.interface"].parameters["gtk-theme"] != null
								&& preferences.applications["org.gnome.desktop.interface"].parameters["gtk-theme"] == "HighContrast")
						...
						else if(newPrefsWords[i] == "ENABLE_MAGNIFIER_WITH_INVERSE_COLOURS")
						{
							...
							if(preferences != null
								&& preferences.applications != null
								&& preferences.applications["com.microsoft.windows.magnifier"] != null
								&& preferences.applications["com.microsoft.windows.magnifier"].parameters != null
								&& preferences.applications["com.microsoft.windows.magnifier"].parameters.MagnificationMode != null)
								delete preferences.applications["com.microsoft.windows.magnifier"].parameters.MagnificationMode;
							if(preferences != null
								&& preferences.applications != null
								&& preferences.applications["com.microsoft.windows.magnifier"] != null
								&& preferences.applications["com.microsoft.windows.magnifier"].parameters != null
								&& preferences.applications["com.microsoft.windows.magnifier"].parameters.Invert != null)
								delete preferences.applications["com.microsoft.windows.magnifier"].parameters.Invert;
							if(preferences != null
								&& preferences.applications != null
								&& preferences.applications["com.microsoft.windows.magnifier"] != null
								&& preferences.applications["com.microsoft.windows.magnifier"].parameters != null
								&& preferences.applications["com.microsoft.windows.magnifier"].parameters.Magnification != null)
								delete preferences.applications["com.microsoft.windows.magnifier"].parameters.Magnification;
							//remove application-unique highContrast - Linux
							if(preferences != null
								&& preferences.applications != null
								&& preferences.applications["org.gnome.desktop.a11y.magnifier"] != null
								&& preferences.applications["org.gnome.desktop.a11y.magnifier"].parameters != null
								&& preferences.applications["org.gnome.desktop.a11y.magnifier"].parameters["mag-factor"] != null)
								delete preferences.applications["org.gnome.desktop.a11y.magnifier"].parameters["mag-factor"];
							if(preferences != null
								&& preferences.applications != null
								&& preferences.applications["org.gnome.desktop.a11y.magnifier"] != null
								&& preferences.applications["org.gnome.desktop.a11y.magnifier"].parameters != null
								&& preferences.applications["org.gnome.desktop.a11y.magnifier"].parameters["screen-position"] != null)
								delete preferences.applications["org.gnome.desktop.a11y.magnifier"].parameters["screen-position"];
						}	
					}
					
					
					 fs.writeFile("metaTaRules.json", JSON.stringify(preferences, null, 4), function(err) {
						    if(err) {
						      console.log(err);
						    } else {
						      //console.log("JSON saved to ");
