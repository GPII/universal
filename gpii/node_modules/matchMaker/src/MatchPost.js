...
(function () {
    ...
    gpii.request.matchMaker.match = function (matchMaker, when, solutions, preferences) {
    ...
    gpii.request.matchMaker.transformPreferences = function (matchMaker, event, model) {
        var preferences = matchMaker.ontologyHandler.prefsToOntology(model.preferences, "flat", "ISO24751");
