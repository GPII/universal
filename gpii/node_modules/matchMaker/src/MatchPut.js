...
(function () {
    ...
    fluid.demands("gpii.requests.request.handler", "matchPut", {
        options: {
            invokers: {
                handle: {
                    funcName: "gpii.requests.request.handler.matchPut",
                    args: ["{request}", "{gpii.matchMaker}"]
                }
            }
        }
    });

    gpii.requests.request.handler.matchPut = function (request, matchMaker) {
        var req = request.req,
            res = request.res,
            model = req.body,
