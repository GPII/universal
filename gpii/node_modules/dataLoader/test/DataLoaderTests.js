...
jqUnit.test("Test gpii.dataLoader.processDataFiles", function () {
    var testData = {
        case1: {
            db1: {
                dataFile: [
                    "%dataLoader/test/data/prefs/carla.json",
                    "%dataLoader/test/data/views-test.json"
                ],
                data: {
                    "test1": "test1"
                }
        ...
        case2: {
            db1: {
                dataFile: [
                    "%dataLoader/test/data/nonExistent1.json",
                    "%dataLoader/test/data/prefs/sammy.json"
                ],
                data: {
                    "test1": "test1"
                }
            ...
            db2: {
                dataFile: [
                    "%dataLoader/test/data/nonExistent2.json"
                ],
                data: {
                    "test2": "test2"
                }
    ...
    var expected = {
        ...
        case2: {
            ...
            errors: [
                ".*test\/data\/nonExistent1.json",
                ".*test\/data\/nonExistent2.json"
            ],
            databases: {
                db1: [{
                    "flat": {
