...
gpii.settingsHandlers.writeFile = function (content, options) {
    if (!options || !options.filename) {
        ...
        fluid.log("writeFile: No settingsfile '", options.filename, "'' exists.  Nothing written.");
        return;
    }
 ...
 * within the source settingshandler block (ie. the named settinghandler sub blocks) must be present
