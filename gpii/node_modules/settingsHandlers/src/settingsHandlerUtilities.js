...
gpii.settingsHandlers.checkRereadSettings = function (that) {
    ...
    if (equal) {
        ...
        if (that.retries === that.retryOptions.numRetries) {
            ...
            console.log("===============RETRYING - try " + that.retries + " of " + that.retryOptions.numRetries + " attempts will reread settings in " + that.retryOptions.retryInterval + "ms");
