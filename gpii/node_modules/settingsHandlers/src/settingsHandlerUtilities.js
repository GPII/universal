 ...
 * @param {String} resolvedName - The resolved "trunk name" of the settings handler to be invoked - e.g. gpii.windows.registrySettingsHandler.
 * @param {Object} payload - The full payload that would be sent to the SET method of the settings handler.
 * @param {Object} [retryOptions] - [optional] Options governing the retry behaviour of the wrapped handler. This contains fields:
 ...
 * @param {String} resolvedName - The resolved "trunk name" of the settings handler to be invoked - e.g. gpii.windows.registrySettingsHandler.
 * @param {Object} payload - The full payload that would be sent to the SET method of the settings handler.
 * @param {Object} retryOptions - Options governing the retry behaviour of the wrapped handler. This contains fields:
 *     numRetries {Integer} A positive integer holding the total number of retries to make
 *     retryInterval {Integer} A positive integer holder the delay in milliseconds between each retry.
 * @return {Promise} A promise that will yield the original payload of the originally invoked SET method if the GET calls eventually produce a result
