...
gpii.settingsHandlers.dispatchSettingsHandler = function (resolvedName, payload, retryOptions) {
    for (var appData in payload) {
        appData = payload[appData];
        if (appData[0].options && appData[0].options.verifySettings === true) {
            return gpii.settingsHandlers.invokeRetryingHandler(resolvedName, payload, retryOptions);
        } else {
