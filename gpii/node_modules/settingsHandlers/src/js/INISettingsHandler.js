            ...
            return fluid.transform(solution, function(solutionEntry) {
                ...
                if (options && options.path) {
                    ...
                    fluid.each(userRequestedSettings, function (settingVal, settingKey) {
                        oldValue = fluid.get(defaultSettings, settingKey, fluid.model.escapedGetConfig);
                        fluid.set(defaultSettings, settingKey, settingVal, fluid.model.escapedSetConfig);
