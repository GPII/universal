        ...
        return fluid.transform(returnObj, function (solution) {
            return fluid.transform(solution, function(solutionEntry) {
                ...
                if (options && options.path) {
                    ...
                    // //we cant simply use require as that'll break if the file doesn't end on .ini
                    // var defaultSettings = iniparser.parseSync(options.path);
                    //defaultSettings = INI.parse(content); 
                    newSettingsResponse = {};
