...
(function () {
    ...
    gpii.settingsHandlers.XMLHandler.invertArrayToHash = function (expandSpec, expander) {
        var togo = fluid.copy(expandSpec);
        togo.type = "gpii.settingsHandlers.XMLHandler.hashToArray";
        togo.inputPath = expander.outputPrefix;
        togo.outputPath = expandSpec.inputPath;
        return togo;
    };
    ...
    fluid.defaults("gpii.settingsHandlers.XMLHandler.arrayToHash", {
        ...
        invertConfiguration: "gpii.settingsHandlers.XMLHandler.invertArrayToHash"
    });
