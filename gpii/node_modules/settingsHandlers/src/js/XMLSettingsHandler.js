    ...
    **/
    var createFromEL = function (root, el, value) {
        ...
        if (root[headPath]) { //if path exists so far, enter one segment further
            ...
            if (!fromHeadPath) { //if we've reached end of el path, set value and return expected structure
                root[headPath] = value;
            } else { //if we made it this far, create the object for this el-segment and enter it
                root[headPath] = {};
                createFromEL(root[headPath], fromHeadPath, value);
            }
        }
