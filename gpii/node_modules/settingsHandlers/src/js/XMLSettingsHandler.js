...
(function () {
    ...
    gpii.settingsHandlers.XMLHandler.set = function(data) {
        var returnPayload = [];
        fluid.each(data, function(arrayEntry, idx) {
            returnPayload[idx] = {};
            fluid.each(arrayEntry, function(application, applicationId) {
                ...
                if (options && options.filename) {
                    ...
                    returnPayload[idx][applicationId] = gpii.settingsHandlers.XMLHandler.applySettings(settings, json);
