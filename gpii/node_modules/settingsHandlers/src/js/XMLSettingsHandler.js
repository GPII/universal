...
(function () {
    ...
    gpii.settingsHandlers.XMLHandler.expandInnerValues = function (innerValues, expander) {
        var expanded = {};
    ...
    gpii.settingsHandlers.XMLHandler.arrayToObject = function (arr, expander, expandSpec) {
        ...
        fluid.each(arr, function (v, k) {
            ...
            if (expandSpec.options.innerValue) {
                content = gpii.settingsHandlers.XMLHandler.arrayToObject.expandInnerValues(k, newKey, expander, expandSpec);
            }
    ...
    gpii.settingsHandlers.XMLHandler.arrayToObject.expandInnerValues = function (arrayIdx, key, expander, expandSpec) {
        ...
        inputPrefixOp.push(arrayIdx.toString()); //push doesn't accept ints
        outputPrefixOp.push(key);
        
        var expanded = gpii.settingsHandlers.XMLHandler.expandInnerValues(expandSpec.options.innerValue, expander)
    ...
    gpii.settingsHandlers.XMLHandler.objectToArray = function (hash, expander, expandSpec) {
        ...
        fluid.each(hash, function (v, k) {
            ...
            content[pivot] = k;
            if (expandSpec.options.innerValue) {
                v = gpii.settingsHandlers.XMLHandler.objectToArray.expandInnerValues(k, newArray, expander, expandSpec);
            }
    ...
    gpii.settingsHandlers.XMLHandler.objectToArray.expandInnerValues = function (key, arr, expander, expandSpec) {
        var inputPrefixOp = expander.inputPrefixOp;
        var outputPrefixOp = expander.outputPrefixOp;
        
        inputPrefixOp.push(expandSpec.inputPath);
        inputPrefixOp.push(key);
        outputPrefixOp.push(expandSpec.inputPath);
        outputPrefixOp.push(arr.length.toString());
