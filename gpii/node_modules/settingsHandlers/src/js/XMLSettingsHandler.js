...
(function () {
    ...
    gpii.settingsHandlers.XMLHandler.applySettings = function(settings, obj) {
        ...
        fluid.each(settings, function(value, el) {
            ...
            console.log("Value: "+prev+" --> "+fluid.get(obj, el));
    ...
    gpii.settingsHandlers.XMLHandler.set = function(data) {
        var returnPayload = {};
        fluid.each(data, function(application, applicationId) {
            ...
            if (options && options.filename) {
                ...
                returnPayload[applicationId] = gpii.settingsHandlers.XMLHandler.applySettings(settings, json);
                console.log(json);
                //Create XML - first the xml-tag from options if set, then our modified json converted to XML
        ...
        //console.log("OLD-SETTINGS "+ JSON.stringify(returnPayload));
        return returnPayload;
    };
}());
