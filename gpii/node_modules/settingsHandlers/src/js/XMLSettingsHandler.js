...
(function () {
    ...
    var fluid = require("infusion"),
        ...
        parser = fluid.registerNamespace(
            "gpii.settingsHandlers.XMLHandler.parser");
     ...
     */
    settingsHandlers.XMLHandler.formatXml = function (xml) {
        var formatted = "";
        var reg = /(>)(<)(\/*)/g;
     ...
     */
    parser.parse = function (content, options) {
        // Parse XML to JSON.
     ...
     */
    parser.stringify = function (content, options) {
        options = options || {};
        ...
        xml = settingsHandlers.XMLHandler.formatXml(xml);
        return xml;
    };
    ...
    // hardcoded to hit the filesystem

    // TODO: Rescue the algorithm gpii.invokeSettingsHandler from
    // RegistrySettingsHandler.js line 226 and use it to simplify the loops
    // of all settings handlers including this one
    settingsHandlers.XMLHandler.get = settingsHandlers.makeGet(parser);
    settingsHandlers.XMLHandler.set = settingsHandlers.makeSet(parser);
}());
