...
(function () {
    ...
    gpii.settingsHandlers.XMLHandler.arrayToHash.invertRules = function (expandSpec, expander) {
        ...
        togo.type = "gpii.settingsHandlers.XMLHandler.hashToArray";
     ...
     */
    gpii.settingsHandlers.XMLHandler.hashToArray = function (hash, expander, expandSpec) {
    ...
    fluid.defaults("gpii.settingsHandlers.XMLHandler.hashToArray", {
