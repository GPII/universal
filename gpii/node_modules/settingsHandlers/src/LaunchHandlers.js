 ...
 * the cases in which a solutions launch-cycle is too complex or specific to efficiently be handled
 ...
 *
 * `getState`: equals the launchHandlers "get" functionality, and should return a boolean value indicating
 *      whether the application is running or not. The content of this directive will be sent to the
 *      processReporters' handleIsRunning function
