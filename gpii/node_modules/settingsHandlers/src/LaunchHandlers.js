...
gpii.launchHandlers.flexibleHandler.executeStartBlock = function (mainEntry) {
    var startBlocks = fluid.get(mainEntry, [ "options", "start" ]);
    fluid.each(fluid.makeArray(startBlocks), function (startBlock) {
...
gpii.launchHandlers.flexibleHandler.executeStopBlock = function (mainEntry) {
    var stopBlocks = fluid.get(mainEntry, [ "options", "stop" ]);
    fluid.each(fluid.makeArray(stopBlocks), function (stopBlock) {
...
gpii.launchHandlers.flexibleHandler.executeIsRunningBlock = function (options) {
    return gpii.processReporter.handleIsRunning(options);
};
