...
(function () {
    ...
    parser.parse = function (content, options) {
        // Parse XML to JSON.
        var json = gpii.settingsHandlers.normalize(xm.tojson(content));
        //  Apply the settings
    ...
    settingsHandlers.XMLHandler.get = settingsHandlers.makeFileGet(parser);
    settingsHandlers.XMLHandler.set = settingsHandlers.makeFileSet(parser);
}());
