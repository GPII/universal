...
(function () {
    ...
    // Potentially, can be deleted unless we really need it
    //
    gpii.settingsHandlers.WebSocketsComponent.clientsChanged = function (change) {
        //var util = require("util");
        //console.log("A change in clients has been registered: " + util.inspect(change));
    };
