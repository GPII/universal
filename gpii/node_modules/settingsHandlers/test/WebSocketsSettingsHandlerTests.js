...
jqUnit.test("Checking wsSettingsHandler's add/remove methods", function () {
    ...
    jqUnit.assertDeepEq("Check that the client has been added", webSocketsTests.clients.clientOneExpected, wsSettingsHandlers.clients[webSocketsTests.clients.clientOne[0]]);

    wsSettingsHandlers.removeClient(webSocketsTests.clients.clientOne[1]);
    jqUnit.assertDeepEq("Check that the client has been removed", undefined, wsSettingsHandlers.clients[webSocketsTests.clients.clientOne[0]]);

    jqUnit.assertDeepEq("Check that the client object is clear", {}, wsSettingsHandlers.clients);
