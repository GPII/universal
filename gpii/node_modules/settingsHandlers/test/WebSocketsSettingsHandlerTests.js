...
jqUnit.test("Checking wsSettingsHandler object before doing anything", function () {
    ...
    jqUnit.assertTrue("There are an object to store the settings", that.model.settings);
    jqUnit.assertTrue("There are an object to store the clients", that.clients);

    jqUnit.assertDeepEq("wsSettingsHandler.settings is empty", {}, that.model.settings);
    jqUnit.assertDeepEq("wsSettingsHandler.clients is empty", {}, that.clients);
});
