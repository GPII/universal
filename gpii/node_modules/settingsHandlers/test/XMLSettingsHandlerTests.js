...
(function () {
    ...
    var deleteTestFiles = function () {
        fluid.each(testFilePaths, function (filePath) {
            fs.unlink(filePath);
        });
    };
    ...
    XMLHandlerTester.asyncTest("XMLHandler.set", function () {
        setTimeout(function() {
            ...
            fs.writeFileSync(testFilePaths[0], origXML, "utf-8");
            //test return payload
            ...
            var savedXML = fs.readFileSync(testFilePaths[0], "utf-8");
            ...
            fs.writeFileSync(testFilePaths[1], origXML2, "utf-8");
            //test return payload
            ...
            //next check that the written XML file is as expected:
            var savedXML2 = fs.readFileSync(testFilePaths[1], "utf-8");
