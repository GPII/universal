...
(function () {
    ...
    XMLHandlerTester.asyncTest("XMLHandler.set", function () {
        ...
        setTimeout(function() {
            ...
            // TODO: Remove duplication between this block and the one at line 538
            ...
            fs.writeFileSync(testTempFilePaths[0], origXML, "utf-8");
            //test return payload
            ...
            var savedXML = fs.readFileSync(testTempFilePaths[0], "utf-8");
            ...
            fs.writeFileSync(testTempFilePaths[1], origXML2, "utf-8");
            //test return payload
            ...
            //next check that the written XML file is as expected:
            var savedXML2 = fs.readFileSync(testTempFilePaths[1], "utf-8");
