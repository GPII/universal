...
(function () {
    ...
    fluid.defaults("fluid.test.XMLSettingsHandler", {
        gradeNames: ["fluid.test.testEnvironment", "autoInit"],
        components: {
            tester: {
                type: "fluid.test.XMLSettingsHandlerTester"
            }
        }
    });

    fluid.defaults("fluid.test.XMLSettingsHandlerTester", {
        ...
        modules: [{
            ...
            tests: [{
                expect: 4,
                name: "XMLHandler.set",
                func: "fluid.test.XMLHandlerSet"
            }, {
                expect: 2,
                name: "XMLHandler.get",
                func: "fluid.test.XMLHandlerGet"
            }, {
                expect: 2,
                name: "XMLHandler.parser.parse",
                func: "fluid.test.XMLHandlerParserParse"
            }, {
                expect: 2,
                name: "XMLHandler.parser.stringify",
                func: "fluid.test.XMLHandlerParserStringify"
            }, {
                expect: 1,
                name: "XMLHandler.FormatXml",
                func: "fluid.test.XMLHandlerFormatXml"
            }]
        }]
    });

    if (kettle.tests.allTests) {
        module.exports = "fluid.test.XMLSettingsHandler";
    } else {
        fluid.test.runTests(["fluid.test.XMLSettingsHandler"]);
    }
