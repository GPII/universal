...
(function () {
    ...
    XMLHandlerTester.test("Test that transformations work as expected", function() {
        ...
        jqUnit.assertDeepEq("Simple array paths correctly saved ", ["root"], output.pathArray);
        ...
        jqUnit.assertDeepEq("Deep array paths correctly saved ", ["root.deepObj.array-key"], output2.pathArray);
        ...
        jqUnit.assertDeepEq("Nested array paths correctly saved ", ["root.outer", "root.outer.outerSpecial.outerSpecialVar"], output3.pathArray);
    });
