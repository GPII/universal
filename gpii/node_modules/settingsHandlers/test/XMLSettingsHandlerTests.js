...
(function () {
    ...
    var arrayTest = function (json, description) {
        setTimeout(function () { 
            ...
            jqUnit.assertDeepEq(description+" array->hash transformation", json.expected, transformed);
            ...
            jqUnit.assertDeepEq(description+" hash->array transformation", json.raw, inverseTransformed);
            jqUnit.start();
        }, 50);
    };
        ...
        setTimeout(function() {
            ...
            var payload2 = {
                "setreq": [{
                    ...
                    options: {
                        "filename": __dirname+"/data/XMLSettingsHandler/tmp2.xml",
                        "encoding": "utf-8",
                        "xml-tag": "<?xml version=\"1.0\" encoding=\"utf-8\"?>",
                        "rules": {
            ...
            //read original XML and copy to a file we can mess up:
            var origXML2 = fs.readFileSync(__dirname+"/data/XMLSettingsHandler/test2.xml", "utf-8");
            fs.writeFileSync(__dirname+"/data/XMLSettingsHandler/tmp2.xml", origXML2, "utf-8");
            //test return payload
            ...
            //next check that the written XML file is as expected:
            var savedXML2 = fs.readFileSync(__dirname+"/data/XMLSettingsHandler/tmp2.xml", "utf-8");
            var expectedXML2 = fs.readFileSync(__dirname+"/data/XMLSettingsHandler/expected_output2.xml", "utf-8");
