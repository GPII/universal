...
(function () {
    ...
    XMLHandlerTester.test("Array transformations", function () {
        var json = {
            raw: {
                a: {
                    b: { b1: "vb1", b2: "vb2" },
        ...
        var transformed = fluid.model.transformWithRules(json.raw, json.transformRules);
        jqUnit.assertDeepEq("Simple single array->hash transformation", json.expected, transformed);
    });
