...
(function () {
    ...
    fluid.require("../index.js", require);
    ...
    XMLHandlerTester.test("XMLHandler.set", function () {
        var payload = {
            "com.texthelp.readwritegold": {
                ...
                options: {
                    "filename": __dirname+"/data/input1.xml",
                    "encoding": "utf-8",
        ...
        var origXML = fs.readFileSync(__dirname+"/data/data1.xml", "utf-8");
        fs.writeFileSync(__dirname+"/data/input1.xml", origXML, "utf-8");
        //test return payload
        ...
        var savedXML = fs.readFileSync(__dirname+"/data/input1.xml", "utf-8");
        var expectedXML = fs.readFileSync(__dirname+"/data/expected_output1.xml", "utf-8");
