...
(function () {
    ...
    XMLHandlerTester.test("Basic Array transformations", function () {
        arrayTest(basicArrayTest, "Basic Array");
    });

    XMLHandlerTester.test("More Complex Array transformations", function () {
        arrayTest(complexArrayTest, "Complex Array");
    });

    XMLHandlerTester.test("Nested Array transformations", function () {
        arrayTest(nestedArrayTest, "Nested Array");
    });

    XMLHandlerTester.test("Multiple Nested Array transformations", function () {
