...
(function () {
    ...
    fluid.test.JSONHandlerSet = function () {
        fluid.each(tests, function (v, k) {
            setTester(k, v);
        });
    };

    fluid.test.JSONHandlerGet = function () {
        fluid.each(tests, function (v, k) {
            getTester(k, v);
        });
    };

    fluid.defaults("fluid.test.JSONSettingsHandler", {
        gradeNames: ["fluid.test.testEnvironment", "autoInit"],
        components: {
            tester: {
                type: "fluid.test.JSONSettingsHandlerTester"
            }
        }
    });

    fluid.defaults("fluid.test.JSONSettingsHandlerTester", {
        ...
        modules: [{
            ...
            tests: [{
                ...
                func: "fluid.test.JSONHandlerSet"
            }, {
                expect: 2,
                name: "JSONHandler.get",
                func: "fluid.test.JSONHandlerGet"
            }]
        }]
    });

    if (kettle.tests.allTests) {
        module.exports = "fluid.test.JSONSettingsHandler";
    } else {
        fluid.test.runTests(["fluid.test.JSONSettingsHandler"]);
    }
