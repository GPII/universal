...
(function () {
        ...
        basicTest: {
            ...
            get: {
                payload: {
                    "net.opendirective.maavis": [{ 
                        options: {
                            "path": __dirname + "/data/JSONSettingsHandler/test1_default.json"
                        },
                        settings: {
                            "theme": null,
                            "userType": null,
        ...
        complexTest: {
            ...
            get: {
                payload: {
                    "org.gnome.orca": [{ 
                        options: {
                            "path": __dirname + "/data/JSONSettingsHandler/test2_default.json"
                        },
                        settings: {
    ...
    JSONHandlerTester.test("JSONHandler.get", function () {
        fluid.each(tests, function (v, k) {
            getTester(k, v);
        });
    });
