...
(function () {
    ...
    var tester = function (test) {
            ...
            jqUnit.assertDeepEq("Checking return payload for simple JSON file: ", test.expectedResult, returnPayload);
    ...
    JSONHandlerTester.asyncTest("JSONHandler.set", function () {
        setTimeout(function() {
            tester(tests.basicTest);
            tester(tests.complexTest);
            jqUnit.start();
        }, 10);
    });
}());