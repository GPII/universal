...
(function () {
    ...
    // TODO KASPER:
    // fix returnTrue og returnFalse til noget lidt lækrere
    ...
    gpii.tests.flexibleHandler.basicTestDefs = [
        {
            ...
            input: {
                ...
                options: {
                    "start": gpii.tests.flexibleHandler.failBlock,
                    "stop": gpii.tests.flexibleHandler.failBlock,
                    "isRunning": gpii.tests.flexibleHandler.reportRunning
                }
            },
            expectedSettings: {
                "running": {
            ...
            input: {
                ...
                options: {
                    "start": gpii.tests.flexibleHandler.failBlock,
                    "stop": gpii.tests.flexibleHandler.failBlock,
                    "isRunning": gpii.tests.flexibleHandler.reportNotRunning
                }
            },
            expectedSettings: {
                "running": {
            ...
            input: {
                ...
                options: {
                    "start": gpii.tests.flexibleHandler.assertBlock,
                    "stop": gpii.tests.flexibleHandler.failBlock,
                    "isRunning": gpii.tests.flexibleHandler.reportNotRunning
                }
            },
            ...
            input: {
                ...
                options: {
                    "start": gpii.tests.flexibleHandler.failBlock,
                    "stop": gpii.tests.flexibleHandler.assertBlock,
                    "isRunning": gpii.tests.flexibleHandler.reportRunning
                }
            },
            expectedSettings: {
