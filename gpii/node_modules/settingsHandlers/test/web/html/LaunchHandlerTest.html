...
<html>
    <head>
        ...
        <title>GPII Launch Handler Tests</title>
        ...
        <script src="../../../src/LaunchHandlers.js"></script>
        <script src="../../../src/settingsHandlerUtilities.js"></script>
        <script src="../../../../processReporter/src/ProcessReporter.js"></script>
        <script src="../js/LaunchHandlerTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Launch Handlers Tests</h1>
