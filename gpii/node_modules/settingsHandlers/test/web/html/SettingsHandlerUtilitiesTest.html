...
<html>
    <head>
        ...
        <title>GPII Settings Handler Utilities Tests</title>
        ...
        <script src="../../../src/js/settingsHandlerUtilities.js"></script>
        <script src="../js/SettingsHandlerUtilitiesTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Settings Handler Utilities Tests</h1>
