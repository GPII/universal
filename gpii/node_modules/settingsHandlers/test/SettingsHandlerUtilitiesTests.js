...
(function () {
    ...
    fluid.test.settingsHandlersSetSettings = function () {
    ...
    fluid.defaults("fluid.test.settingsHandlerUtilities", {
        gradeNames: ["fluid.test.testEnvironment", "autoInit"],
        components: {
            tester: {
                type: "fluid.test.settingsHandlerUtilitiesTester"
            }
        }
    });

    fluid.defaults("fluid.test.settingsHandlerUtilitiesTester", {
        ...
        modules: [{
            ...
            tests: [{
                ...
                func: "fluid.test.settingsHandlersSetSettings"
            }]
        }]
    });

    if (kettle.tests.allTests) {
        module.exports = "fluid.test.settingsHandlerUtilities";
    } else {
        fluid.test.runTests(["fluid.test.settingsHandlerUtilities"]);
    }
}());
