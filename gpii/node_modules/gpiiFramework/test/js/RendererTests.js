...
(function () {
        ...
        components: {
            ...
            rendererProduceTree: {
                ...
                options: {
                    ...
                    produceTree: "gpii.tests.rendererTests.produceTree"
                }
            },
    ...
    gpii.tests.rendererTests.produceTree = function () {
        return {
            "my-paragraph": {
                messagekey: "test"
            }
    ...
    fluid.defaults("fluid.tests.rendererTester", {
        ...
        modules: [{
            name: "Test renderer grade.",
            tests: [{
                expect: 1,
                name: "Test gpii.renderer.renderImpl",
                type: "test",
                ...
                expect: 1,
                name: "Test template rendering with produceTree.",
                type: "test",
                func: "fluid.tests.testRender",
                args: ["{rendererProduceTree}",
                    "{gpii.tests.rendererTests}.options.template",
                    "{gpii.tests.rendererTests}.options.expectedTemplate"
                ]
            }]
    ...
    fluid.tests.testRenderRender = function (tree, rendererOptions, template, expected) {
        jqUnit.assertEquals("Template is rendered correctly", expected,
            gpii.renderer.renderImpl(template, {
                tree: tree,
