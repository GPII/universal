...
(function () {
        ...
        components: {
            messageResolver: {
                ...
                options: {
                    ...
                    parents: ["{that}.options.parentBundle"]
                }
            },
            rendererOptions: {
    ...
    gpii.renderer.finalInit = function (that) {
        ...
        that.fossils = rendererOptions.fossils;
    ...
    fluid.defaults("gpii.renderer.impl", {
        ...
        expanderOptions: "{gpii.renderer}.options.expanderOptions"
    });
    ...
    gpii.renderer.impl.finalInit = function (that) {
        ...
        that.options.expanderOptions = fluid.renderer.modeliseOptions(
            that.options.expanderOptions, {ELstyle: "${}"}, that.renderer);
        fluid.renderer.reverseMerge(that.options.expanderOptions,
            rendererFnOptions, ["resolverGetConfig", "resolverSetConfig"]);
        if (!rendererFnOptions.noexpand) {
            that.expander = fluid.renderer.makeProtoExpander(
                that.options.expanderOptions);
        }
