...
(function () {
    ...
    fluid.defaults("gpii.middleware", {
        ...
        invokers: {
            ...
            apply: {
                funcName: "gpii.middleware.apply",
                args: ["{that}.resolveEventName", "{arguments}.0", "{arguments}.1", "{arguments}.2"]
            }
        },
        listeners: {
            onCreate: [{
                ...
                listener: "{gpii.server}.server.use",
                args: "{that}.apply"
            }]
        }
    });

    gpii.middleware.apply = function (resolveEventName, req, res, next) {
