...
(function () {
    ...
    fluid.defaults("gpii.dataSource.CouchDB", {
        ...
        components: {
            gradeContext: {
                ...
                options: {
                    targetTypeName: "gpii.dataSource.URL"
                }
            }
        },
    ...
    */
    ...
    gpii.dataSource.URL.handle.url = function (path, options, callback, model) {
        ...
        req.on("error", options.callbackWrapper.wrap(function (error) {
    ...
    gpii.dataSource.URL.handle.fs = function (fileName, options, callback, model) {
        var method = "readFile",
            args = [fileName, "utf8", options.callbackWrapper.wrap(function (error, data) {
                if (error) {
                    options.errback.events.onError.fire({
                        isError: true,
                        message: error.message
    ...
    */
    ...
    fluid.defaults("gpii.callbackWrappingPromiseData", {
        gradeNames: ["autoInit", "fluid.littleComponent"],
        components: {
            callbackWrapper: "{callbackWrapper}",
            rawSource: {
        ...
        finalInitFunction: "gpii.callbackWrappingPromiseData.finalInit"
    });

    gpii.callbackWrappingPromiseData.finalInit = function (that) {
