...
(function () {
    ...
    fluid.defaults("gpii.dataSource", {
        ...
        invokers: {
            ...
            wrapErrorHandler: "gpii.dataSource.wrapErrorHandler"
        },
    ...
    fluid.demands("gpii.dataSource.wrapErrorHandler", "gpii.dataSource.CouchDB", {
        funcName: "gpii.dataSource.wrapErrorHandler",
        args: ["{callbackWrapper}", "{requestProxy}", "{arguments}.0"]
    });

    fluid.demands("gpii.dataSource.wrapErrorHandler", "gpii.dataSource.URL", {
        funcName: "gpii.dataSource.wrapErrorHandler",
        args: ["{callbackWrapper}", "{requestProxy}", "{arguments}.0"]
    });
    ...
    gpii.dataSource.URL.all = function (dataSource, method) {
        var deferred = when.defer(),
            ...
            errback = dataSource.wrapErrorHandler(),
    ...
    gpii.dataSource.wrapErrorHandler = function (callbackWrapper, requestProxy, data) {
    ...
    fluid.defaults("gpii.requestContextDataSource", {
        gradeNames: ["autoInit", "fluid.littleComponent"],
        components: {
        ...
        finalInitFunction: "gpii.requestContextDataSource.finalInit"
    });

    gpii.requestContextDataSource.finalInit = function (that) {
