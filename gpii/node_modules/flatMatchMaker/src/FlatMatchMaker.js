...
(function () {
    ...
    gpii.flatMatchMaker.pathsToOntology = function (leaves, fromOntology, toOntology) {
    ...
    gpii.flatMatchMaker.match = function (ontologyHandler, payload, disposeStrategy) {
        ...
        return when(gpii.matchMaker.disposeSolutions2(payload, disposeStrategy), function (disposed) {
    ...
    gpii.flatMatchMaker.disposeStrategy = function (ontologyHandler, leaves, solrecs) {
        ...
        fluid.each(solrecs, function(solrec) {
            ...
            var accepted = fluid.find(leaves, function (leaf) {
                return fluid.get(skeleton, leaf, fluid.model.escapedGetConfig);
            });
