...
(function () {
    ...
    gpii.request.flowManager.userLogonStateChange.logoutUser = function (requestProxy, lifecycleManager, userToken) {
    ...
    fluid.defaults("gpii.request.flowManager.userLogonStateChange.matchMakingStateChangeHandler", {
        gradeNames: ["gpii.request.flowManager.userLogonStateChange.stateChangeHandler",
                     "gpii.request.flowManager.nonPrivacyFilteredMatchMakingRequest"],
        listeners: {
    ...
    fluid.defaults("kettle.requests.request.handler.userLogonStateChange", {
        gradeNames: ["fluid.littleComponent", "gpii.request.flowManager.userLogonStateChange.matchMakingStateChangeHandler"],
        invokers: {
            handle: {
