 ...
 * @param gpiiKey {String} the gpiiKey of the user who is logging in or out
...
/**
 * Does a logout of the user with the given GPII key. No response will be sent to the request (ie. no request events fired)
 ...
 * @param {gpiiKey} the user to logout
...
fluid.defaults("gpii.flowManager.userLogonHandling.stateChangeHandler", {
    ...
    invokers: {
        ...
        isBounce: {
            ...
            args: ["{flowManager}.lifecycleManager", "{that}.debounceTimeMs", "{arguments}.0"] // gpiiKey
        }
    },
    events: {
        onMatchDone: null
 ...
 * @param gpiiKey {String} The GPII key of the user for whom the proximityTrigger was fired
 ...
 * *                OR if the last login/logout process for <myGpiiKey> finished less than 5 seconds ago
