...
(function () {
    ...
    gpii.request.flowManager.userLogonStateChange.logoutComplete = function (that, requestEvent) {
    ...
    gpii.request.flowManager.userLogonStateChange.loginComplete = function (that, requestEvent) {
        requestEvent.fire(that.responseMsg);
        that.responseMsg = null;
    };
