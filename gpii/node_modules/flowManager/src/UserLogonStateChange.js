...
(function () {
    ...
    fluid.defaults("kettle.requests.request.handler.userLogonStateChange", {
        gradeNames: ["fluid.littleComponent", "gpii.request.flowManager.userLogonStateChange.stateChangeHandler", "gpii.request.flowManager.nonPrivacyFilteredMatchMakingRequest"],
        invokers: {
            handle: {
