...
(function () {
    ...
    gpii.flowManager.userLogonStateChange.startLifecycle = function (lifecycleManager, lifecyclePayload, event) {
        ...
        lifecycleManager.start(lifecyclePayload,
            gpii.flowManager.logAndNotify("Lifecycle manager returned: ", event, function () {
    ...
    gpii.flowManager.userLogonStateChange.getDeviceContext = function (deviceReporterDataSource, event, errorEvent) {
    ...
    fluid.defaults("gpii.flowManager.userLogonStateChange.stateChangeHandler", {
        gradeNames: "fluid.component", // TODO: Infusion bug - without fluid.component, we fail to merge listeners in matchMakingStateChangeHandler through lack of mergePolicy
        invokers: {
            startLifecycle: {
            ...
            getDeviceContext: {
                funcName: "gpii.flowManager.userLogonStateChange.getDeviceContext",
    ...
    fluid.defaults("gpii.flowManager.userLogin.handler", {
        gradeNames: ["kettle.request.http", "gpii.flowManager.userLogonStateChange.handlerBase"],
        invokers: {
            handle: {
