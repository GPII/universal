...
gpii.flowManager.userLogonHandling.handleResetGpiiKey = function (that, lifecycleManager) {
...
gpii.flowManager.userLogonHandling.errorResponse = function (that, message, statusCode) {
 ...
 */
gpii.flowManager.userLogonHandling.logoutUser = function (that, lifecycleManager, gpiiKey) {
...
fluid.defaults("gpii.flowManager.userLogonHandling.stateChangeHandler", {
    invokers: {
        ...
        startLifecycle: {
            ...
            args: [ "{that}", "{flowManager}.lifecycleManager", "{arguments}.0", "{that}.events.onSuccess" ]
        ...
        handleResetGpiiKey: {
            funcName: "gpii.flowManager.userLogonHandling.handleResetGpiiKey",
            args: ["{that}","{flowManager}.lifecycleManager"]
        },
        errorResponse: {
...
// The grade used to handle login request
