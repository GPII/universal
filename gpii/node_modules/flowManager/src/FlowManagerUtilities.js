...
(function () {
    ...
    gpii.request.flowManager.getPreferences = function (preferencesDataSource, event, token) {
        console.log("gpii.request.flowManager.getPreferences called - fetching preferences");
    ...
    gpii.request.flowManager.getDevice = function (deviceReporterDataSource, event) {
        console.log("gpii.request.flowManager.getDevice called - fetching device info");
    ...
    fluid.defaults("gpii.request.flowManager.token", {
        ...
        events: {
            ...
            onPreferences: null,
            onReadyToMatch: null,
            onMatch: "{matchMakerFramework}.events.onMatch",
