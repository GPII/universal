...
(function () {
    ...
    gpii.request.flowManager.privacy.reverseTransform = fluid.require("${universal}/testData/ontologies/privacy-flat.json");
    gpii.request.flowManager.privacy.forwardTransform = fluid.model.transform.invertConfiguration(gpii.request.flowManager.privacy.reverseTransform);

    // TODO We don't need to provide both forwardTransform and reverseTransform
    ...
    fluid.defaults("gpii.request.flowManager.privacyFilteredMatchMakingRequest", {
        ...
        components: {
            privacyFilter: {
                ...
                options: {
                    members: {
                        forwardTransform: gpii.request.flowManager.privacy.forwardTransform,
                        reverseTransform: gpii.request.flowManager.privacy.reverseTransform
                    }
                }
            }
        },
