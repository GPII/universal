...
(function () {
     ...
     *     userKeyaction.js - where it coordinates the standard lifecycle for a user logging on to a local FlowManager
    ...
    gpii.request.flowManager.sessionAware.withSession = function (that, lifecycleManager, events, callback, failMessage) {
        var userTokens = lifecycleManager.activeUserTokens;
