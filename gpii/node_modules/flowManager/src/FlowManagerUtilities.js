...
(function () {
    ...
    gpii.request.flowManager.runMatchMakerFramework = function (that, matchMakerFramework, preferences, device, solutionsRegistry, event) {
        matchMakerFramework.preProcess(that.token, preferences, device, solutionsRegistry, event);
    };
    ...
    fluid.defaults("gpii.request.flowManager.token", {
        ...
        invokers: {
            getPreferences: {
                ...
                args: ["{flowManager}.preferencesDataSource", "{that}.events.onPreferences", "{that}.token"]
            },
