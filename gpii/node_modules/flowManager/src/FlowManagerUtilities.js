...
(function () {
    ...
    gpii.flowManager.getPreferences = function (preferencesDataSource, request, event, userToken) {
        fluid.log("gpii.flowManager.getPreferences called - fetching preferences");
     ...
     */
    gpii.flowManager.getSolutions = function (solutionsRegistryDataSource, deviceContext, event) {
    ...
    gpii.flowManager.privacy.settingsToPrivacyTransformRules = fluid.model.transform.invertConfiguration(gpii.request.flowManager.privacy.privacyToSettingsTransformRules);
    ...
    fluid.defaults("gpii.flowManager.sessionAware", {
        ...
        invokers: {
            ...
            withSession: {
                ...
                args: ["{that}", "{flowManager}.lifecycleManager", "{request}.events", "{arguments}.0", "{arguments}.1"]
            }
        }
    });

    gpii.flowManager.sessionAware.withSession = function (that, lifecycleManager, events, callback, failMessage) {
