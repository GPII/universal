...
(function () {
    ...
    gpii.multiServerKettleConfig.build = function (servers) {
        ...
        // Build components for the servers

        var components = {};
        fluid.each(servers, function (server, serverName) {
            var serverConfig = fluid.copy(fluid.defaults(kettle.config.createDefaults({
                configName: server.configName,
                configPath: fluid.stringTemplate(server.configPath, baseDirs)
            })));
            delete serverConfig.gradeNames;
            var component = {
                type: "fluid.eventedComponent",
                options: serverConfig
            };
            components[serverName] = component;
        });
            ...
            components: {
                server: {
                    ...
                    options: {
                        ...
                        events: {
                            onListen: {
                                events: onListenEvents
                            },
                            onStopped: {
                                events: onStoppedEvents
                            }
                        },
                        invokers: {
                            stop: {
