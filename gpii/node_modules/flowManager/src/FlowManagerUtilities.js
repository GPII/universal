...
(function () {
    ...
    gpii.flowManager.getPreferences = function (preferencesDataSource, request, event, userToken) {
        ...
        console.log("Fetching preferences - options ", preferencesDataSource.options);
    ...
    gpii.flowManager.getDeviceContext = function (deviceReporterDataSource, event, errorEvent) {
        console.log("getDeviceContext for dataSource with options ", deviceReporterDataSource.options);
    ...
    gpii.flowManager.sessionAware.withSession = function (that, lifecycleManager, events, callback, failMessage) {
        ...
        console.log("GOT SESSION TOKENS ", userTokens);
