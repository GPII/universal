...
gpii.flowManager.cloudBased.matchToUntrustedSettings = function (finalPayload, event) {
    var wantedSections = ["userToken", "lifecycleInstructions", "activeContextName",
                          "activeConfiguration", "solutionsRegistryEntries",
                          "matchMakerOutput"];
    var settings = {};
    fluid.each(wantedSections, function (section) {
        settings[section] = finalPayload[section];
    });
    event.fire(settings);
};
