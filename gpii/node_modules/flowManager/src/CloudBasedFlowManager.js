...
fluid.defaults("kettle.requests.request.handler.oauth2Settings", {
    ...
    listeners: {
        processMatch: { // Contribute our filter into the middle of the chain
            ...
            namespace: "privacyFilter",
            funcName: "gpii.flowManager.cloudBased.privacy.filter",
            args: ["{arguments}.0", "{request}.selectedPreferencesMap"]
        }
    }
});
...
// Use browser-based like for the LifecycleManager
// May need to split off the functions under test into their own file

// TODO question: can matchMakerOutput have any children other than inferredConfiguration?

gpii.flowManager.cloudBased.privacy.filter = function (contextPayload, selectedPreferencesMap) {
