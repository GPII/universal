...
fluid.defaults("kettle.requests.request.handler.untrustedSettings", {
    ...
    invokers: {
        handle: {
            funcName: "gpii.flowManager.onUntrustedSettings",
            args: [
...
gpii.flowManager.onUntrustedSettings = function (onError, request, handler, userToken, deviceString, userService) {
    request.privacySettings = {};
    ...
    handler.events.onPrivacySettings.fire();
    gpii.flowManager.onSettings(onError, userToken, handler, deviceString);
};
