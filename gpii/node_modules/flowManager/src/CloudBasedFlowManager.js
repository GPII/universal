...
fluid.defaults("gpii.flowManager.cloudBased", {
    ...
    requestHandlers: {
        settings: {
            ...
            method: "get",
            handler: "gpii.flowManager.cloudBased.settings.handler"
        },
        userLogin: null,
        userLogout: null,
        getUserToken: null
...
fluid.defaults("gpii.flowManager.cloudBased.oauth2", {
    ...
    requestHandler: {
        oauth2Settings: {
            route: "/settings",
            method: "get",
            handler: "gpii.flowManager.cloudBased.oauth2settings.handler"
        },
        untrustedSettings: {
...
gpii.request.flowManager.onUntrustedSettings = function (onError, request, handler, userToken, deviceString, userService) {
    request.privacySettings = {};
    ...
    if (userService.gpiiTokenHasAssociatedUser(userToken)) {
        request.isAnonymousToken = false;
        var authorizedClients = userService.getAuthorizedClientsByGpiiToken(userToken);
