...
fluid.defaults("gpii.flowManager.cloudBased", {
    ...
    members: {
        revisionPath: "gpii-revision.json"
    },
    components: {
    ...
    requestHandlers: {
        ...
        // The endpoint to request the full SHA256 of the revision of the
        // repository used for this CPFM
        getFullSHA: {
            route: "/fullSHA",
            method: "get",
            type: "gpii.flowManager.cloudBased.fullSHA.handler"
        }
    }
});
