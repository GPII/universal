...
gpii.flowManager.onUntrustedSettings = function (onError, request, userToken, deviceString, userService) {
    request.privacySettings = {};
    ...
    gpii.flowManager.onSettings(onError, userToken, request, deviceString);
};
