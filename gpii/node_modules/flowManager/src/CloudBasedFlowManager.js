...
fluid.defaults("gpii.flowManager.cloudBased", {
    ...
    handlers: {
        ...
        getUserToken: null,
        fakeSettings: {
            route: "/:userToken/fakesettings/:device",
            type: "get"
        }
    }
});
...
gpii.flowManager.cloudBased.getFakeSettings = function (userToken, device, event) {
...
fluid.defaults("kettle.requests.request.handler.fakeSettings", {
    gradeNames: ["fluid.littleComponent", "autoInit"],
    invokers: {
        handle: {
            funcName: "gpii.flowManager.cloudBased.getFakeSettings",
            args: ["{request}.req.params.userToken", "{request}.req.params.device", "{requestProxy}.events.onSuccess"]
        }
    }
});
