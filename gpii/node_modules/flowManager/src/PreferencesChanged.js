(function () {
    ...
    gpii.requests.request.handler.onReadyToCacheHandler = function (token, preferences, device, lifecycleManager) {
        lifecycleManager.options.cache = {"token": token, "preferences": preferences, "device": device};
    };
