 ...
 *                            solutions registry
 * @param {String} platformId - the platform id for the solutions fetched, e.g.,
 *                              "win32".
 ...
 *      property.
 */
gpii.flowManager.repositorySolutionsLoader.getSolutions = function (that, gpiiRevision, fileName, platformId) {
    fluid.log("TRACE: RepositorySolutionsLoader loads solutions registry from github ... START");
    ...
    if (gpiiRevision && fileName) {
        ...
        solutionsPromise.then(function (solutions) {
            fluid.log("TRACE: RepositorySolutionsLoader loads solutions registry from github ... END");
            var taggedRegistry = {};
            ...
            fluid.log("TRACE: RepositorySolutionsLoader failed to download solutions registry from github ... END");
