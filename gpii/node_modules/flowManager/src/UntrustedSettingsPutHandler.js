...
gpii.flowManager.cloudBased.untrustedSettings.put.handleRequest = function (preferencesServer, request, gpiiKey, preferences, authGrantFinder) {
    ...
    authorizationPromise.then(function (authorization) {
        if (authorization && authorization.gpiiKey === gpiiKey && authorization.allowUntrustedSettingsPut) {
            ...
            var updatePromise = preferencesServer.updatePreferences(gpiiKey, preferences);
            ...
            //     fluid.log("The preferences set for the key (", gpiiKey, ") is being updated to: ", targetPreferences);
            //     updatePromise.then(function (response) {
            //         // The default success response from the preference server contains the updated preferences,
            //         request.events.onSuccess.fire({
            //             gpiiKey: response.gpiiKey,
