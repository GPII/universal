...
fluid.defaults("gpii.defaultSettingsLoader", {
    ...
    // The url to the remote default settings file
    defaultSettingsUrl: "https://raw.githubusercontent.com/GPII/universal/master/testData/defaultSettings/defaultSettings.json5",
    members: {
    ...
    listeners: {
        ...
        // 1. The first attempt is to fetch from the remote url;
        ...
        "onGet.getRemoteDefaultSettings": {
            ...
            args: ["{that}.remoteDefaultSettingsDataSource"]
        },
 ...
 * return undefined.
 */
gpii.defaultSettingsLoader.getRemoteDefaultSettings = function (remoteDefaultSettingsDataSource) {
