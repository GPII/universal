...
fluid.defaults("gpii.defaultSettingsLoader", {
    ...
    listeners: {
        "onCreate.prepareSettingsFile": {
            ...
            // listener: "gpii.defaultSettingsLoader.prepareSettingsFile",
            // args: ["{that}.options.defaultSettingsInCodeBase", "{that}.gpiiSettingsDir"]
        }
    },
    invokers: {
        get: {
...
gpii.defaultSettingsLoader.get = function (defaultSettingsFile) {
    return JSON5.parse(fs.readFileSync(fluid.module.resolvePath(defaultSettingsFile), "utf-8"));
};
