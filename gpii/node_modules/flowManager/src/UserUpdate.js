...
gpii.flowManager.userUpdate.handleUpdate = function (that, data, transformer, lifecycleManager) {
    ...
    that.withSession(function (session) {
        ...
        lifecycleManager.update(finalPayload, function (response) {
            ...
            if (response.success) {
                // Update the session.
                // TODO: This presumably should be an "ADD" and clear the existing activeConfiguration
                // But given we have no tests, who cares, right?
                session.applier.change("activeConfiguration", updatedConfig);
            }
