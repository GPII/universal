...
(function () {
    ...
    request.userUpdateHandle = function (matchMakerDataSource, event, preferences, session) {
        var updatedPreferences = request.getUpdatedPreferences(preferences,
            session.preferences);
        request.getMatch(matchMakerDataSource, event,
            updatedPreferences, session.device);
    };
