...
fluid.defaults("gpii.flowManager.solutionsRegistry.dataSource.local", {
    ...
    listeners: {
        ...
        "loadSolutions.loadFromRepository": {
            listener: "gpii.flowManager.solutionsRegistry.dataSource.loadFromRepository",
 ...
 *      property.
 */
gpii.flowManager.solutionsRegistry.dataSource.loadFromRepository = function (that, revision, platformId) {
