...
gpii.flowManager.cloudBased.settings.put.handleRequest = function (preferencesDataSource, request, gpiiKey, preferences, authGrantFinder) {
    ...
    authorizationPromise.then(function (authorization) {
        if (authorization && authorization.gpiiKey === gpiiKey && authorization.allowSettingsPut) {
            ...
            fluid.log("The preference set to be merged for the GPII key (", gpiiKey, ") is: ", preferences);
