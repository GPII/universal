...
fluid.defaults("gpii.flowManager.capture", {
    ...
    invokers: {
        ...
        captureSystemSettings: {
            ...
            args: ["{lifecycleManager}", "{arguments}.0", "{arguments}.1"] // solutionsRegistryEntries, options
        }
    }
});
 ...
 *
 * @param {gpii.lifecycleManager} lifecycleManager - Instance of the local machine lifecycle manager.
 ...
 */
gpii.flowManager.captureSystemSettings = function (lifecycleManager, solutions, options) {
    ...
    return lifecycleManager.processRead(solutionsToFetch);
};
