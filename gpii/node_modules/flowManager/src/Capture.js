...
fluid.defaults("gpii.flowManager.capture", {
    ...
    listeners: {
        ...
        "onCaptureSettingsForCurrentDevice.captureSystemSettings": {
            ...
            args: ["{lifecycleManager}.read", "{lifecycleManager}", "{arguments}.0", "{arguments}.1"], // solutionsRegistryEntries, options
 ...
 */
gpii.flowManager.capture.captureSystemSettings = function (readSettingsFunc, lifecycleManager, solutions, options) {
    ...
    var expandedSolutions = lifecycleManager.getSession().localResolver(solutionsToFetch);
