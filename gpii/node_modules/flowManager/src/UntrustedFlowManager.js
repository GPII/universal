...
fluid.defaults("gpii.flowManager.untrusted", {
    logonStateChangeHandler: "gpii.flowManager.untrusted.stateChangeHandler",
    components: {
        settingsDataSource: {
...
// This grade communicate with GPII Cloud to read settings and write preferences.
// It's distributed to "gpii.lifecycleManager.loginRequest" to support user login process in untrusted settings.
