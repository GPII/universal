...
fluid.defaults("gpii.flowManager.untrusted", {
    ...
    requestHandlers: {
        ...
        untrustedUserLogin: {
            ...
            method: "get",
            handler: "gpii.flowManager.untrusted.userLogin.handler"
        },
        untrustedUserLogonStateChange: {
            route: "/user/:userToken/logonChange",
            method: "get",
            handler: "gpii.flowManager.untrusted.userLogonStateChange.handler"
        }
    }
});

gpii.flowManager.untrusted.getSettings = function (settingsDataSource, userToken, deviceReporterData, event) {
    settingsDataSource.get({
        userToken: userToken,
        device: JSON.stringify(deviceReporterData)
    }, gpii.flowManager.logAndNotify("Fetched settings: ", event));
};
