...
gpii.flowManager.untrusted.settingsDataSource.findValidAccessToken = function (that, userToken) {
    var accessToken = fluid.get(that, ["accessTokens", userToken, "accessToken"]);
    var expiresIn = gpii.oauth2.getExpiresIn(new Date(), fluid.get(that, ["accessTokens", userToken, "timestampExpires"]));
...
gpii.flowManager.untrusted.settingsDataSource.save = function (that, userToken, accessToken, timestampExpires) {
    fluid.set(that, ["accessTokens", userToken, "accessToken"], accessToken);
    fluid.set(that, ["accessTokens", userToken, "timestampExpires"], timestampExpires);
};
