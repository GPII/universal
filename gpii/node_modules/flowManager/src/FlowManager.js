...
gpii.flowManager.local.computeSolutionRegistryUrl = function (that) {
    ...
    revisionPromise.then(function (revision) {
        if (!revision.isError) {
            ...
            that.repositorySolutionsLoader.gpiiRevision = revision.sha256;
            that.repositorySolutionsLoader.fileName = platform.id + ".json5";
            debugger;
            return that.repositorySolutionsLoader.getSolutions();
        }
    });
