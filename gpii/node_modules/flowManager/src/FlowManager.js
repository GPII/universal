...
fluid.defaults("gpii.flowManager.local", {
    ...
    // In all-in-local config, the handler is "gpii.flowManager.userLogonHandling.matchMakingStateChangeHandler".
    // In untrusted config, the handler should be "gpii.flowManager.untrusted.stateChangeHandler".
    logonStateChangeHandler: "gpii.flowManager.userLogonHandling.matchMakingStateChangeHandler",
    components: {
        lifecycleManager: {
            type: "gpii.lifecycleManager",
            options: {
                logonStateChangeHandler: "{gpii.flowManager}.options.logonStateChangeHandler",
                components: {
    ...
    listeners: {
        ...
        "onCreate.loginWithNoUser": {
            listener: "{lifecycleManager}.addToUserLogonRequestQueue",
            args: [{
                gpiiKey: "noUser",
                logonState: "login"
            }]
