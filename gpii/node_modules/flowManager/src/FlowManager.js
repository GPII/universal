...
fluid.defaults("gpii.flowManager.local", {
    ...
    requestHandlers: {
        ...
        userLogonHandling: {
            ...
            method: "get",
            type: "gpii.flowManager.userLogonHandling.handler",
            gradeNames: "gpii.flowManager.userLogonHandling.matchMakingStateChangeHandler"
        },
        getUserToken: {
            route: "/userToken",
    ...
    events: {
        // informative lifecycle events related to login/logout
    ...
    listeners: {
        ...
        "userLoginInitiated.notify": "{lifecycleManager}.logonChangeStarted",
        "userLogoutInitiated.notify": "{lifecycleManager}.logonChangeStarted",
        "userLoginComplete.notify": "{lifecycleManager}.logonChangeComplete",
        "userLogoutComplete.notify": "{lifecycleManager}.logonChangeComplete"
    }
});
