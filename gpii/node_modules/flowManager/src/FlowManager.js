(function () {
    ...
    gpii.flowManager.preInit = function (that) {
        ...
        that.server.configure("demo_local", function () {
            // Set development options.
            fluid.staticEnvironment.production = fluid.typeTag("gpii.demo_local");
            that.config = JSON.parse(fs.readFileSync(path.join(__dirname, "../config.demo_local.json")));
            fluid.setLogging(true);
        });
        that.server.configure("demo", function () {
            // Set demo options.
            fluid.staticEnvironment.production = fluid.typeTag("gpii.demo");
            that.config = JSON.parse(fs.readFileSync(path.join(__dirname, "../config.demo.json")));
            fluid.setLogging(true);
        });
