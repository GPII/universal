...
gpii.flowManager.convertDefaultSettingsToSnapshot = function (that, defaultSettings, defaultSnapshotCreatedEvent) {
    if (defaultSettings) {
        ...
        matchMakingPromise.then(function (payload) {
            ...
            that.options.defaultSnapshot = gpii.transformer.configurationToSettings(payload.matchMakerOutput.inferredConfiguration[activeContextName], payload.solutionsRegistryEntries);
