...
fluid.defaults("gpii.flowManager.local", {
    ...
    requestHandlers: {
        userLogin: {
            ...
            gradeNames: "gpii.flowManager.userLogonStateChange.matchMakingStateChangeHandler"
        },
        userLogout: {
...
fluid.defaults("gpii.flowManager.ws", {
    requestHandlers: {
        ...
        pcpChannel: {
            route: "/pcpChannel",
            type: "gpii.flowManager.pcpChannel.handler"
        }
    },
    components: {
        ...
        pcpInterface: {
            type: "gpii.flowManager.pcpChannel"
        }
    },
    listeners: {
        onCreate: [{
        ...
        {
            funcName: "gpii.flowManager.mountPCPInterface",
            args: ["{pcpInterface}"]
        }]
    }
});
...
gpii.flowManager.mountPCPInterface = function (pcpInterface) {
    gpii.flowManager.pcpInterface = pcpInterface;
    console.log("##### on mountPCPInterface");
};
