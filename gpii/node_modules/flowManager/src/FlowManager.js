...
fluid.defaults("gpii.flowManager.local", {
    ...
    components: {
        ...
        pspChannel: {
            ...
            options: {
                members: {
                    // This member value is calculated here rather than in the pspChannel component itself is to ensure
                    // the arguments used in this function, which are dependent on {flowManager} and {ontologyHandler},
                    // are ready before the calculation.
                    defaultSettingControls: {
                        expander: {
                            funcName: "gpii.flowManager.local.generateDefaultSettingControls",
...
/**
 * Calculate the schemas containing preferences with their the default values from the reset to default file.
 ...
 * and the default preference values defined in the reset to default file are populated into the "default" field of
 * the returned schema.
 */
gpii.flowManager.local.generateDefaultSettingControls = function (defaultSettings, schemas) {
