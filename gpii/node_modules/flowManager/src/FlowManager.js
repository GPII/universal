...
fluid.defaults("gpii.flowManager.local", {
    ...
    events: {
        ...
        noUserLoggedIn: null,
        loadedSolutionsFromRepository: null,
        getDefaultSettingsData: null,
        defaultSettingsDataLoaded: null,
        flowManagerReady: {
            events: {
                "loadedSolutionsFromRepository": "loadedSolutionsFromRepository",
    ...
    listeners: {
        ...
        "onCreate.loadSolutionsFromRepository": {
            funcName: "gpii.flowManager.local.loadSolutionsFromRepository",
            args: ["{that}", "{that}.events.loadedSolutionsFromRepository"]
        },
 ...
 * @param {Event} loadedFromRepositoryEvent - Event to fire when done loading,
 *      even on failure.
 ...
 */
gpii.flowManager.local.loadSolutionsFromRepository = function (that, loadedFromRepositoryEvent) {
    ...
    revisionPromise.then(function (revision) {
        ...
        if (!revision.isError) {
            ...
            var loadingPromise = that.repositorySolutionsLoader.getSolutions(gpiiRevision, fileName, platform.id);
            loadingPromise.then(function () {
                ...
                loadedFromRepositoryEvent.fire();
            });
        } else {
            loadedFromRepositoryEvent.fire();
        }
