...
fluid.defaults("gpii.flowManager.local", {
    gradeNames: ["{that}.httpEndpointsGradeFinder"],
    ...
    distributeOptions: {
        ...
        */
        ...
        "userListeners.lifecycleManager": {
            record: {
                lifecycleManager: "{gpii.flowManager.local}.lifecycleManager"
            },
            target: "{that userListeners}.options.components"
        },
    ...
    invokers: {
        ...
        httpEndpointsGradeFinder: {
            funcName: "gpii.flowManager.local.httpEndpointsGradeFinder",
            args: ["{that}.options.suppressHttpEndpoints"]
        }
    },
    events: {
...
/**
 * When the flag "suppressHttpEndpoints" is turned on, remove unneeded http endpoints from the local flow manager.
 * When this flag is turned off, add these endpoints.
 * @param {Boolean} suppressHttpEndpoints - The flag to indicate whether to remove unneeded http endpoints from LFM.
 * @return {String} If the flag is true, return undefined. Otherwise, return the gradename that attach extra endpoints.
 */
gpii.flowManager.local.httpEndpointsGradeFinder = function (suppressHttpEndpoints) {
    return suppressHttpEndpoints ? undefined : "gpii.flowManager.local.requestHandlers";
};
