 ...
 * @param {Component} that - An instance of gpii.flowManager.local.
 */
gpii.flowManager.local.computeSolutionRegistryUrl = function (localFlowManger) {
    // Make the request for the version
    ;
    // then construct and save the full url to the git repo
    ;
    // on failure, set the full url to null.
    ;
}
