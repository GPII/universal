...
gpii.flowManager.cloudBased.gpiiRevision.handler.handleRequest = function (flowmanager, that) {
    var result = {};
    var errMsg = null;
    var fullPath = fluid.module.resolvePath(flowmanager.options.gpiiRevisionPath);
    try {
