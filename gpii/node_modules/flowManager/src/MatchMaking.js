...
(function () {
    ...
    gpii.flowManager.getPreferences = function (that, prefsServerDataSource) {
        ...
        if (gpiiKey !== gpii.defaultGpiiKey) {
        ...
        var defaultGpiiKeyPrefs = {};
        var promise = gpiiKey === gpii.defaultGpiiKey ? fluid.promise().resolve(defaultGpiiKeyPrefs) : prefsServerDataSource.get(gpiiKey);
