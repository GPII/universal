...
(function () {
    ...
    gpii.flowManager.getPreferences = function (that, preferencesDataSource) {
        ...
        var noUserPrefs = {
            "contexts": {
                "gpii-default": {
                    "name": "Default preferences for noUser",
                    "preferences": {}
                }
            }
        };
        var promise = gpiiKey === "noUser" ? fluid.promise().resolve(noUserPrefs) : preferencesDataSource.get({gpiiKey: gpiiKey});
    ...
    fluid.defaults("gpii.flowManager.matchMaking", {
        invokers: {
            getPreferences: {
                ...
                args: ["{that}", "{flowManager}.preferencesDataSource"]
            },
            processMatch: {
