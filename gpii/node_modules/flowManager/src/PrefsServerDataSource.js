...
fluid.defaults("gpii.flowManager.prefsServerDataSource", {
    ...
    invokers: {
        ...
        // Update preferences
        set: {
            funcName: "gpii.flowManager.prefsServerDataSource.set",
 ...
 */
gpii.flowManager.prefsServerDataSource.set = function (that, gpiiKey, merge, preferences) {
    merge = merge || true;
...
gpii.flowManager.prefsServerDataSource.isLive = function (prefsServerHealthImpl) {
    ...
    isLivePromise.then(function () { // onResolve
        promiseTogo.resolve({isLive: true});
    }, function (value) {            // onReject
        promiseTogo.resolve({isLive: false, reason: value.message});
    });
