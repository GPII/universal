...
fluid.defaults("gpii.pspChannel", {
    ...
    members: {
        outputBlocked: null
        //defaultSettingControls: null  // "defaultSettingControls" holds the schemas containing the default values
                                        // default file. Its value is calculated in the gpii.flowManager.local. from
                                        // the reset to
    },
    listeners: {
...
gpii.pspChannel.sessionToPSP = function (model, transformSpec) {
    ...
    // GPII-3828: Return default values defined in the reset to default file rather than ones frpm the ontologyMetadata
