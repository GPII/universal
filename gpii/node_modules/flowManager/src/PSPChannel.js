...
fluid.defaults("gpii.pspChannel", {
    ...
    modelRelay: {
        pspChannel: {
            source: "{that}.model.settingControls",
            target: "{that}.model.settingControls",
            singleTransform: {
...
gpii.pspChannel.respondDefaultSettings = function (currentSettingControls, transformSpec) {
    var defaultSettings = transformSpec.defaultSettings;
    if (!$.isEmptyObject(currentSettingControls) || !defaultSettings) {
        return currentSettingControls;
    } else {
        var schemas = transformSpec.ontologyMetadata.flat.schemas;
