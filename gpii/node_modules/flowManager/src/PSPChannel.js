...
fluid.defaults("gpii.pspChannel", {
    ...
    // GPII-3828: report default settings to psp clients when model.settingControls is empty.
    // This model relay will be replaced with GPII-3318 (https://issues.gpii.net/browse/GPII-3318) implementation.
    modelRelay: {
        pspChannel: {
