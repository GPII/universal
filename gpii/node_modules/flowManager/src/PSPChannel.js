 ...
 *      "<preference URI N>": { .. }
 * },
 * "preferences": {                       // Used for listing available contexts and name of preferences set
 ...
 *
 * @param message {Object} the message recieved via the PSP socket. WARNING - note that the `path` value of
