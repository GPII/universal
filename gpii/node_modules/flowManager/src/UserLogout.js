...
(function () {
    ...
    gpii.request.flowManager.onUserLogout = function (requestProxy, token, lifecycleManager) {
        // TODO: clarify semantics of multiple active start/stop cycles.
        lifecycleManager.stop({
            userToken: token
        }, gpii.request.flowManager.logAndNotify("Lifecycle manager returned: ", requestProxy.events.onSuccess,
            function () {
                return "User with token " + token + " was successfully logged out.";
            }
        ));
    };
