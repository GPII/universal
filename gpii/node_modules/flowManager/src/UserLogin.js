...
(function () {
    ...
    fluid.defaults("kettle.gradeLinkageRecord.userLoginHandlerSession", {
        ...
        resultGrades: ["gpii.flowManager.userLoginSession"]
    });

    fluid.defaults("gpii.flowManager.userLoginSession", {
        gradeNames: ["fluid.littleComponent", "autoInit"],
        invokers: {
            handleSession: {
                funcName: "gpii.request.flowManager.handleSession",
                args: ["{request}.session.session", "{that}.userToken",
        ...
        listeners: {
            onReadyToMatch: {
                listener: "{that}.handleSession"
            }
        }
    });

    request.handleSession = function (session, token, preferences, device) {
        // Save token, preferences and device data into session.
        session.token = token;
