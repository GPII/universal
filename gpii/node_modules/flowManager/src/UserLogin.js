...
(function () {
    ...
    gpii.requests.request.handler.userLoginPreInit = function (that) {
        ...
        that.onMatchHandler = function (match) {
            that.lifecycleManager.start({userToken: that.userToken}, match, wrap(function (response) {
                fluid.log("Lifecycle manager returned: ", response);
                that.requests.events.onSuccess.fire("User was successfully logged in.");
            }));
        };
    };
