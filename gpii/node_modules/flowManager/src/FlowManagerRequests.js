...
(function () {
    ...
    gpii.flowManager.transformLifecycle = function (transformer, contextPayload) {
        ...
        gpii.logFully("Transformer got lifecycleInstructions " + JSON.stringify(lifecycleInstructions, null, 2) + " from contextPayload ", gpii.renderMegapayload(contextPayload));
