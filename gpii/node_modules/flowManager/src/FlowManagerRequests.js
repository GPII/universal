...
(function () {
    ...
    gpii.flowManager.privacy.privacyToSettingsTransformRules = JSON5.parse(fs.readFileSync(fluid.module.resolvePath("%gpii-universal/testData/ontologies/mappings/privacy-flat.json5", "utf8")));
