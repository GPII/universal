...
(function () {
    ...
    gpii.flowManager.getPreferences = function (preferencesServer, request, event, gpiiKey) {
        fluid.log("gpii.flowManager.getPreferences called - fetching preferences from Preferences Server for the GPII key " + gpiiKey);
        var promise = preferencesServer.getPreferences(gpiiKey);
     ...
     * @event (Object) - Event to be fired when an error occurs
     *
    ...
    fluid.defaults("gpii.flowManager.matchMakingRequest", {
        invokers: {
            getPreferences: {
                ...
                args: ["{flowManager}.preferencesServer", "{request}", "{that}.events.onPreferences", "{that}.gpiiKey"]
            },
            processMatch: {
