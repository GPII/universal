...
(function () {
    ...
    gpii.flowManager.getPreferences = function (flowManager, preferencesDataSource, request, event, userToken) {
    ...
    fluid.defaults("gpii.flowManager.matchMakingRequest", {
        invokers: {
            getPreferences: {
                ...
                args: ["{flowManager}", "{flowManager}.preferencesDataSource", "{request}", "{that}.events.onPreferences", "{that}.userToken"]
            },
            processMatch: {
