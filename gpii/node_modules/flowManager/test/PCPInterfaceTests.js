...
gpii.tests.flowManager.PCPInterface.onLogin = function (data, userToken, settings) {
...
var testDef = {
    ...
    sequence: [
        {
            func: "{client}.send",
            args: "{client}.options.solutionId"
        }, {
            event: "{client}.events.onComplete",
            listener: "gpii.tests.flowManager.PCPInterface.checkConnectionRequest",
            args: [ "{arguments}.0", "{client}" ]
        }, {
            // Test regular login notification with no settings passed
            func: "{flowManager}.pcpInterface.notifyLogin",
            args: [ "someUser" ]
        }, {
            event: "{client}.events.onLogin",
            listener: "gpii.tests.flowManager.PCPInterface.onLogin",
            args: [ "{arguments}.0", "someUser", { "http://registry.gpii.net/common/highContrastEnabled": false } ]
        }, {
            // Test regular login notification with a set of settings passed
            func: "{flowManager}.pcpInterface.notifyLogin",
            args: [ "someOtherUser",  { "http://registry.gpii.net/common/screenResolution": "low" } ]
        }, {
            event: "{client}.events.onLogin",
            listener: "gpii.tests.flowManager.PCPInterface.onLogin",
            args: [ "{arguments}.0", "someOtherUser", { "http://registry.gpii.net/common/screenResolution": "low" } ]
        }, {
            // Test logout notification gets passed to socket client
            func: "{flowManager}.pcpInterface.notifyLogout"
        }, {
            event: "{client}.events.onLogout",
            listener: "gpii.tests.flowManager.PCPInterface.onLogout"
        }, {
            // Test regular messages gets passed to socket client
...
module.exports = kettle.test.bootstrapServer([testDef]);
