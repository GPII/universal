...
gpii.tests.pcpChannel.checkPayload = function (data, expected) {
    console.log("\n\n\n\n\n\ndata", JSON.stringify(data, null, 2), "n");
    console.log("\nexpected", JSON.stringify(expected, null, 2), "\n\n\n\n\n\n");
    jqUnit.assertDeepEq("Check PCP channel response is as expected", gpii.tests.pcpChannel.payloads[expected], data);
};
...
// gpii.tests.pcpChannel.sendPreferenceChange = function (client, path, value) {
...
// };
//
// gpii.tests.pcpChannel.preferenceTestDef = {
//     name: "PCP Channel - Test triggering preference changes and receiving updates",
//     expect: 4,
//     // As per ContextIntegrationTests.js
//     gradeNames: [
//         "gpii.test.integration.testCaseHolder.linux"
...
//     //     args: ["{pcpClient}", "bright"]
//     }, {
//         funcName: "gpii.tests.pcpChannel.sendPreferenceChange",
//         args: ["{pcpClient}", [ "preferences","http://registry\\.gpii\\.net/common/DPIScale"], 3]
//     }, {
//         event: "{pcpClient}.events.onReceiveMessage",
//         listener: "gpii.tests.pcpChannel.checkPayload",
//         args: ["{arguments}.0", "snapset_1a_modified"] //, "{flowManager}", "{lifecycleManager}", "context1_bright"]
//     }]
// };
