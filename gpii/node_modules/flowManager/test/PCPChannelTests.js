    ...
    "snapset_2c_loggedIn": {
        ...
        "value": {
            ...
            "settingControls": {
                ...
                "http://registry\\.gpii\\.net/applications/com\\.microsoft\\.windows\\.highContrast.http://registry\\.gpii\\.net/common/highContrast/enabled": {
                    "value": true,
                    "schema": {
                        "title": "High Contrast",
                ...
                "http://registry\\.gpii\\.net/applications/net\\.gpii\\.uioPlus.http://registry\\.gpii\\.net/common/highContrast/enabled": {
                    "value": true,
                    "schema": {
                        "title": "High Contrast",
                        "description": "Whether to enable/disable High Contrast",
...
fluid.defaults("gpii.tests.pcpChannel.gpiiKeyRequest", {
...
fluid.defaults("gpii.tests.pcpChannel.loginRequest", {
    gradeNames: "gpii.tests.pcpChannel.gpiiKeyRequest",
