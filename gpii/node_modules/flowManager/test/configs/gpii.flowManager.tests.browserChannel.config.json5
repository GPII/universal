{
    ...
    "options": {
        ...
        "distributeOptions": {
            ...
            "browserChannel.tests.repositorySolutionsLoader": {
                "record": {
                    "funcName": "gpii.tests.flowManager.browserChannel.getRepositorySolutions"
                },
                "target": "{that flowManager solutionsRegistryDataSource repositorySolutionsLoader}.options.invokers.getSolutions"
            }
        }
    },
