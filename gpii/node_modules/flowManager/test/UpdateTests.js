...
gpii.tests.flowManager.update.tokenPrefs = $.extend(true, {}, gpii.tests.flowManager.update.tokenDefaultPrefs.flat, {
    "contexts": {
        "gpii-default": {
            "preferences": {
                "http://registry.gpii.org/common/fontSize": 14
            }
        }
    }
});
...
gpii.tests.flowManager.update.tokenPrefsUpdated = $.extend(true, {}, gpii.tests.flowManager.update.tokenDefaultPrefs.flat, {
    "contexts": {
        "gpii-default": {
            "preferences": {
                "http://registry.gpii.org/common/fontSize": 16
            }
        }
    }
});
...
gpii.tests.flowManager.update.clearActiveSessions = function (activeSessions, tests, lfm) {
...
var testDefs = [{
    ...
    sequence: [{
        ...
        // args: [ "{tests}.configuration.server.lifecycleManager", "{tests}", "{tests}.configuration.server.flowManager.lifecycleManager" ]
        // args: "{tests}.configuration.server.lifecycleManager.activeSessions"
    }, {
        func: "{updateRequest}.send",
        args: gpii.tests.flowManager.update.payload1 //gpii.tests.flowManager.update.tokenPrefs
    }, {
