...
gpii.tests.flowManager.browserChannel.checkSettingsForChrome = function () {
    jqUnit.assertDeepEq("The settings for 'org.chrome.cloud4chrome' are the expected",
        gpii.tests.flowManager.browserChannel.payloads.expectedChromeSettings,
...
gpii.tests.flowManager.browserChannel.checkSettingsForFirefox = function () {
    jqUnit.assertEquals("The settings for 'org.mozilla.cloud4firefox' are the expected",
        JSON.stringify(gpii.tests.flowManager.browserChannel.payloads.expectedFirefoxSettings),
...
gpii.tests.flowManager.browserChannel.connectionSucceeded = function (data, solutionId) {
    jqUnit.assertDeepEq("Right after connecting, the initial settings for " + solutionId  + " are as expected",
        gpii.settingsHandlers.webSockets.getSettingsForId(solutionId),
        data
    );
};
...
fluid.defaults("gpii.tests.flowManager.browserChannel.clientHolder", {
    gradeNames: "kettle.test.request.io", // TODO
    path: "/browserChannel",
...
gpii.tests.flowManager.browserChannel.testDefs = [{
    ...
    config: {
        ...
        configPath: "%universal/gpii/node_modules/flowManager/test/configs"
    },
    components: {
        clientOne: {
