...
kettle.tests.replaceDataSource = function (flowManager) {
    if (kettle.tests.realDataSource) {
        fluid.pushSoftFailure(-1);
        flowManager.preferencesDataSource = kettle.tests.realDataSource;
    } else {
        fluid.pushSoftFailure(testCondition);
        kettle.tests.realDataSource = flowManager.preferencesDataSource;
...
var testDefs = [{
    ...
    sequence: [{
        ...
        func: "kettle.tests.replaceDataSource",
        args: "{tests}.configuration.server.flowManager"
    }, {
