...
var cleanUpTmpFiles = function () {
    var files = fs.readdirSync(kettle.tests.prefsDir);
    fluid.each(files, function (filePath) {
        filePath = path.resolve(kettle.tests.prefsDir, filePath);
        var stats = fs.statSync(filePath);
        var interval = getSeconds(stats.ctime) - getSeconds(statTime);
