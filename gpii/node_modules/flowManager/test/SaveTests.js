...
gpii.tests.userSave.cleanUpTmpFiles = function () {
    fluid.each(gpii.tests.filesToDelete, function (filePath) {
...
gpii.tests.userSave.testSaveResponse = function (dataText) {
    ...
    jqUnit.assertDeepEq("Saved preferences are correct", gpii.tests.userSave.testToken1Set, savedPrefs);
};
...
var testDefs = [{
    ...
    components: {
        saveRequest: { // TODO: this test is faulty - a PUT should be supplied for an existing token
