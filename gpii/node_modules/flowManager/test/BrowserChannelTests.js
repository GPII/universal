...
gpii.tests.flowManager.browserChannel.testDisconnection = function (data) {
    jqUnit.assertTrue("Disconnected", true);
};
...
gpii.tests.flowManager.browserChannel.checkFirstClient = function () {
    jqUnit.assertEquals("'org.chrome.cloud4chrome' is registered as a client",
        ...
        Object.keys(gpii.settingsHandlers.WebSockets.model.clients)
    );
};
...
gpii.tests.flowManager.browserChannel.checkNoClients = function () {
    jqUnit.assertEquals("No clients are registered yet", "", Object.keys(gpii.settingsHandlers.WebSockets.model.clients));
};

gpii.tests.flowManager.browserChannel.checkTwoChromeClients = function () {
    jqUnit.assertEquals("We have two clients",
        2,
        Object.keys(gpii.settingsHandlers.WebSockets.model.clients["org.chrome.cloud4chrome"]).length
    );
};
...
gpii.tests.flowManager.browserChannel.checkThreeClients = function () {
    jqUnit.assertEquals("We have two client ids",
        2,
        Object.keys(gpii.settingsHandlers.WebSockets.model.clients).length
    );
    ...
    jqUnit.assertEquals("We have one clients in 'org.mozilla.cloud4firefox'",
        1,
        Object.keys(gpii.settingsHandlers.WebSockets.model.clients["org.mozilla.cloud4firefox"]).length
    );
};
...
var testDefs = [{
    ...
    sequence: [{
        ...
        args: "org.mozilla.cloud4firefox"
    }, {
