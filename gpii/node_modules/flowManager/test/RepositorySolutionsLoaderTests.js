...
gpii.tests.repositorySolutionsLoader.testFetchAndSave = function (testName, response, expected, path, fileName) {
    // Check the response
    jqUnit.assertDeepEq(testName, expected, response);

    // Check the file written
    var savedSolutions = fluid.require(path + "foo" + fileName);
    jqUnit.assertDeepEq("Checking file written", expected, savedSolutions);
};
...
fluid.defaults("gpii.tests.repositorySolutionsLoader.testCaseHolder.success", {
    ...
    modules: [{
        name: "Repository solutions loader module tests - successful retrieval and save",
        expect: 1,
        tests: [{
            ...
            sequence: [{
                ...
                resolve: "gpii.tests.repositorySolutionsLoader.testFetchAndSave" /*jqUnit.assertDeepEq"*/,
                resolveArgs: [
                    "The response and written file are both the expected solutions",
