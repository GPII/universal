...
(function ($) {
    ...
    gpii.tests.flowManager.privacy.verifyUnchanged = function (property, before, after) {
    ...
    gpii.tests.flowManager.privacy.runTests = function () {
        jqUnit.test("Filtering matchMakerOutput leaves other properties as is", function () {
            jqUnit.expect(14);
            ...
            fluid.each(otherProperties, function (property) {
                gpii.tests.flowManager.privacy.verifyUnchanged(
                    property,
                    gpii.tests.flowManager.privacy.testdata.payload,
                    filteredPayload
                );
