...
gpii.tests.solutionsRegistry.checkRejection = function (msg, result) {
    ...
    jqUnit.assertEquals(msg, 404, result.statusCode);
};
    ...
    modules: [{
        ...
        tests: [{
            ...
            sequence: [
                ...
                {
                    // Cannot listen for solutionsRegistryReady event since it
                    // is long gone by the time this executes.  Double checking
                    // that it is actually ready.
                    funcName: "jqUnit.assertNotNull",
                    args: [
                        "Cloud based solutionsRegistryDataSource is ready",
                        "{solutionsRegistryDataSource}.fullSolutionsRegistry"
                    ]
                }, {
