...
fluid.defaults("gpii.tests.solutionsRegistry.local.repository.testCaseHolder", {
    gradeNames: "fluid.test.testCaseHolder",
    components: {
        ...
        tests: [{
            ...
            sequence: [
                { funcName: "fluid.log", args: ["Solutions Registry Mock Repo Load, getting named and all registries -- START"] },
                {
                    ...
                    args: [
                        "Expecting repository named solutions registry",
                        jqUnit.assertDeepEq,
                        gpii.tests.solutionsRegistry.repositoryDarwinSolutions,
                        "{arguments}.0"
                    ]
...
// Test environments for LFM solutions registry data source where solutions are
// fetched from the repository
fluid.defaults("gpii.tests.solutionsRegistry.dataSource.local.repository.env", {
    gradeNames: ["fluid.test.testEnvironment"],
    components: {
        tester: {
            type: "gpii.tests.solutionsRegistry.local.repository.testCaseHolder"
        }
    }
});
kettle.test.bootstrap("gpii.tests.solutionsRegistry.dataSource.local.repository.env");
