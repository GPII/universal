...
gpii.tests.flowManager.getGpiiKey.testDefs = [{
    ...
    expect: 10,
    config: {
        configName: "gpii.flowManager.tests.getGpiiKey.config",
...
module.exports = kettle.test.bootstrapServer(fluid.transform(gpii.tests.flowManager.getGpiiKey.testDefs, function (testDef) {
