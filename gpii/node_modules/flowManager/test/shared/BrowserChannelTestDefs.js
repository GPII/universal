 ...
 * Copyright 2015 Raising the Floor - Internawional
 *
...
gpii.tests.flowManager.browserChannel.checkConnectionRequest = function (data, request) {
    request.events.onReceiveMessage.addListener(function (message, request) {
        console.log("GOT ONRECEIVEMESSAGE ", message);
    ...
    events: {
        loginAndSettingsChangedChrome: {
            events: {
                ...
                "org.chrome.cloud4chrome": "{clientOne}.events.onBrowserSettingsChanged"
            },
            args: ["{arguments}", {
    ...
    events: {
        loginAndSettingsChangedChromeAndFirefox: {
            events: {
                ...
                "org.chrome.cloud4chrome": "{clientTwo}.events.onBrowserSettingsChanged",
                "org.mozilla.cloud4firefox": "{clientThree}.events.onBrowserSettingsChanged"
            },
            args: ["{arguments}", {
