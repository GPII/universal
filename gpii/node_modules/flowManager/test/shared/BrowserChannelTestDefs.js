...
gpii.tests.flowManager.browserChannel.loginAndSettingsChanged = function (multiArg, spec) {
    ...
    jqUnit.assertEquals("Login response is correct", "User with GPII key " + spec.gpiiKeyId + " was successfully logged in.", multiArg.login[0]);
};
...
gpii.tests.flowManager.browserChannel.testDefs = [{
    ...
    events: {
        loginAndSettingsChangedChrome: {
            ...
            args: ["{arguments}", {
                gpiiKeyId: "{loginChrome}.options.gpiiKey",
    ...
    events: {
        loginAndSettingsChangedChromeAndFirefox: {
            ...
            args: ["{arguments}", {
                gpiiKeyId: "{loginChromeAndFirefox}.options.gpiiKey",
