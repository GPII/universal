...
gpii.tests.flowManager.browserChannel.chromeGpiiKey = "chrome2";
gpii.tests.flowManager.browserChannel.firefoxGpiiKey = "firefox";
gpii.tests.flowManager.browserChannel.chromeAndFirefoxGpiiKey = "chrome_and_firefox";
...
// Glorified no-op to gracefully fail fetching the solutions registry in the
// source code repository in order to use the canned registry set up for these
// tests
gpii.tests.flowManager.browserChannel.getRepositorySolutions = function (repositorySolutionsLoader) {
    fluid.log("TRACE: RepositorySolutionsLoader defeating loading from repository ... END");
    var togo = fluid.promise();
    repositorySolutionsLoader.solutionsRegistry = null;
    togo.resolve(repositorySolutionsLoader.solutionsRegistry);
    return togo;
};
...
gpii.tests.flowManager.browserChannel.testDefs = [{
    ...
    sequence: [{
        ...
        args: ["chrome2", "{arguments}.0", "{arguments}.1"]
    }, {
        func: "gpii.tests.flowManager.browserChannel.checkClients"
    }]
}, {
    ...
    // All three clients now logged in - disconnect client 1 and try a spurious logout
    {
        ...
        event: "{logoutChrome1}.events.onComplete",
        listener: "gpii.tests.flowManager.browserChannel.checkErrorResponse",
        args: ["chrome1", "{arguments}.0", "{arguments}.1"]
    }, {
        func: "gpii.tests.flowManager.browserChannel.checkClients",
        args: {
            "org.chrome.cloud4chrome": 1,
    ...
    // Log in a user who has settings for two browsers
    {
        ...
        listener: "gpii.tests.flowManager.browserChannel.checkErrorResponse",
        args: ["firefox", "{arguments}.0", "{arguments}.1"]
    }, {
        func: "gpii.tests.flowManager.browserChannel.checkClients",
        args: {
            "org.mozilla.cloud4firefox": 1
