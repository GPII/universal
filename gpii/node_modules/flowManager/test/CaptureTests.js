...
fluid.defaults("gpii.tests.flowManager.capture.tests", {
    ...
    modules: [
        ...
        },
        {
            ...
            tests: [{
                ...
                sequence: [{
                    ...
                    task: "{config}.server.flowManager.capture.getInstalledSolutions",
                    args: [],
        ...
        {
            name: "Test Raw Settings Formatting",
            tests: [{
                name: "All correct settings",
                expect: 2,
                sequence: [{
                    funcName: "gpii.tests.flowManager.capture.testFormatRawCapturedSettings"
                }]
            }]
        },
        {
            name: "Test filterInvokeSettingsHandlersReturn",
            tests: [{
                name: "Test filter results",
                sequence: [{
                    funcName: "gpii.tests.flowManager.capture.testfilterInvokeSettingsHandlersReturn"
                }]
            }]
        }
    ],
...
gpii.tests.flowManager.capture.testfilterInvokeSettingsHandlersReturn = function () {
    // 1. Test a regular setting
    var regularResult = gpii.flowManager.filterInvokeSettingsHandlersReturn({
        ...
        type: "org.gnome.settingsHandler"
    });

    jqUnit.assertDeepEq("Regular setting with no modifications:", {
        "com.microsoft.windows.magnifier": [
            {
                "settings": {
                    "Magnification": 200
    ...
    // 2. Test a windows nativeSettingsHandler
    var nativeResult = gpii.flowManager.filterInvokeSettingsHandlersReturn({
    ...
    jqUnit.assertDeepEq("Native Settings Handler", {
        "com.microsoft.windows.mouseSettings": [
            {
                "settings": {
                    "DoubleClickWidthConfig": 4
                }
            }
        ]
    }, nativeResult);

    // 3. Test an SPI Setting
    var spiResult = gpii.flowManager.filterInvokeSettingsHandlersReturn({
        "com.microsoft.windows.mouseSettings": [
            {
                "settings": {
    ...
    jqUnit.assertDeepEq("SPI Settings Handler", {
        "com.microsoft.windows.mouseSettings": [
            {
                "settings": {
                    "ScrollWheelModeConfig": 3
                }
            }
        ]
    }, spiResult);

    // 4. SPI Case with multiple settings
    var complexSPIResult = gpii.flowManager.filterInvokeSettingsHandlersReturn({
    ...
    jqUnit.assertDeepEq("Complex SPI Settings Handler", {
        "com.microsoft.windows.mouseKeys": [
            {
                "settings": {
                    "MouseKeysOn": true,
...
gpii.tests.flowManager.capture.testFormatRawCapturedSettings = function () {
    ...
    var someErrorsSettings = gpii.flowManager.formatRawCapturedSettings([
        {
            "fakemag1": [
                {
                    "settings": {
...
gpii.tests.flowManager.capture.checkForInstalledMags = function (payload) {
    jqUnit.assertEquals("There should be 2 solutions installed", Object.keys(payload).length, 2);
