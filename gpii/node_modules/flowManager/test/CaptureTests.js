...
gpii.tests.flowManager.capture.adjustSolutions = function (solutionsRegistryDataSource, solutionsPayload) {
    ...
    // The solutionsPayload block is a read only data structure
    var adjustedSolutions = fluid.copy(solutionsPayload);
    ...
    solutionsRegistryDataSource.repositorySolutionsRegistry = fluid.freezeRecursive({"darwin": adjustedSolutions});
};
    ...
    modules: [
        {
            ...
            tests: [{
                ...
                sequence: [{
                    ...
                    listener: "gpii.tests.flowManager.capture.adjustSolutions",
                    args: ["{config}.server.flowManager.solutionsRegistryDataSource", "{arguments}.0"]
                }, {
