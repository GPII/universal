...
gpii.tests.flowManager.capture.adjustSolutions = function (solutionsRegistryDataSource) {
    var platformId = gpii.tests.flowManager.capture.platformId;
...
gpii.tests.flowManager.capture.solutionsRegistryIsReady = function (msg, solutionsRegistryDataSource) {
    jqUnit.assertNotNull(msg, solutionsRegistryDataSource.fullSolutionsRegistry);
    jqUnit.assertNotNull(msg, solutionsRegistryDataSource.repositorySolutionsRegistry);
};
    ...
    modules: [
        {
            ...
            tests: [{
                ...
                sequence: [{
                    ...
                    // event, but it was emitted long ago.  Nonetheless, check
                    // that the SRDS is ready.
