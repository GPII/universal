...
fluid.defaults("gpii.tests.settingsDataSourceTests", {
    gradeNames: ["fluid.test.testEnvironment", "gpii.test.setupNock"],
    ...
    nockSetupFunc: "gpii.tests.settingsDataSource.setupNock",
    nockSetupFuncArgs: gpii.tests.settingsDataSource.nockConfig,
    distributeOptions: {
