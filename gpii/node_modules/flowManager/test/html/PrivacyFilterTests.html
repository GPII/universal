...
<html>
    <head>
        ...
        <title>GPII Flow Manager Privacy Filter Tests</title>
        ...
        <script src="../../src/PrivacyFilter.js"></script>
        ...
        <script src="../js/PrivacyFilterTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII Flow Manager Privacy Filter Tests</h1>
        ...
        <script>
            gpii.tests.flowManager.privacy.runTests();
        </script>
    </body>
</html>
