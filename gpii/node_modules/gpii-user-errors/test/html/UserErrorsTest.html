...
<html>
    <head>
        ...
        <title>GPII User Errors Tests</title>
        ...
        <script src="../../src/UserErrors.js"></script>
        ...
        <script src="../js/UserErrorsTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">GPII User Errors Tests</h1>
