    ...
    modules: [{
        ...
        tests: [{
            ...
            sequence: [{
                ...
                resolveArgs: ["{arguments}.0", "darwin"]
            }]
        }]
    }]
});
...
gpii.tests.deviceReporter.verifyPayload = function (response, expectedOS) {
    jqUnit.assertEquals("OS id has been received", expectedOS, response.OS.id);
