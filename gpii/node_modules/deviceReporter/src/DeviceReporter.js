...
gpii.deviceReporter["static"].get = function (request, deviceReporter) {
    console.log("STATIC DEVICEREPORTER GET with options ", deviceReporter.installedSolutionsDataSource.options);
...
fluid.defaults("gpii.deviceReporter.live", {
    ...
    invokers: {
        get: {
            ...
            // TODO: Why does {solutionsRegistryDataSource} not resolve here?
            args: ["{arguments}.0", "{deviceReporter}", "{that}.solutionsRegistryDataSource"]
        }
    }
});
