...
fluid.defaults("gpii.deviceReporter.live", {
    ...
    components: {
        solutionsRegistryDataSource: {
            type: "kettle.dataSource.URL",
            options: {
                url: "{gpii.deviceReporter.live}.options.solutionsRegistryUrl",
                termMap: {
                    os: os.platform()
                }
            }
...
gpii.deviceReporter.live.get = function (requestProxy, deviceReporter) {
    var installedSolutions = [];
    deviceReporter.solutionsRegistryDataSource.get(null, function onSuccess(entries) {
