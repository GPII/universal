        ...
        options: {
            invokers: {
                handle: {
                    ...
                    args: ["{request}", "{deviceReporter}.installedSolutionsDataSource"]
                }
            }
        }
    });

    gpii.requests.request.handler.deviceGet = function (request, installedSolutionsDataSource) {
        var res = request.res;
        installedSolutionsDataSource.get(null, function (solutions) {
            if (!solutions) {
                res.send({
                    isError: true,
