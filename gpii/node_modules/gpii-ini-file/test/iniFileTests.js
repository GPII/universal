...
gpii.tests.iniFile.parserTestData = fluid.freezeRecursive({
    ...
    expect: [
        ...
        // [[section2B]]
        ["sectionEnd", "state", ["section2", "section2A"]],
        ...
        // implied from eof
        ["sectionEnd", "state", ["section2", "section2B"]],
        ["sectionEnd", "state", ["section2"]],
        ["sectionEnd", "state", []]
    ]
});
...
jqUnit.test("inifile reading/writing non-existent file", function () {
    ...
    jqUnit.assertEquals("INI content should be as expected", "key=value\n\n", writtenContent);
});
