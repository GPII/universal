...
jqUnit.test("gpii.transformer.jsonArrayToTaggedArray() tests", function () {
    var result = gpii.transformer.jsonArrayToTaggedArray(jsonArrayToTaggedArrayPayload.value,
        jsonArrayToTaggedArrayPayload.spec);
    ...
    jqUnit.assertDeepEq("gpii.transformer.jsonArrayToTaggedArray", result, expRes);

    var invertRes = gpii.transformer.jsonArrayToTaggedArray.invert(result);

    jqUnit.assertDeepEq("gpii.transformer.jsonArrayToTaggedArrayInvert",
        invertRes, jsonArrayToTaggedArrayPayload.value);
});
