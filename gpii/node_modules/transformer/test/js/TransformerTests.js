...
(function () {
    ...
    gpii.tests.transformer.filterSupportedSettingsSpecs = {
    ...
    jqUnit.test("filterSupportedSettings tests", function () {
        fluid.each(gpii.tests.transformer.filterSupportedSettingsSpecs, function (test, name) {
            var result = gpii.transformer.filterSupportedSettings(test.settings, test.supportedSettings);
