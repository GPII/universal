...
(function () {
    ...
    /* --------------- gpii.transformer.removeElement tests -------------------- */
    gpii.tests.transformer.removeElementTests = [
        {
    ...
    jqUnit.test("gpii.transformer.removeElement() tests", function () {
        fluid.each(gpii.tests.transformer.removeElementTests, function (oneTest) {
            gpii.transformer.removeElement(oneTest.inputArray, oneTest.elementsToRemove);
            jqUnit.assertDeepEq("gpii.transformer.removeElement() test - " + oneTest.name, oneTest.expected, oneTest.inputArray);
        });
    });
