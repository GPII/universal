...
(function () {
    ...
    jqUnit.test("gpii.transformer.hasSupportedSettings() tests", function () {
        fluid.each(gpii.tests.transformer.hasSupportedSettingsTests, function (oneTest) {
            var result = gpii.transformer.hasSupportedSettings(oneTest.capabilitiesTransformations, oneTest.settings);
            jqUnit[oneTest.expected ? "assertTrue" : "assertFalse"]("gpii.transformer.hasSupportedSettings() test - " + oneTest.name, result);
        });
    });

    /* --------------- gpii.transformer.arrayDifference tests -------------------- */
    gpii.tests.transformer.arrayDifferenceTests = [
        {
    ...
    jqUnit.test("gpii.transformer.arrayDifference() tests", function () {
        fluid.each(gpii.tests.transformer.arrayDifferenceTests, function (oneTest) {
            gpii.transformer.arrayDifference(oneTest.inputArray, oneTest.elementsToRemove);
            jqUnit.assertDeepEq("gpii.transformer.arrayDifference() test - " + oneTest.name, oneTest.expected, oneTest.inputArray);
        });
    });
