...
(function () {
    ...
    var makeSettings = function (solutionsSpec, settingsBlocks) {
    ...
    var expectedAppSpecificSettings = makeSettings(onlyGnomeMagnifierSolutionSpec, {
         "show-cross-hairs": true
    });
    ...
    var expectedGenericSettings = makeSettings(onlyGnomeMagnifierSolutionSpec, {
        "mag-factor": 200,
    ...
    var expectedGenericAndAppSpecificSettings = makeSettings(onlyGnomeMagnifierSolutionSpec, {
        "mag-factor": 200,
        "mouse-tracking": "centered",
        "show-cross-hairs": true
    });
    ...
    var expectedNoMagnificationSettings = makeSettings(onlyGnomeMagnifierSolutionSpec, {
        "mouse-tracking": "centered"
    });
    
    var multipleAppSpecificPreferences = {
        "applications": {
    ...
    var multipleAppSpecificPreferences2 = {
        "display": {
            "applications": {
                "org.gnome.desktop.a11y.keyboard": {
                   "name": "GNOME Shell Keyboard",
    ...
    var expectedMultipleAppSpecificSettings = makeSettings(multipleSolutionSpec, [
        {
            "mouse-tracking": "centered",
            "show-cross-hairs": true
        }, 
    ...
    var transformationConfigs = [
        ...
        {
            name: "app-specific at top level and nested.",
            input: {
                preferences: multipleAppSpecificPreferences,
                solutions: multipleSolutionSpec
            },
            expectedOutput: expectedMultipleAppSpecificSettings
        },
        {
            name: "app-specific at non-top level and nested.",
            input: {
                preferences: multipleAppSpecificPreferences2,
                solutions: multipleSolutionSpec
            },
            expectedOutput: expectedMultipleAppSpecificSettings               
        }
