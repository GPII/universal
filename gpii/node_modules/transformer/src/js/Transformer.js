...
(function () {
    ...
    gpii.transformer.filterSupportedSettings = function (settings, supportedSettings) {
    ...
    gpii.transformer.transformOneSettingsHandler = function (settingsHandler, oneUserSolution, solutionId) {
        var appSettings = oneUserSolution.settings["http://registry.gpii.net/applications/" + solutionId];
        var settings = gpii.transformer.filterSupportedSettings(fluid.copy(appSettings), settingsHandler.supportedSettings);
