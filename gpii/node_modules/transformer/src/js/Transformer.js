...
(function () {
    ...
    gpii.transformer.inRange = function (value, transformSpec) {
        return (transformSpec.min === undefined || transformSpec.min === "unbounded" || transformSpec.min <= value) &&
            (transformSpec.max === undefined || transformSpec.max === "unbounded" || transformSpec.max >= value) ? true : false;
    };
