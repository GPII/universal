...
(function () {
    ...
    gpii.transformer.transformOneSettingsHandler = function (settingsHandler, oneUserSolution, solutionId) {
        ...
        // extract any common terms that were defined in the application block
        var scopedCommon = fluid.remove_if(fluid.copy(settings), function (val, key) {
            return !key.startsWith("http://registry.gpii.net/common/");
        });
