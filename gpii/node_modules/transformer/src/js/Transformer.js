...
(function () {
    ...
    gpii.transformer.settingsHandlerToLifecycle = function (settingsHandler, preferences, solutionId) {
        var settings = preferences.settings["http://registry.gpii.net/applications/"+solutionId]; //todo: throw app specific settings in the correct locations if there are multiple handlers
        var inferred;
