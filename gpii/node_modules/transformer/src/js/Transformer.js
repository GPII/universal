...
(function () {
    ...
    gpii.transformer.hasSupportedSettings = function (capabilitiesTransformations, settings) {
        ...
        var actualSettingPaths = gpii.matchMakerFramework.utils.computeLeaves(settings);
        ...
        // calculate the intersection of supported paths and actual paths
        var overlap = supportedSettingPaths.filter(value => -1 !== actualSettingPaths.indexOf(value));
