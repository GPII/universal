...
(function () {
    ...
    gpii.transformer.findApplications = function (settings, appSpecific) {
        ...
        settings = fluid.copy(settings);

        if (settings.applications) {
            gpii.transformer.indexApplicationSettings(settings.applications, appSpecific);
            delete settings.applications;
        }
     ...
     ****************/
     ...
     gpii.transformer.scaleValue = function (value, expander, expandSpec) {
     ...
     fluid.defaults("gpii.transformer.scaleValue", {
         gradeNames: "fluid.standardTransformFunction"
     });
     
     gpii.transformer.fontSizeToScale = function (value, expander, expandSpec) {
         if (typeof (value) !== "number") {
             return undefined;
         }
         
         var baseFontSize = expandSpec.baseFontSize === undefined ? value : expandSpec.baseFontSize;
         return value / baseFontSize;
     };
     
     fluid.defaults("gpii.transformer.fontSizeToScale", {
         gradeNames: "fluid.standardTransformFunction"
     });
}());
