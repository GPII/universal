...
(function () {
    ...
    fluid.defaults("gpii.transformer", {
        ...
        invokers: {
            transformSettings: {
                funcName: "gpii.transformer.transformSettings",
    ...
    gpii.transformer.transformSettings = function (that, configuration, solutionsRegistry) { //was setting
        var togo = {};
        fluid.each(configuration.applications, function (preferences, solutionId) {
            ...
            fluid.transform(registryEntry.settingsHandlers, function (settingsHandler) {
                var settings = preferences.settings["http://registry.gpii.net/applications/"+solutionId]; //todo: throw app specific settings in the corrdct locations if there are multiple handlers
                var inferred;
        ...
        console.log(JSON.stringify(togo, null, 3));
