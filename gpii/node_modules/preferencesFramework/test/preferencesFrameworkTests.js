...
gpii.preferencesFramework.tests.cleanUpTmpFiles = function () {
    var file;
    while ((file = gpii.preferencesFramework.tests.filesToDelete.pop()) !== undefined) {
        fs.unlinkSync(file);
    }
};
...
var getFixtures = [
    {
        ...
        expected: {
            ...
            "http://registry.gpii.org/applications/org.alsa-project": [
                {
                    "value": {
                        "volume": 14,
                        "pitch": 100
...
/////////////////////// TESTING preferencesFramework PUT functionality ////////////////////////////
fluid.registerNamespace("gpii.preferencesFramework.tests.put");

gpii.preferencesFramework.tests.put.testRequestResponse = function (prefs, token) {
    return function (data) {
        var retrievedData = JSON.parse(data);
        //expect preferences without ontology info - any generated token is fine
        var expected = {
...
gpii.preferencesFramework.tests.put.buildTestDef = function (fixture) {
    return {
        name: fixture.name,
        expect: 3,
        config: {
        ...
        sequence: [{
            func: "gpii.preferencesFramework.tests.put.copyNPSet",
            ...
            listenerMaker: "gpii.preferencesFramework.tests.put.testRequestResponse",
            makerArgs: [ fixture.putBody, fixture.token ]
        }, {
            func: "gpii.preferencesFramework.tests.put.checkRawPreferences",
            args: [ fixture.token, fixture.expectedRaw ]
        }]
    };
};

gpii.preferencesFramework.tests.put.copyNPSet = function (toToken, fromToken) {
...
gpii.preferencesFramework.tests.put.checkRawPreferences = function (token, expectedRaw) {
    var rawPrefs;
...
fluid.each(putFixtures, function (fixture) {
    testDefs.push(gpii.preferencesFramework.tests.put.buildTestDef(fixture));
});
